...
*   **VHD Name**: 962954588869ba.vhd
*   **Vhd Release**: Spark4.1-default-2026-08-11.0-rc.1
...
|-----|-----|-----|
|2242819|Delta:4.2.0.20260810.3|Updates Delta for Fabric Runtime 2.0 (Spark 4.1) with fixes for auto-compaction eligibility, REORG PURGE executor session handling, and RLS enforcement on warm pooled clusters.|
|2243655|ServiceConfigurationTemplates:spark/4.1.1|The default Parquet row-group size on Fabric Spark 4.1 is reduced from 1 GiB to 128 MiB, aligning it with the target file size and the OSS parquet-mr default. This yields finer row-group statistics, improving data skipping and reducing bytes read for scan-heavy queries.|
|2225181|ServiceConfigurationTemplates:spark/4.1.1|The OneSecurity async-shuffle index cache, data cache, and timing metrics are turned off by default in the Spark 4.1 runtime configuration.|
...
|**Delta**|**4.2.0.20260714.2 ⬆️ 4.2.0.20260810.3**|SparkJobInsight|2.0.0|
...
|FLTSparkExtensions|1.7.1|SparkSqlConnector|1.1.0.217307560|
...
|GlutenUI|1.6.0-20260722.2|TridentCore|1.4.4|
...
|libharfbuzz-devel|14.2.1|flt-python|1.7.1|
...
|jjwt-api|0.12.6|trident-core|1.4.4|
