...
*   **VHD Name**: b1a14482e05190.vhd
*   **Vhd Release**: Spark4.1-earlyaccess-2026-08-25.0-rc.1
...
|-----|-----|-----|
|2251727|ServiceConfigurationTemplates:spark/4.1.1|Routes ABFSS request-level telemetry into FilteredSparkComponentLogs so storage request IDs and latencies are queryable for Spark diagnostics. Internal config change; no customer-facing API change.|
|2259094|FLTSparkExtensions:1.9.0|Updates FLT-SparkExtensions to 1.9.0 for Spark 4.1: incremental refresh for additional operators (Left Anti Join, DISTINCT), Delta File Ingestion (DFI) enhancements (AS SELECT/partition coverage, reader-option pass-through, PARTITION BY), and more precise user-vs-system error classification for Materialized Lake View (MLV) operations.|
|2240031|FlightingProxy:0.1.1-20260626.1|Adds the default-OFF per-cluster egress-isolation (MITM) proxy component to Fabric Spark 4.1 clusters. No behavior change on normal clusters -- the proxy stack self-gates to a clean no-op unless a cluster is explicitly flagged for flighting.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|2261065|LibraryManager:1.0.20|Enhance user and system error classifications for Environment Publish / LPS. This improves Environment Publish reliability and distinguishes user configuration errors from system failures and unknown failures.|
|2251727|ServiceConfigurationTemplates:spark/4.1.1|Routes ABFSS request-level telemetry into FilteredSparkComponentLogs so storage request IDs and latencies are queryable for Spark diagnostics. Internal config change; no customer-facing API change.|
|2259094|FLTSparkExtensions:1.9.0|Updates FLT-SparkExtensions to 1.9.0 for Spark 4.1: incremental refresh for additional operators (Left Anti Join, DISTINCT), Delta File Ingestion (DFI) enhancements (AS SELECT/partition coverage, reader-option pass-through, PARTITION BY), and more precise user-vs-system error classification for Materialized Lake View (MLV) operations.|
|2230044|Impulse:1.5.230534541|Rolls Spark 4.1 BBC-VHD forward to the latest successful Impulse official build.|


# Bug Fixes
|Id|Component|Description|
|-----|-----|-----|
|2229686|KustoConnector:2.1.1|Updates the Fabric Kusto Spark connector to 7.1.2. This fixes read queries that end in a single-line comment (`// ...`): previously the connector's appended query operators could be swallowed by the comment, causing large-result distributed reads to fail with `E_QUERY_RESULT_SET_TOO_LARGE` and, in some cases, incorrect column selection. No action needed from users. OneLake transient storage (added in 2.1.0) is unchanged.|
|2239251|AutoscaleProbe:3.9.11|This release contains the latest autoscale probe build 20260807.3.0 for Spark 4.1.|
...
|Delta|4.2.0.20260810.3|SparkDiagnosticsLibrary|1.2.1|
...
|**FLTSparkExtensions**|**1.7.2 ⬆️ 1.9.0**|SparkSqlConnector|1.1.0.217307560|
...
|GlutenUI|1.6.0-20260731.1|TridentCore|1.4.6|
|HiveMetaStoreClient|1.1.21.2|TridentTokenLibrary|2.5.1|
|**Iceberg**|**1.11.0 ⬆️ 1.11.0.1**|UpgradeToFabric|1.2.15|
|**Impulse**|**1.5.226604159 ⬆️ 1.5.230534541**|Vegas|4.1.0.01|
|**KustoConnector**|**2.1.0 ⬆️ 2.1.1**|Wildfire|1.10.60|
|**LibraryManager**|**1.0.18 ⬆️ 1.0.20**|
|LibraryMetadataCooker|1.0.0|
|MlflowLibrary|2.18.0.1|
|MMLSpark|1.4.28|
|NotebookUtils|1.1.15.20260524.4|
|OneLakeClientStarter|1.0.28.0|
|OnelakeSparkCatalog|0.4.17|
...
|libharfbuzz-devel|14.2.1|**flt-python**|**1.7.2 ⬆️ 1.9.0**|
...
|libntlm|1.8|**impulse-python-handler**|**1.5.226604159 ⬆️ 1.5.230534541**|
...
|**flt-spark-sql-extensions**|**1.7.2 ⬆️ 1.9.0**|org.eclipse.xtext.xbase.lib|2.28.0|
|**fmlv-utils**|**1.7.2 ⬆️ 1.9.0**|oro|2.0.8|
...
|hadoop-aliyun|3.4.2.5.5.20260803.3|parquet-column|1.16.0|
|hadoop-annotations|3.4.2.5.5.20260803.3|parquet-common|1.16.0|
|hadoop-aws|3.4.2.5.5.20260803.3|parquet-encoding|1.16.0|
|hadoop-azure|3.4.2.5.5.20260803.3|parquet-format-structures|1.16.0|
|hadoop-azure-datalake|3.4.2.5.5.20260803.3|parquet-hadoop|1.16.0|
|hadoop-client-api|3.4.2.5.5.20260803.3|parquet-hadoop-ms|4.1.1.5.5.20260803.3|
|hadoop-client-runtime|3.4.2.5.5.20260803.3|parquet-jackson|1.16.0|
|hadoop-cloud-storage|3.4.2.5.5.20260803.3|parsers|2.13-4.13.10|
|hadoop-huaweicloud|3.4.2.5.5.20260803.3|pickle|1.5|
...
|**iceberg-azure-bundle**|**1.11.0**|scalatra-jakarta|2.13-3.0.0|
|iceberg-spark-runtime|4.1_2.13-1.11.0|scalatra-metrics-jakarta|2.13-3.0.0|
|icu4j|77.1|semanticdb-shared|2.13-4.13.10|
|impulse-core_spark|2.13-1.5.214702911|slf4j-api|2.0.17|
|impulse-exception_java17|2.13-1.5.214702911|snappy-java|1.1.10.8|
|impulse-telemetry-common|2.13-1.5.214702911|sourcecode|2.13-0.4.4|
|impulse-telemetry-mds_spark|2.13-1.5.214702911|spark-arsenal|2.13-4.1.1.5.5.20260803.3|
|impulse-telemetry-pulse_spark|2.13-1.5.214702911|spark-avro|2.13-4.1.1.5.5.20260803.3|
|ini4j|0.5.4|spark-catalyst|2.13-4.1.1.5.5.20260803.3|
|interface|1.0.28|spark-common-utils|2.13-4.1.1.5.5.20260803.3|
|io|2.13-4.13.10|spark-common-utils-java|2.13-4.1.1.5.5.20260803.3|
|istack-commons-runtime|4.1.2|spark-connect|2.13-4.1.1.5.5.20260803.3|
|ivy|2.5.1|spark-core|2.13-4.1.1.5.5.20260803.3|
|jackson-annotations|2.20|spark-enhancement|2.13-4.1.1.5.5.20260803.3|
|jackson-core|2.20.0|spark-graphx|2.13-4.1.1.5.5.20260803.3|
|jackson-databind|2.20.0|spark-hadoop-cloud|2.13-4.1.1.5.5.20260803.3|
|jackson-dataformat-cbor|2.20.0|spark-hive|2.13-4.1.1.5.5.20260803.3|
|jackson-datatype-jsr310|2.20.0|spark-kvstore|2.13-4.1.1.5.5.20260803.3|
|jackson-module-scala|2.13-2.20.0|spark-launcher|2.13-4.1.1.5.5.20260803.3|
|jakarta.activation-api|2.1.3|spark-microsoft-tools|2.13-4.1.1.5.5.20260803.3|
|jakarta.annotation-api|2.1.1|spark-mllib|2.13-4.1.1.5.5.20260803.3|
|jakarta.inject-api|2.0.1|spark-mllib-local|2.13-4.1.1.5.5.20260803.3|
|jakarta.servlet-api|5.0.0|spark-network-common|2.13-4.1.1.5.5.20260803.3|
|jakarta.validation-api|3.0.2|spark-network-shuffle|2.13-4.1.1.5.5.20260803.3|
|jakarta.ws.rs-api|3.0.0|spark-onesecurity-client|2.13-4.1.1.5.5.20260803.3|
|jakarta.xml.bind-api|4.0.2|spark-onesecurity-common|2.13-4.1.1.5.5.20260803.3|
|janino|3.1.9|spark-onesecurity-server|2.13-4.1.1.5.5.20260803.3|
|java-diff-utils|4.16|spark-pipelines|2.13-4.1.1.5.5.20260803.3|
|java-xmlbuilder|1.2|spark-repl|2.13-4.1.1.5.5.20260803.3|
|javaparser-core|3.2.12|spark-sketch|2.13-4.1.1.5.5.20260803.3|
|javassist|3.30.2-GA|spark-sql|2.13-4.1.1.5.5.20260803.3|
|javatuples|1.2|spark-sql-api|2.13-4.1.1.5.5.20260803.3|
|javax.annotation-api|1.3.2|spark-sql-kafka|2.13-4.1.1.5.5.20260803.3|
|javax.jdo|3.2.0-m3|spark-streaming|2.13-4.1.1.5.5.20260803.3|
|javax.servlet-api|4.0.1|spark-streaming-kafka|2.13-4.1.1.5.5.20260803.3|
|javolution|5.5.1|spark-tags|2.13-4.1.1.5.5.20260803.3|
|jaxb-core|4.0.5|spark-token-provider-kafka|2.13-4.1.1.5.5.20260803.3|
|jaxb-runtime|4.0.5|spark-unsafe|2.13-4.1.1.5.5.20260803.3|
|jcip-annotations|1.0-1|spark-variant|2.13-4.1.1.5.5.20260803.3|
|jcl-over-slf4j|2.0.17|spark-yarn|2.13-4.1.1.5.5.20260803.3|
|jdo-api|3.0.1|spire|2.13-0.18.0|
|jdom2|2.0.6|spire-macros|2.13-0.18.0|
|jersey-client|3.0.18|spire-platform|2.13-0.18.0|
|jersey-common|3.0.18|spire-util|2.13-0.18.0|
|jersey-container-servlet|3.0.18|stax-api|1.0.1|
|jersey-container-servlet-core|3.0.18|stream|2.9.8|
|jersey-hk2|3.0.18|threeten-extra|1.8.0|
|jersey-server|3.0.18|tink|1.16.0|
|jettison|1.5.4|transaction-api|1.1|
|jetty-util|11.0.26|trees|2.13-4.13.10|
|jetty-util-ajax|11.0.26|trident-core|1.4.6|
|jjwt-api|0.12.6|tridenttokenlibrary-assembly|2.5.1|
|jjwt-impl|0.12.6|typename|2.13-1.1.0|
|jjwt-jackson|0.12.6|ujson|2.13-4.3.2|
|jline|2.14.6|univocity-parsers|2.9.1|
|jline|3.29.0-jdk8|upack|2.13-4.3.2|
|joda-time|2.14.0|upickle|2.13-4.3.2|
|jodd-core|3.5.2|upickle-core|2.13-4.3.2|
|json|1.8|upickle-implicits|2.13-4.3.2|
|json|20231013|wildfly-openssl|2.2.5.Final|
|json-simple|1.1|xbean-asm9-shaded|4.28|
|json4s-ast|2.13-4.0.7|xmlschema-core|2.3.1|
|json4s-core|2.13-4.0.7|xz|1.10|
|json4s-jackson|2.13-4.0.7|zookeeper|3.8.4.5.5.20260803.3|
|json4s-jackson-core|2.13-4.0.7|zookeeper-jute|3.8.4.5.5.20260803.3|
|json4s-scalap|2.13-4.0.7|zstd-jni|1.5.7-6|
|jsr305|3.0.0|
