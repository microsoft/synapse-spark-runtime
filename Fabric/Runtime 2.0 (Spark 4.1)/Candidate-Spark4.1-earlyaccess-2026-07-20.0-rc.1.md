...
*   **VHD Name**: a9f451092e851a.vhd
*   **Vhd Release**: Spark4.1-earlyaccess-2026-07-20.0-rc.1
...
|-----|-----|-----|
|2119896|NotebookUtils:1.1.15.20260524.4|This update brings Spark 4.1 VHD to NotebookUtils 1.1.15 and blobfuse v2.1.21. It includes customer-facing fixes and improvements for MLV refresh, UDF metadata authentication, Variable Library APIs, sovereign cloud OneLake mounts, Plotly rendering, mount/library reliability, R/Spark 4.x runtime compatibility, and blobfuse path/Redis reliability.|
|2130597|SStreamOnSparkJar:3.1.2|Addressed two IcMs by fixing partition elimination and improving load balancing:|
|2140919|Iceberg/spark41:1.11.0|Add iceberg libraries (1.11.0) in Spark classpath for introducing iceberg support in experimental mode|
|2145075|FLTDeequ:2.0.18.1-msft|Adds the Microsoft-maintained forks of Deequ (JARs) and PyDeequ (Python bindings) to the Fabric Spark 4.1 runtime to power the Fabric Materialized Lake View service. This enables the service — and customers authoring Spark/PySpark notebooks and jobs — to run data quality checks (constraints, profiling, and anomaly detection) out of the box, without needing to bring their own libraries.|
...
|2172028|delta:4.2.0.20260630.2sparknativeparquetwriter:4.1.0-20260630.2|Delivers Delta Extended Statistics V2 (ESv2), disabled by default. Opt new tables into ESv2 by setting `spark.microsoft.delta.stats.extended.defaultVersion=2`.|
|2177255|FLTSparkExtensions:1.6.1|Two changes on Fabric Spark 4.1 VHDs:|
|2079035|OneLakeClientStarter:1.0.28.0|Upgrade OLC Out-of-proc to v340 for GCC support.|
|2119896|NotebookUtils:1.1.15.20260524.4|This update brings Spark 4.1 VHD to NotebookUtils 1.1.15 and blobfuse v2.1.21. It includes customer-facing fixes and improvements for MLV refresh, UDF metadata authentication, Variable Library APIs, sovereign cloud OneLake mounts, Plotly rendering, mount/library reliability, R/Spark 4.x runtime compatibility, and blobfuse path/Redis reliability.|
|2130597|SStreamOnSparkJar:3.1.2|Addressed two IcMs by fixing partition elimination and improving load balancing:|
|2136144|FLTSparkExtensions:1.4.1|Update FLT-SparkExtensions to 1.4.1|
|2136469|TridentTokenLibrary:2.5.1|TridentTokenLibrary Improvements|
|2137157|MMLSpark:1.4.28|Upgrades SynapseML packages from 1.1.1 to 1.1.3 for the Spark 4.1 runtime, including AI Functions, OpenAI integration, and bug fixes.|
|2147179|LibraryManager:1.0.15, Genesis:2.0.3|Enhances experience when users override libraries already present in the built-in python environment. Existing versions are now safely removed before installing the updated version, preventing stale files from persisting on the same paths. This behavior is controlled via a feature flight.|
|2152177|Impulse:1.5.223168344|Updates the Impulse diagnostics/telemetry library for the Spark 4.1 VHD to version `1.5.223168344` (latest official build `20260615.1`, tag `v1.5.223168344`).|
|2155732|FabricDWConnector:1.0.25|Add retries for throttling error during TDS SQL Endpoint discovery|
|2164902|LibraryManager:1.0.16|Library installation is now more resilient to transient to upload/download failures with added retries during both library preparation and deployment stages, with improved diagnostics when failures do occur. No user-facing behavior change.|
|2174363|Conda:10.0.0, LibraryManager:1.0.17|The Spark 4.1 Python environment has been refreshed to reduce footprint and remediate known CVEs by upgrading a set of Python/conda libraries.|
|2112962|Esri:2.0.0|Esri's geoanalytics library has been updated with new functionality.|
...
|2177255|FLTSparkExtensions:1.6.1|Two changes on Fabric Spark 4.1 VHDs:|
|2180681|sparknativeparquetwriter:4.1.0-20260429.1|Reverts the SparkNativeParquetWriter bump. Delta stays at 4.2.0.20260630.2; ESv2 remains disabled by default.|
|2115929|KustoConnector:2.0.6|Fixed a packaging issue where commons-io was not being shaded into the connector JAR and was in provided mode, causing NoClassDefFoundError: kusto_connector_shaded/org/apache/commons/io/IOUtils at runtime on Fabric.|
|2119896|NotebookUtils:1.1.15.20260524.4|This update brings Spark 4.1 VHD to NotebookUtils 1.1.15 and blobfuse v2.1.21. It includes customer-facing fixes and improvements for MLV refresh, UDF metadata authentication, Variable Library APIs, sovereign cloud OneLake mounts, Plotly rendering, mount/library reliability, R/Spark 4.x runtime compatibility, and blobfuse path/Redis reliability.|
|2130597|SStreamOnSparkJar:3.1.2|Addressed two IcMs by fixing partition elimination and improving load balancing:|
|2158260|ServiceConfigurationTemplates/spark/4.1.1:4.1.1|If namespace is not provided, tables will be resolved against `dbo`|


# Components
|Name|Version|Name|Version|
|-----|-----|-----|-----|
|**AutoscaleProbe**|**3.9.9 ⬆️ 3.9.10**|R|1.0.3|
|**Conda**|**8.0.7 ⬆️ 11.0.0**|SparkAdvisor|1.0.5|
|**CSparkMetricUpdate**|**1.0.2.210061716 ⬆️ 1.0.3.226407580**|SparkDiagnosticsLibrary|1.2.1|
|**Delta**|**4.1.0.20260430.1 ⬆️ 4.2.0.20260714.2**|SparkJobInsight|2.0.0|
|**Esri**|**1.0.0 ⬆️ 2.0.0**|SparkLineage|1.0.0|
|**EventStreamsFabricExtension**|**1.0.1 ⬆️ 4.1.1**|SparklyrConnector|1.0.0|
|**FabricDWConnector**|**1.0.24 ⬆️ 1.0.25**|SparkNativeParquetWriter|4.1.0-20260429.1|
|**FLTDeequ**|**2.0.18.1-msft**|SparkRPCHistoryServer|41.2.0|
|**FLTSparkExtensions**|**1.2.2 ⬆️ 1.7.1**|SparkSqlConnector|1.1.0.217307560|
|FLTSparkUtils|0.4.0|SQLServerODBCDriver|18.1.0|
|FsspecWrapper|2.0.0|**SStreamOnSparkJar**|**3.1.1 ⬆️ 3.1.2**|
|**Genesis**|**2.0.2 ⬆️ 2.0.4**|TokenLibrary|5.0.0|
|**GlutenUI**|**1.6.0-20260521.1 ⬆️ 1.6.0-20260718.1**|**TridentCore**|**1.3.4 ⬆️ 1.4.4**|
|HiveMetaStoreClient|1.1.21.2|**TridentTokenLibrary**|**2.4.0 ⬆️ 2.5.1**|
|**Iceberg**|**1.11.0**|UpgradeToFabric|1.2.15|
|**Impulse**|**1.5.217662871 ⬆️ 1.5.226604159**|**Vegas**|**4.1.0 ⬆️ 4.1.0.01**|
|**KustoConnector**|**2.0.4 ⬆️ 2.1.0**|**Wildfire**|**1.10.52 ⬆️ 1.10.59**|
|**LibraryManager**|**1.0.13 ⬆️ 1.0.18**|
|LibraryMetadataCooker|1.0.0|
|MlflowLibrary|2.18.0.1|
|**MMLSpark**|**1.4.27 ⬆️ 1.4.28**|
|**NotebookUtils**|**1.1.14.20260507.11 ⬆️ 1.1.15.20260524.4**|
|**OneLakeClientStarter**|**1.0.26.3 ⬆️ 1.0.28.0**|
|**OnelakeSparkCatalog**|**0.4.10 ⬆️ 0.4.16**|
|Python|3.13/1.0.0|
...
|_py-xgboost-mutex|2.0|**openssl**|**3.6.1 ⬆️ 3.6.3**|
|_python_abi3_support|1.0|**opentelemetry-api**|**1.40.0 ⬆️ 1.16.0**|
|adwaita-icon-theme|49.0|**opentelemetry-sdk**|**1.40.0 ⬆️ 1.16.0**|
|**aiohappyeyeballs**|**2.6.1 ⬆️ 2.7.1**|**opentelemetry-semantic-conventions**|**0.61b0 ⬆️ 0.37b0**|
|**aiohttp**|**3.13.3 ⬆️ 3.14.1**|packaging|24.2|
|aiosignal|1.4.0|pandas|2.3.3|
|**alsa-lib**|**1.2.15.3 ⬆️ 1.2.16.1**|pandasql|0.7.3|
|**amqp**|**5.3.1**|pango|1.56.4|
|**annotated-doc**|**0.0.4**|**parso**|**0.8.6 ⬆️ 0.8.7**|
|**annotated-types**|**0.7.0**|**pathspec**|**1.0.4 ⬆️ 1.1.1**|
|**anyio**|**4.12.1 ⬆️ 4.14.2**|patsy|1.0.2|
|asttokens|3.0.1|pcre2|10.47|
|at-spi2-atk|2.38.0|pexpect|4.9.0|
|at-spi2-core|2.40.3|**pillow**|**12.1.1 ⬆️ 12.3.0**|
|atk-1.0|2.38.0|**pip**|**25.3 ⬆️ 26.1.2**|
|**attrs**|**25.4.0 ⬆️ 26.1.0**|pixman|0.46.4|
|**azure-core**|**1.38.0 ⬆️ 1.39.0**|**platformdirs**|**4.9.4 ⬆️ 4.10.0**|
|**azure-storage-blob**|**12.28.0 ⬆️ 12.30.0**|**plotly**|**6.3.0 ⬆️ 6.7.0**|
|**azure-storage-file-datalake**|**12.14.0 ⬆️ 12.25.0**|portalocker|3.2.0|
|**backports.zstd**|**1.3.0 ⬆️ 1.6.0**|prompt-toolkit|3.0.52|
|**billiard**|**4.2.4**|**prompt_toolkit**|**3.0.52**|
|**boto3**|**1.43.45**|**propcache**|**0.3.1 ⬆️ 0.5.2**|
...
|**ca-certificates**|**2026.2.25 ⬆️ 2026.6.17**|**py-xgboost**|**2.1.1 ⬆️ 2.1.4**|
|cachetools|5.5.2|**pyasn1**|**0.6.2 ⬆️ 0.6.4**|
|cairo|1.18.4|pyasn1-modules|0.4.2|
|**celery**|**5.5.3**|**pycparser**|**2.22 ⬆️ 3.0**|
|**certifi**|**2026.2.25 ⬆️ 2026.6.17**|**pydantic**|**2.13.4**|
|**cffi**|**2.0.0 ⬆️ 2.1.0**|**pydantic-core**|**2.46.4**|
|**charset-normalizer**|**3.4.6 ⬆️ 3.4.9**|**pydantic-extra-types**|**2.11.1**|
|**click**|**8.3.1 ⬆️ 8.4.2**|**pydantic-settings**|**2.14.2**|
|**click-didyoumean**|**0.3.1**|**pygments**|**2.19.2 ⬆️ 2.20.0**|
|**click-plugins**|**1.1.1.2**|pyodbc|5.3.0|
|**click-repl**|**0.3.0**|pyparsing|3.3.2|
|cloudpickle|3.1.2|**pyside6**|**6.10.2 ⬆️ 6.11.1**|
|colorama|0.4.6|pysocks|1.7.1|
|comm|0.2.3|python|3.13.11|
|contourpy|1.3.3|python-dateutil|2.9.0.post0|
|**cpython**|**3.13.12 ⬆️ 3.13.14**|**python-discovery**|**1.4.4**|
|**cryptography**|**46.0.5 ⬆️ 49.0.0**|**python-dotenv**|**1.2.2**|
|cycler|0.12.1|**python-gil**|**3.13.12 ⬆️ 3.13.14**|
|cyrus-sasl|2.1.28|**python-graphviz**|**0.20.1 ⬆️ 0.20.3**|
|**databricks-sdk**|**0.100.0 ⬆️ 0.120.0**|**python-librt**|**0.13.0**|
|dbus|1.16.2|**python-multipart**|**0.0.32**|
|**debugpy**|**1.8.20 ⬆️ 1.8.21**|**python-tzdata**|**2025.3 ⬆️ 2026.3**|
|**decorator**|**5.2.1 ⬆️ 5.3.1**|python_abi|3.13|
|defusedxml|0.7.1|**pytz**|**2026.1.post1 ⬆️ 2026.2**|
|deprecated|1.3.1|pyu2f|0.1.5|
|**distlib**|**0.4.0 ⬆️ 0.4.3**|pyyaml|6.0.3|
|**dnspython**|**2.8.0**|pyzmq|27.1.0|
|double-conversion|3.4.0|qhull|2020.2|
|**email-validator**|**2.3.0**|**qt6-main**|**6.10.2 ⬆️ 6.11.1**|
|**email_validator**|**2.3.0**|readline|8.3|
|epoxy|1.5.10|**regex**|**2025.9.1 ⬆️ 2026.5.9**|
|et_xmlfile|2.0.0|**requests**|**2.32.5 ⬆️ 2.34.2**|
|exceptiongroup|1.3.1|**rich**|**14.3.3 ⬆️ 15.0.0**|
|executing|2.2.1|**rich-toolkit**|**0.20.1**|
|**fastapi**|**0.139.0**|rsa|4.9.1|
|**fastapi-cli**|**0.0.29**|**ruamel.yaml**|**0.18.16 ⬆️ 0.19.1**|
|**fastapi-core**|**0.139.0**|ruamel.yaml.clib|0.2.15|
|**fastar**|**0.11.0**|**s3transfer**|**0.19.1**|
|**filelock**|**3.25.2 ⬆️ 3.29.7**|**scikit-learn**|**1.5.2 ⬆️ 1.6.1**|
|**flask**|**2.2.5**|**scipy**|**1.17.1 ⬆️ 1.18.0**|
...
|**fontconfig**|**2.17.1 ⬆️ 2.18.1**|six|1.17.0|
|fonts-conda-ecosystem|1|**smmap**|**5.0.2 ⬆️ 5.0.3**|
|fonts-conda-forge|1|**sniffio**|**1.3.1**|
|**fonttools**|**4.62.0 ⬆️ 4.63.0**|**sqlalchemy**|**2.0.48 ⬆️ 2.0.51**|
|**freetype**|**2.14.2 ⬆️ 2.14.3**|sqlparse|0.5.5|
|fribidi|1.0.16|stack_data|0.6.3|
|**frozenlist**|**1.7.0 ⬆️ 1.8.0**|**starlette**|**1.3.1**|
|fsspec_wrapper|0.1.15|statsmodels|0.14.6|
|**gdk-pixbuf**|**2.44.5 ⬆️ 2.44.7**|threadpoolctl|3.6.0|
|gitdb|4.0.12|tk|8.6.13|
|**gitpython**|**3.1.46 ⬆️ 3.1.51**|**tomli**|**2.4.1**|
|**glib-tools**|**2.86.4 ⬆️ 2.88.2**|**tornado**|**6.5.4 ⬆️ 6.5.7**|
|**google-auth**|**2.49.1 ⬆️ 2.55.2**|**tqdm**|**4.67.1 ⬆️ 4.68.3**|
|**graphite2**|**1.3.14 ⬆️ 1.3.15**|**traitlets**|**5.14.3 ⬆️ 5.15.1**|
|graphviz|14.1.2|**typer**|**0.26.8**|
|**greenlet**|**3.3.2 ⬆️ 3.5.3**|**typing-extensions**|**4.15.0 ⬆️ 4.16.0**|
|**gtk3**|**3.24.51 ⬆️ 3.24.52**|**typing-inspection**|**0.4.2**|
|gts|0.7.6|**typing_extensions**|**4.15.0 ⬆️ 4.16.0**|
|h11|0.16.0|tzdata|2025c|
|h2|4.3.0|unixodbc|2.3.14|
|**harfbuzz**|**13.1.1 ⬆️ 14.2.1**|**urllib3**|**2.6.3 ⬆️ 2.7.0**|
|hicolor-icon-theme|0.17|**uvicorn**|**0.51.0**|
|**hpack**|**4.1.0 ⬆️ 4.2.0**|**uvicorn-standard**|**0.51.0**|
|httpcore|1.0.9|**uvloop**|**0.22.1**|
|**httptools**|**0.8.0**|**vine**|**5.1.0**|
|httpx|0.28.1|**virtualenv**|**20.28.0 ⬆️ 21.5.0**|
|hyperframe|6.1.0|**watchfiles**|**1.2.0**|
|**icu**|**78.2 ⬆️ 78.3**|**wayland**|**1.24.0 ⬆️ 1.25.0**|
|**idna**|**3.11 ⬆️ 3.18**|**wcwidth**|**0.6.0 ⬆️ 0.8.2**|
|**importlib-metadata**|**8.7.0 ⬆️ 8.8.0**|**websockets**|**16.1**|
|**ipykernel**|**6.31.0 ⬆️ 7.3.0**|**werkzeug**|**3.1.8**|
|**ipython**|**9.7.0 ⬆️ 9.14.0**|widgetsnbextension|4.0.15|
|ipython_pygments_lexers|1.1.1|**wrapt**|**2.1.2 ⬆️ 2.2.2**|
|ipywidgets|8.1.7|xcb-util|0.4.1|
|isodate|0.7.2|xcb-util-cursor|0.1.6|
|**itsdangerous**|**2.2.0**|xcb-util-image|0.4.0|
|**jedi**|**0.19.2 ⬆️ 0.20.0**|xcb-util-keysyms|0.4.1|
|jinja2|3.1.6|xcb-util-renderutil|0.3.10|
|**jmespath**|**1.1.0**|xcb-util-wm|0.4.2|
|**jupyter_client**|**8.8.0 ⬆️ 8.9.1**|**xgboost**|**2.1.1 ⬆️ 2.1.4**|
|jupyter_core|5.9.1|**xkeyboard-config**|**2.47 ⬆️ 2.48**|
...
|**lcms2**|**2.18 ⬆️ 2.19.1**|xorg-libxcomposite|0.4.7|
...
|**libboost**|**1.88.0 ⬆️ 1.90.0**|xorg-libxfixes|6.0.2|
|libbrotlicommon|1.2.0|**xorg-libxi**|**1.8.2 ⬆️ 1.8.3**|
|libbrotlidec|1.2.0|xorg-libxinerama|1.1.6|
|libbrotlienc|1.2.0|xorg-libxrandr|1.5.5|
|libcblas|3.11.0|xorg-libxrender|0.9.12|
|**libclang-cpp22.1**|**22.1.0 ⬆️ 22.1.8**|xorg-libxtst|1.2.5|
|**libclang13**|**22.1.0 ⬆️ 22.1.8**|xorg-libxxf86vm|1.1.7|
|libcups|2.3.3|xorg-xorgproto|2025.1|
|libdeflate|1.25|yaml|0.2.5|
|**libdrm**|**2.4.125 ⬆️ 2.4.127**|**yarl**|**1.23.0 ⬆️ 1.24.2**|
|libedit|3.1.20250104|zeromq|4.3.5|
|libegl|1.7.0|**zipp**|**3.23.0 ⬆️ 4.1.0**|
|libegl-devel|1.7.0|zlib-ng|2.3.3|
|**libexpat**|**2.7.4 ⬆️ 2.8.1**|zstd|1.5.7|
|libffi|3.5.2|**absl-py**|**2.4.0 ⬆️ 2.5.0**|
|**libfreetype**|**2.14.2 ⬆️ 2.14.3**|adlfs|2025.8.0|
|**libfreetype6**|**2.14.2 ⬆️ 2.14.3**|**alembic**|**1.18.4 ⬆️ 1.18.5**|
|libgcc|15.2.0|azure-datalake-store|0.0.53|
|libgcc-ng|15.2.0|azure-identity|1.25.3|
|libgd|2.3.3|**azure-keyvault-secrets**|**4.10.0 ⬆️ 4.11.0**|
|libgfortran|15.2.0|azureml-synapse|0.0.1|
|libgfortran5|15.2.0|catboost|1.2.10|
|libgl|1.7.0|**clr-loader**|**0.2.10 ⬆️ 0.3.1**|
|libgl-devel|1.7.0|cmdstanpy|1.3.0|
|**libglib**|**2.86.4 ⬆️ 2.88.2**|colorlog|6.10.1|
...
|**libharfbuzz**|**14.2.1**|**flaml**|**2.5.0.post3 ⬆️ 2.5.0.post6**|
|**libharfbuzz-devel**|**14.2.1**|**flt-python**|**1.2.2 ⬆️ 1.7.1**|
|libiconv|1.18|fluent-logger|0.10.0|
|**libjpeg-turbo**|**3.1.2 ⬆️ 3.2.0**|**fsspec**|**2026.2.0 ⬆️ 2026.6.0**|
|liblapack|3.11.0|**geoanalytics-fabric**|**2.0.0b0 ⬆️ 2.0.0**|
|liblightgbm|4.6.0|gson|0.0.4|
|**libllvm22**|**22.1.1 ⬆️ 22.1.8**|hcrystalball|0.1.10|
|**liblzma**|**5.8.2 ⬆️ 5.8.3**|**holidays**|**0.93 ⬆️ 0.100**|
|libmpdec|4.0.0|**importlib-resources**|**6.5.2 ⬆️ 7.1.0**|
|libntlm|1.8|**impulse-python-handler**|**1.5.214702911 ⬆️ 1.5.226604159**|
|**libopenblas**|**0.3.30 ⬆️ 0.3.33**|**joblib**|**1.3.2 ⬆️ 1.4.2**|
|libopengl|1.7.0|joblibspark|0.6.0|
|**libpciaccess**|**0.18 ⬆️ 0.19**|jsonschema|4.26.0|
|**libpng**|**1.6.55 ⬆️ 1.6.58**|jsonschema-specifications|2025.9.1|
|**libpq**|**18.3 ⬆️ 18.4**|jupyter-ui-poll|1.1.0|
|**librsvg**|**2.62.0 ⬆️ 2.62.3**|kqlmagiccustom|0.1.115+fabric.post26|
|**libsodium**|**1.0.21 ⬆️ 1.0.22**|library-metadata-cooker|3.7.0.0|
|**libsqlite**|**3.52.0 ⬆️ 3.53.3**|**lunardate**|**0.2.2 ⬆️ 0.3.0**|
|libstdcxx|15.2.0|**mako**|**1.3.10 ⬆️ 1.3.12**|
|libstdcxx-ng|15.2.0|**msal**|**1.35.1 ⬆️ 1.37.0**|
|**libtiff**|**4.7.1 ⬆️ 4.7.2**|msal-extensions|1.3.1|
|**libuuid**|**2.41.3 ⬆️ 2.42.2**|**msgpack**|**1.1.2 ⬆️ 1.2.1**|
|**libuv**|**1.52.1**|nbformat|5.10.4|
|libvulkan-loader|1.4.341.0|**nltk**|**3.9.3 ⬆️ 3.10.0**|
|libwebp-base|1.6.0|**notebookutils**|**1.1.14.40.20260507.11 ⬆️ 1.1.15.41.20260524.4**|
|libxcb|1.17.0|optuna|3.6.1|
|libxcrypt|4.4.36|pandasnet|1.0|
|**libxgboost**|**2.1.1 ⬆️ 2.1.4**|powerbiclient|3.1.1|
|**libxkbcommon**|**1.13.1 ⬆️ 1.13.2**|prophet|1.3.0|
|**libxml2**|**2.15.2 ⬆️ 2.15.3**|prose-pandas2pyspark|10.16.0|
|**libxml2-16**|**2.15.2 ⬆️ 2.15.3**|prose-suggestions|10.16.0|
|libxslt|1.1.43|py4j|0.10.9.9|
|**libzlib**|**1.3.1 ⬆️ 1.3.2**|**pyarrow**|**22.0.0 ⬆️ 24.0.0**|
|lightgbm|4.6.0|**pydeequ**|**1.5.0+msft.1**|
|**markdown-it-py**|**4.0.0 ⬆️ 4.2.0**|**pyjwt**|**2.12.1 ⬆️ 2.13.0**|
|markupsafe|3.0.3|pyluach|2.3.0|
|**matplotlib**|**3.10.6 ⬆️ 3.10.9**|pymeeus|0.5.12|
|**matplotlib-base**|**3.10.6 ⬆️ 3.10.9**|pyspark|4.1.1.5.5.20260428.5|
|**matplotlib-inline**|**0.2.1 ⬆️ 0.2.2**|**pythonnet**|**3.0.5 ⬆️ 3.1.0**|
|mdurl|0.1.2|referencing|0.37.0|
|**mlflow-skinny**|**2.18.0 ⬆️ 2.22.0**|rgf-python|3.12.0|
|multidict|6.7.1|rouge-score|0.1.2|
|munkres|1.1.4|**rpds-py**|**0.30.0 ⬆️ 2026.6.3**|
|**mypy**|**1.17.1 ⬆️ 1.20.2**|semantic-link-sempy|0.14.1|
|mypy_extensions|1.1.0|spark-mssql-connector-fabric41|1.1.0.217307560|
|**narwhals**|**2.18.0 ⬆️ 2.23.0**|sqlanalyticsfabricconnectorpy|1.0.1|
|**ncurses**|**6.5 ⬆️ 6.6**|stanio|0.5.1|
|**nest-asyncio2**|**1.7.2**|**synapseml**|**1.1.1+spark4.0 ⬆️ 1.1.3+spark4.1**|
|numpy|2.4.1|**synapseml-internal**|**1.1.1.0+spark4.0 ⬆️ 1.1.3.0+spark4.1**|
|**ocl-icd**|**2.3.3 ⬆️ 2.3.4**|synapseml-mlflow|2.0.4|
|opencl-headers|2025.06.13|synapseml-utils|1.1.14|
|openjpeg|2.5.4|tenacity|9.1.4|
|**openldap**|**2.6.10 ⬆️ 2.6.13**|workalendar|17.0.0|
...
|**flt-spark-sql-extensions**|**1.7.1**|org.eclipse.xtext.xbase.lib|2.28.0|
|**fmlv-utils**|**1.7.1**|oro|2.0.8|
...
|**hadoop-aliyun**|**3.4.2.5.5.20260521.3 ⬆️ 3.4.2.5.5.20260717.1**|parquet-column|1.16.0|
|**hadoop-annotations**|**3.4.2.5.5.20260521.3 ⬆️ 3.4.2.5.5.20260717.1**|parquet-common|1.16.0|
|**hadoop-aws**|**3.4.2.5.5.20260521.3 ⬆️ 3.4.2.5.5.20260717.1**|parquet-encoding|1.16.0|
|**hadoop-azure**|**3.4.2.5.5.20260521.3 ⬆️ 3.4.2.5.5.20260717.1**|parquet-format-structures|1.16.0|
|**hadoop-azure-datalake**|**3.4.2.5.5.20260521.3 ⬆️ 3.4.2.5.5.20260717.1**|parquet-hadoop|1.16.0|
|**hadoop-client-api**|**3.4.2.5.5.20260521.3 ⬆️ 3.4.2.5.5.20260717.1**|**parquet-hadoop-ms**|**4.1.1.5.5.20260521.3 ⬆️ 4.1.1.5.5.20260717.1**|
|**hadoop-client-runtime**|**3.4.2.5.5.20260521.3 ⬆️ 3.4.2.5.5.20260717.1**|parquet-jackson|1.16.0|
|**hadoop-cloud-storage**|**3.4.2.5.5.20260521.3 ⬆️ 3.4.2.5.5.20260717.1**|parsers|2.13-4.13.10|
|**hadoop-huaweicloud**|**3.4.2.5.5.20260521.3 ⬆️ 3.4.2.5.5.20260717.1**|pickle|1.5|
...
|impulse-telemetry-pulse_spark|2.13-1.5.214702911|**spark-arsenal**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|ini4j|0.5.4|**spark-avro**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|interface|1.0.28|**spark-catalyst**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|io|2.13-4.13.10|**spark-common-utils**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|istack-commons-runtime|4.1.2|**spark-common-utils-java**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|ivy|2.5.1|**spark-connect**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jackson-annotations|2.20|**spark-core**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jackson-core|2.20.0|**spark-enhancement**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jackson-databind|2.20.0|**spark-graphx**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jackson-dataformat-cbor|2.20.0|**spark-hadoop-cloud**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jackson-datatype-jsr310|2.20.0|**spark-hive**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jackson-module-scala|2.13-2.20.0|**spark-kvstore**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jakarta.activation-api|2.1.3|**spark-launcher**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jakarta.annotation-api|2.1.1|**spark-microsoft-tools**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jakarta.inject-api|2.0.1|**spark-mllib**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jakarta.servlet-api|5.0.0|**spark-mllib-local**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jakarta.validation-api|3.0.2|**spark-network-common**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jakarta.ws.rs-api|3.0.0|**spark-network-shuffle**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jakarta.xml.bind-api|4.0.2|**spark-onesecurity-client**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|janino|3.1.9|**spark-onesecurity-common**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|java-diff-utils|4.16|**spark-onesecurity-server**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|java-xmlbuilder|1.2|**spark-pipelines**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|javaparser-core|3.2.12|**spark-repl**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|javassist|3.30.2-GA|**spark-sketch**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|javatuples|1.2|**spark-sql**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|javax.annotation-api|1.3.2|**spark-sql-api**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|javax.jdo|3.2.0-m3|**spark-sql-kafka**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|javax.servlet-api|4.0.1|**spark-streaming**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|javolution|5.5.1|**spark-streaming-kafka**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jaxb-core|4.0.5|**spark-tags**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jaxb-runtime|4.0.5|**spark-token-provider-kafka**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jcip-annotations|1.0-1|**spark-unsafe**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jcl-over-slf4j|2.0.17|**spark-variant**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
|jdo-api|3.0.1|**spark-yarn**|**2.13-4.1.1.5.5.20260521.3 ⬆️ 2.13-4.1.1.5.5.20260717.1**|
...
|jjwt-impl|0.12.6|**tridenttokenlibrary-assembly**|**2.4.0 ⬆️ 2.5.1**|
...
|json4s-jackson-core|2.13-4.0.7|**zookeeper**|**3.8.4.5.5.20260521.3 ⬆️ 3.8.4.5.5.20260717.1**|
|json4s-scalap|2.13-4.0.7|**zookeeper-jute**|**3.8.4.5.5.20260521.3 ⬆️ 3.8.4.5.5.20260717.1**|
...
|V8|8.0.1|**notebookutils**|**1.1.14.40.20260507.11 ⬆️ 1.1.15.41.20260524.4**|
