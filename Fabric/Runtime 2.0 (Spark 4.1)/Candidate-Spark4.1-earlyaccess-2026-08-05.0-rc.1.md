...
*   **VHD Name**: 56b97950b2fa44.vhd
*   **Vhd Release**: Spark4.1-earlyaccess-2026-08-05.0-rc.1
...
|-----|-----|-----|
|2213051|SparkLineage:2.0.0|Updates the Spark 4.1 SparkLineage component to route Spark runtime (OpenLineage) events into the RTL platform in Fabric, replacing direct writes to the user's default Lakehouse. Enables Spark Runtime Lineage for LSEG (Private Preview).|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|2227306|ServiceConfigurationTemplates:spark/4.1.1|The default Parquet row-group size on Fabric Spark 4.1 is reduced from 1 GiB to 128 MiB, aligning it with the target file size and the OSS parquet-mr default. This yields finer row-group statistics, improving data skipping and reducing bytes read for scan-heavy queries.|
|2223725|ServiceConfigurationTemplates:spark/4.1.1|The OneSecurity async-shuffle index cache, data cache, and timing metrics are turned off by default in the Spark 4.1 runtime configuration.|
|2219324|ServiceConfigurationTemplates:spark/4.1.1|Set spark.dynamicAllocation.excludeDeltaSnapshotCache Spark config to true. It is needed so Delta log cache does not prevent executor scale down.|
|2200605|FLTSparkExtensions:1.7.2|Release new version 1.7.2 of FLTSparkExtensions with improvements in FileIngestion feature|
|2211001|TridentCore:1.4.6|Upgrades the TridentCore component to version 1.4.6 in the Spark 4.1 VHD.|


# Bug Fixes
|Id|Component|Description|
|-----|-----|-----|
|2225898|SparkLineage:2.0.1|Patch update to the Spark 4.1 SparkLineage component that picks up OpenLineage `openlineage-spark-4.1` @ 2.0.1. This release emits well-formed `file://` schemaURL URIs in the OneLake -> RTL runtime lineage events. No change to the transport behavior introduced in 2.0.0.|
...
|Conda|11.0.0|SparkAdvisor|1.0.5|
|CSparkMetricUpdate|1.0.3.226407580|SparkDiagnosticsLibrary|1.2.1|
|Delta|4.2.0.20260714.2|SparkJobInsight|2.0.0|
|Esri|2.0.0|**SparkLineage**|**1.0.0 ⬆️ 2.0.1**|
...
|**FLTSparkExtensions**|**1.7.1 ⬆️ 1.7.2**|SparkSqlConnector|1.1.0.217307560|
...
|**GlutenUI**|**1.6.0-20260718.1 ⬆️ 1.6.0-20260722.2**|**TridentCore**|**1.4.4 ⬆️ 1.4.6**|
|HiveMetaStoreClient|1.1.21.2|TridentTokenLibrary|2.5.1|
|Iceberg|1.11.0|UpgradeToFabric|1.2.15|
|Impulse|1.5.226604159|Vegas|4.1.0.01|
|KustoConnector|2.1.0|**Wildfire**|**1.10.59 ⬆️ 1.10.60**|
|LibraryManager|1.0.18|
|LibraryMetadataCooker|1.0.0|
|MlflowLibrary|2.18.0.1|
|MMLSpark|1.4.28|
|NotebookUtils|1.1.15.20260524.4|
|OneLakeClientStarter|1.0.28.0|
|**OnelakeSparkCatalog**|**0.4.16 ⬆️ 0.4.17**|
|Python|3.13/1.0.0|
...
|libharfbuzz-devel|14.2.1|**flt-python**|**1.7.1 ⬆️ 1.7.2**|
...
|libntlm|1.8|impulse-python-handler|1.5.226604159|
...
|ammonite-interp|2.13.17_2.13.17-3.0.3|lz4-java|1.8.1|
...
|arpack_combined_all|0.1|netty-all|4.2.15.Final|
|arrow-compression|18.3.0|netty-buffer|4.2.15.Final|
|arrow-format|18.3.0|netty-codec|4.2.15.Final|
|arrow-memory-core|18.3.0|netty-codec-base|4.2.15.Final|
|arrow-memory-netty|18.3.0|netty-codec-classes-quic|4.2.15.Final|
|arrow-memory-netty-buffer-patch|18.3.0|netty-codec-compression|4.2.15.Final|
|arrow-vector|18.3.0|netty-codec-dns|4.2.15.Final|
|audience-annotations|0.12.0|netty-codec-http|4.2.15.Final|
|avro|1.12.1|netty-codec-http2|4.2.15.Final|
|avro-ipc|1.12.1|netty-codec-http3|4.2.15.Final|
|avro-mapred|1.12.1|netty-codec-marshalling|4.2.15.Final|
|azure-data-lake-store-sdk|2.3.9|netty-codec-native-quic|4.2.15.Final-linux-aarch_64|
|azure-keyvault-core|1.0.0|netty-codec-native-quic|4.2.15.Final-linux-x86_64|
|azure-storage|7.0.1|netty-codec-native-quic|4.2.15.Final-osx-aarch_64|
|blas|3.0.4|netty-codec-native-quic|4.2.15.Final-osx-x86_64|
|breeze|2.13-2.1.0|netty-codec-native-quic|4.2.15.Final-windows-x86_64|
|breeze-macros|2.13-2.1.0|netty-codec-protobuf|4.2.15.Final|
|bsp4j|2.1.1|netty-codec-socks|4.2.15.Final|
|bundle|2.29.52|netty-common|4.2.15.Final|
|cats-kernel|2.13-2.8.0|netty-handler|4.2.15.Final|
|chill|2.13-0.10.0|netty-handler-proxy|4.2.15.Final|
|chill-java|0.10.0|netty-resolver|4.2.15.Final|
|class-path-util|2.13-0.1.4|netty-resolver-dns|4.2.15.Final|
...
|commons-crypto|1.1.0|netty-transport|4.2.15.Final|
|commons-dbcp|1.4|netty-transport-classes-epoll|4.2.15.Final|
|commons-io|2.21.0|netty-transport-classes-io_uring|4.2.15.Final|
|commons-lang|2.6|netty-transport-classes-kqueue|4.2.15.Final|
|commons-lang3|3.19.0|netty-transport-native-epoll|4.2.15.Final-linux-aarch_64|
|commons-math3|3.6.1|netty-transport-native-epoll|4.2.15.Final-linux-riscv64|
|commons-pool|1.5.4|netty-transport-native-epoll|4.2.15.Final-linux-x86_64|
|commons-pool2|2.12.1|netty-transport-native-io_uring|4.2.15.Final-linux-aarch_64|
|commons-text|1.14.0|netty-transport-native-io_uring|4.2.15.Final-linux-riscv64|
|compress-lzf|1.1.2|netty-transport-native-io_uring|4.2.15.Final-linux-x86_64|
|curator-client|5.9.0|netty-transport-native-kqueue|4.2.15.Final-osx-aarch_64|
|curator-framework|5.9.0|netty-transport-native-kqueue|4.2.15.Final-osx-x86_64|
|curator-recipes|5.9.0|netty-transport-native-unix-common|4.2.15.Final|
...
|**flt-spark-sql-extensions**|**1.7.1 ⬆️ 1.7.2**|org.eclipse.xtext.xbase.lib|2.28.0|
|**fmlv-utils**|**1.7.1 ⬆️ 1.7.2**|oro|2.0.8|
...
|**hadoop-aliyun**|**3.4.2.5.5.20260717.1 ⬆️ 3.4.2.5.5.20260803.3**|parquet-column|1.16.0|
|**hadoop-annotations**|**3.4.2.5.5.20260717.1 ⬆️ 3.4.2.5.5.20260803.3**|parquet-common|1.16.0|
|**hadoop-aws**|**3.4.2.5.5.20260717.1 ⬆️ 3.4.2.5.5.20260803.3**|parquet-encoding|1.16.0|
|**hadoop-azure**|**3.4.2.5.5.20260717.1 ⬆️ 3.4.2.5.5.20260803.3**|parquet-format-structures|1.16.0|
|**hadoop-azure-datalake**|**3.4.2.5.5.20260717.1 ⬆️ 3.4.2.5.5.20260803.3**|parquet-hadoop|1.16.0|
|**hadoop-client-api**|**3.4.2.5.5.20260717.1 ⬆️ 3.4.2.5.5.20260803.3**|**parquet-hadoop-ms**|**4.1.1.5.5.20260717.1 ⬆️ 4.1.1.5.5.20260803.3**|
|**hadoop-client-runtime**|**3.4.2.5.5.20260717.1 ⬆️ 3.4.2.5.5.20260803.3**|parquet-jackson|1.16.0|
|**hadoop-cloud-storage**|**3.4.2.5.5.20260717.1 ⬆️ 3.4.2.5.5.20260803.3**|parsers|2.13-4.13.10|
|**hadoop-huaweicloud**|**3.4.2.5.5.20260717.1 ⬆️ 3.4.2.5.5.20260803.3**|pickle|1.5|
...
|impulse-telemetry-pulse_spark|2.13-1.5.214702911|**spark-arsenal**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|ini4j|0.5.4|**spark-avro**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|interface|1.0.28|**spark-catalyst**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|io|2.13-4.13.10|**spark-common-utils**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|istack-commons-runtime|4.1.2|**spark-common-utils-java**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|ivy|2.5.1|**spark-connect**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jackson-annotations|2.20|**spark-core**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jackson-core|2.20.0|**spark-enhancement**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jackson-databind|2.20.0|**spark-graphx**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jackson-dataformat-cbor|2.20.0|**spark-hadoop-cloud**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jackson-datatype-jsr310|2.20.0|**spark-hive**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jackson-module-scala|2.13-2.20.0|**spark-kvstore**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jakarta.activation-api|2.1.3|**spark-launcher**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jakarta.annotation-api|2.1.1|**spark-microsoft-tools**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jakarta.inject-api|2.0.1|**spark-mllib**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jakarta.servlet-api|5.0.0|**spark-mllib-local**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jakarta.validation-api|3.0.2|**spark-network-common**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jakarta.ws.rs-api|3.0.0|**spark-network-shuffle**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jakarta.xml.bind-api|4.0.2|**spark-onesecurity-client**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|janino|3.1.9|**spark-onesecurity-common**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|java-diff-utils|4.16|**spark-onesecurity-server**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|java-xmlbuilder|1.2|**spark-pipelines**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|javaparser-core|3.2.12|**spark-repl**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|javassist|3.30.2-GA|**spark-sketch**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|javatuples|1.2|**spark-sql**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|javax.annotation-api|1.3.2|**spark-sql-api**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|javax.jdo|3.2.0-m3|**spark-sql-kafka**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|javax.servlet-api|4.0.1|**spark-streaming**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|javolution|5.5.1|**spark-streaming-kafka**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jaxb-core|4.0.5|**spark-tags**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jaxb-runtime|4.0.5|**spark-token-provider-kafka**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jcip-annotations|1.0-1|**spark-unsafe**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jcl-over-slf4j|2.0.17|**spark-variant**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
|jdo-api|3.0.1|**spark-yarn**|**2.13-4.1.1.5.5.20260717.1 ⬆️ 2.13-4.1.1.5.5.20260803.3**|
...
|jjwt-api|0.12.6|**trident-core**|**1.4.4 ⬆️ 1.4.6**|
...
|json4s-jackson-core|2.13-4.0.7|**zookeeper**|**3.8.4.5.5.20260717.1 ⬆️ 3.8.4.5.5.20260803.3**|
|json4s-scalap|2.13-4.0.7|**zookeeper-jute**|**3.8.4.5.5.20260717.1 ⬆️ 3.8.4.5.5.20260803.3**|
