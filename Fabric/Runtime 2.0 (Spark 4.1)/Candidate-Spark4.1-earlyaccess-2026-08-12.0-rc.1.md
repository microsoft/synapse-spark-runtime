...
*   **VHD Name**: 907123263f7d5a.vhd
*   **Vhd Release**: Spark4.1-earlyaccess-2026-08-12.0-rc.1
...
|-----|-----|-----|
|2229971|N/A|New Spark 4.1 Release which includes changes in wildfire-spark, wildfire-hadoop|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|2230778|Delta:4.2.0.20260810.3|Updates Delta for Fabric Runtime 2.0 (Spark 4.1) with fixes for auto-compaction eligibility, REORG PURGE executor session handling, and RLS enforcement on warm pooled clusters.|
|2229971|N/A|New Spark 4.1 Release which includes changes in wildfire-spark, wildfire-hadoop|
...
|-----|-----|-----|-----|
|**AutoscaleProbe**|**3.9.10 ⬆️ 3.9.11**|R|1.0.3|
...
|FLTSparkExtensions|1.7.2|SparkSqlConnector|1.1.0.217307560|
...
|**GlutenUI**|**1.6.0-20260722.2 ⬆️ 1.6.0-20260731.1**|TridentCore|1.4.6|
...
|KustoConnector|2.1.0|Wildfire|1.10.60|
...
|libharfbuzz-devel|14.2.1|flt-python|1.7.2|
...
|flt-spark-sql-extensions|1.7.2|org.eclipse.xtext.xbase.lib|2.28.0|
|fmlv-utils|1.7.2|oro|2.0.8|
...
|impulse-telemetry-pulse_spark|2.13-1.5.214702911|spark-arsenal|2.13-4.1.1.5.5.20260803.3|
|ini4j|0.5.4|spark-avro|2.13-4.1.1.5.5.20260803.3|
|interface|1.0.28|spark-catalyst|2.13-4.1.1.5.5.20260803.3|
|io|2.13-4.13.10|spark-common-utils|2.13-4.1.1.5.5.20260803.3|
|istack-commons-runtime|4.1.2|spark-common-utils-java|2.13-4.1.1.5.5.20260803.3|
|ivy|2.5.1|spark-connect|2.13-4.1.1.5.5.20260803.3|
|jackson-annotations|2.20|spark-core|2.13-4.1.1.5.5.20260803.3|
|jackson-core|2.20.0|spark-enhancement|2.13-4.1.1.5.5.20260803.3|
|jackson-databind|2.20.0|spark-graphx|2.13-4.1.1.5.5.20260803.3|
|jackson-dataformat-cbor|2.20.0|spark-hadoop-cloud|2.13-4.1.1.5.5.20260803.3|
|jackson-datatype-jsr310|2.20.0|spark-hive|2.13-4.1.1.5.5.20260803.3|
|jackson-module-scala|2.13-2.20.0|spark-kvstore|2.13-4.1.1.5.5.20260803.3|
|jakarta.activation-api|2.1.3|spark-launcher|2.13-4.1.1.5.5.20260803.3|
|jakarta.annotation-api|2.1.1|spark-microsoft-tools|2.13-4.1.1.5.5.20260803.3|
|jakarta.inject-api|2.0.1|spark-mllib|2.13-4.1.1.5.5.20260803.3|
|jakarta.servlet-api|5.0.0|spark-mllib-local|2.13-4.1.1.5.5.20260803.3|
|jakarta.validation-api|3.0.2|spark-network-common|2.13-4.1.1.5.5.20260803.3|
|jakarta.ws.rs-api|3.0.0|spark-network-shuffle|2.13-4.1.1.5.5.20260803.3|
|jakarta.xml.bind-api|4.0.2|spark-onesecurity-client|2.13-4.1.1.5.5.20260803.3|
|janino|3.1.9|spark-onesecurity-common|2.13-4.1.1.5.5.20260803.3|
|java-diff-utils|4.16|spark-onesecurity-server|2.13-4.1.1.5.5.20260803.3|
|java-xmlbuilder|1.2|spark-pipelines|2.13-4.1.1.5.5.20260803.3|
|javaparser-core|3.2.12|spark-repl|2.13-4.1.1.5.5.20260803.3|
|javassist|3.30.2-GA|spark-sketch|2.13-4.1.1.5.5.20260803.3|
|javatuples|1.2|spark-sql|2.13-4.1.1.5.5.20260803.3|
|javax.annotation-api|1.3.2|spark-sql-api|2.13-4.1.1.5.5.20260803.3|
|javax.jdo|3.2.0-m3|spark-sql-kafka|2.13-4.1.1.5.5.20260803.3|
|javax.servlet-api|4.0.1|spark-streaming|2.13-4.1.1.5.5.20260803.3|
|javolution|5.5.1|spark-streaming-kafka|2.13-4.1.1.5.5.20260803.3|
|jaxb-core|4.0.5|spark-tags|2.13-4.1.1.5.5.20260803.3|
|jaxb-runtime|4.0.5|spark-token-provider-kafka|2.13-4.1.1.5.5.20260803.3|
|jcip-annotations|1.0-1|spark-unsafe|2.13-4.1.1.5.5.20260803.3|
|jcl-over-slf4j|2.0.17|spark-variant|2.13-4.1.1.5.5.20260803.3|
|jdo-api|3.0.1|spark-yarn|2.13-4.1.1.5.5.20260803.3|
...
|jjwt-api|0.12.6|trident-core|1.4.6|
...
|json4s-jackson-core|2.13-4.0.7|zookeeper|3.8.4.5.5.20260803.3|
|json4s-scalap|2.13-4.0.7|zookeeper-jute|3.8.4.5.5.20260803.3|
