...
*   **Vhd Release**: Spark3.4-Rel-2025-01-22.0-rc.1
...
|1551758|OneLakeClientStarter:1.0.24|Upgrading OLC Client 176.68.0.|
...
|-----|-----|-----|-----|
|AutoscaleProbe|3.9.4|**OneLakeClientStarter**|**1.0.23.1 ⬆️ 1.0.24**|
...
|Conda|8.0.29|Python|3.10/2.0.0|
...
|FsspecWrapper|1.0.16|**SparkRPCHistoryServer**|**1.4.0 ⬆️ 1.5.0**|
|Genesis|0.33.1|SparklyrConnector|1.0.1|
|GlutenUI|1.0.1|**TokenLibrary**|**4.3.5 ⬆️ 4.3.6**|
|HiveMetaStoreClient|1.1.24|TridentCore|1.2.16|
|Impulse|1.2.5|**TridentTokenLibrary**|**1.9.6 ⬆️ 1.9.7**|
|KustoConnector|1.5.1|VPaaSClient|3.4.01|
|LibraryManager|1.0.24|Vegas|3.4.09.02|
|LibraryMetadataCooker|2.0.3|**Wildfire**|**1.9.23 ⬆️ 1.9.24**|
...
|huggingface_hub|0.18.0|semantic-link-sempy|0.8.4|
...
|json-tricks|3.17.3|**synapseml-cognitive**|**1.0.8 ⬆️ 1.0.9**|
|jsonpointer|2.4|**synapseml-core**|**1.0.8 ⬆️ 1.0.9**|
|jsonschema|4.19.1|**synapseml-deep-learning**|**1.0.8 ⬆️ 1.0.9**|
|jsonschema-specifications|2023.7.1|**synapseml-internal**|**1.0.8.0.dev1 ⬆️ 1.0.9.0.dev1**|
|jsonschema-with-format-nongpl|4.19.1|**synapseml-lightgbm**|**1.0.8 ⬆️ 1.0.9**|
|jupyter-ui-poll|0.2.2|synapseml-mlflow|1.0.30.post1|
|jupyter_client|8.5.0|**synapseml-opencv**|**1.0.8 ⬆️ 1.0.9**|
|jupyter_core|5.4.0|synapseml-utils|1.0.26|
|jupyter_events|0.8.0|**synapseml-vw**|**1.0.8 ⬆️ 1.0.9**|
...
|**TokenLibrary-assembly**|**4.3.5 ⬆️ 4.3.6**|jul-to-slf4j|2.0.6|
...
|avro-mapred|1.11.3|microsoft-catalog-metastore-client|1.1.24|
...
|commons-compress|1.22|notebook-utils|1.1.8-spark34-20241224.2|
...
|delta-core|2.12-2.4.0.22|parquet-encoding|1.12.3|
|delta-iceberg|2.12-2.4.0.22|parquet-format-structures|1.12.3|
|delta-storage|2.4.0.22|parquet-hadoop-ms|3.4.3.5.3.20241209.1|
...
|hadoop-aliyun|3.3.4.5.3.20241209.1|rocksdbjni|7.9.2|
|hadoop-annotations|3.3.4.5.3.20241209.1|scala-collection-compat|2.12-2.7.0|
|hadoop-aws|3.3.4.5.3.20241209.1|scala-compiler|2.12.17|
|hadoop-azure|3.3.4.5.3.20241209.1|scala-java8-compat|2.12-0.9.0|
|hadoop-azure-datalake|3.3.4.5.3.20241209.1|scala-library|2.12.17|
|hadoop-azureml|1.0-fs|scala-parser-combinators|2.12-2.1.1|
|hadoop-client-api|3.3.4.5.3.20241209.1|scala-reflect|2.12.17|
|hadoop-client-runtime|3.3.4.5.3.20241209.1|scala-xml|2.12-2.1.0|
|hadoop-cloud-storage|3.3.4.5.3.20241209.1|scalactic|2.12-3.2.14|
|hadoop-openstack|3.3.4.5.3.20241209.1|shims|0.9.38|
|hadoop-shaded-guava|1.1.1|slf4j-api|2.0.6|
|hadoop-yarn-server-web-proxy|3.3.4.5.3.20241209.1|snappy-java|1.1.10.5|
...
|hive-metastore|2.3.9|spark-avro|2.12-3.4.3.5.3.20241209.1|
|hive-serde|2.3.9|spark-catalyst|2.12-3.4.3.5.3.20241209.1|
|hive-shims|2.3.9|spark-core|2.12-3.4.3.5.3.20241209.1|
|hive-shims|0.23-2.3.9|spark-enhancement|2.12-3.4.3.5.3.20241209.1|
|hive-shims-common|2.3.9|spark-enhancementui|2.12-3.3.0|
|hive-shims-scheduler|2.3.9|spark-graphx|2.12-3.4.3.5.3.20241209.1|
|hive-storage-api|2.8.1|spark-hadoop-cloud|2.12-3.4.3.5.3.20241209.1|
|hk2-api|2.6.1|spark-hive|2.12-3.4.3.5.3.20241209.1|
|hk2-locator|2.6.1|spark-kusto-synapse-connector|3.4_2.12-1.5.1|
|hk2-utils|2.6.1|spark-kvstore|2.12-3.4.3.5.3.20241209.1|
|httpclient|4.5.14|spark-launcher|2.12-3.4.3.5.3.20241209.1|
...
|httpmime|4.5.14|spark-microsoft-tools|2.12-3.4.3.5.3.20241209.1|
|httpmime|4.5.13|spark-mllib|2.12-3.4.3.5.3.20241209.1|
|impulse-core_spark|3.4_2.12-1.0.22|spark-mllib-local|2.12-3.4.3.5.3.20241209.1|
|impulse-telemetry-mds_spark|3.4_2.12-1.0.22|spark-network-common|2.12-3.4.3.5.3.20241209.1|
|ini4j|0.5.4|spark-network-shuffle|2.12-3.4.3.5.3.20241209.1|
|isolation-forest|3.4.2_2.12-3.0.4|spark-repl|2.12-3.4.3.5.3.20241209.1|
|istack-commons-runtime|3.0.8|spark-sketch|2.12-3.4.3.5.3.20241209.1|
|ivy|2.5.1|spark-sql|2.12-3.4.3.5.3.20241209.1|
|jackson-annotations|2.14.2|spark-sql-kafka|0_2.12-3.4.3.5.3.20241209.1|
|jackson-core|2.14.2|spark-streaming|2.12-3.4.3.5.3.20241209.1|
|jackson-core-asl|1.9.13|spark-streaming-kafka|0_2.12-3.4.3.5.3.20241209.1|
|jackson-databind|2.14.2|spark-streaming-kafka|2.12-3.4.3.5.3.20241209.1|
|jackson-dataformat-cbor|2.14.2|spark-tags|2.12-3.4.3.5.3.20241209.1|
|jackson-datatype-jsr310|2.14.2|spark-token-provider-kafka|0_2.12-3.4.3.5.3.20241209.1|
|jackson-mapper-asl|1.9.13|spark-unsafe|2.12-3.4.3.5.3.20241209.1|
|jackson-module-scala|2.12-2.14.2|spark-yarn|2.12-3.4.3.5.3.20241209.1|
|jakarta.annotation-api|1.3.5|spark_diagnostic_cli|2.1.7_spark-3.4.1_20250107.2-shaded|
...
|jaxb-api|2.2.11|**synapseml-cognitive**|**2.12-1.0.8 ⬆️ 2.12-1.0.9**|
|jaxb-runtime|2.3.2|**synapseml-core**|**2.12-1.0.8 ⬆️ 2.12-1.0.9**|
|jcl-over-slf4j|2.0.6|**synapseml-deep-learning**|**2.12-1.0.8 ⬆️ 2.12-1.0.9**|
|jdo-api|3.0.1|**synapseml-internal**|**2.12-1.0.8.0-spark3.4 ⬆️ 2.12-1.0.9.0-spark3.4**|
|jdom2|2.0.6|**synapseml-lightgbm**|**2.12-1.0.8 ⬆️ 2.12-1.0.9**|
|jersey-client|2.36|**synapseml-opencv**|**2.12-1.0.8 ⬆️ 2.12-1.0.9**|
|jersey-common|2.36|**synapseml-vw**|**2.12-1.0.8 ⬆️ 2.12-1.0.9**|
|jersey-container-servlet|2.36|synfs|1.1.8-spark34-20241224.2|
...
|jetty-util|9.4.54.v20240208|**tridenttokenlibrary-assembly**|**1.9.6 ⬆️ 1.9.7**|
...
|jsch|0.1.54|xz|1.9|
|json|3|zookeeper|3.6.3.5.3.20241209.1|
|json|1.8|zookeeper-jute|3.6.3.5.3.20241209.1|
