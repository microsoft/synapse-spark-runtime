...
*   **VHD Name**: 7d519644da98f0.vhd
*   **Vhd Release**: Spark3.4-Rel-2025-02-19.0-rc.1
...
|backcall|0.2.0|notebookutils|1.1.8.34.20241224.2|
...
|**chat-magics**|**0.1.25.2.11**|paramiko|3.3.1|
|**chat-magics-fabric**|**0.2.0.25.2.11**|parso|0.8.3|
...
|**ds-copilot**|**0.1.25.2.11**|pycparser|2.21|
|**dscopilot-installer**|**0.0.7 ⬆️ 0.0.9**|pydantic|1.10.9|
...
|**fabric-connection**|**0.1.0**|pyparsing|3.0.9|
...
|**fsspec_wrapper**|**0.1.12 ⬆️ 0.1.15**|pytz|2023.3.post1|
...
|holidays|0.35|**semantic-link-sempy**|**0.8.4 ⬆️ 0.9.0**|
