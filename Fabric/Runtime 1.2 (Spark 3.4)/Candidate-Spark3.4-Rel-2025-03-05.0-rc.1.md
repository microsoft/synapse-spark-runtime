...
*   **Vhd Release**: Spark3.4-Rel-2025-03-05.0-rc.1
...
|backcall|0.2.0|**notebookutils**|**1.1.8.34.20241224.2 ⬆️ 1.1.9.34.20250224.5**|
...
|**hdinsight-spark-metrics**|**3.4.0-1.0.8 ⬆️ 3.4.0-1.0.9**|spark|3.4-rpc-history-server-core_2.12-1.0.0|
