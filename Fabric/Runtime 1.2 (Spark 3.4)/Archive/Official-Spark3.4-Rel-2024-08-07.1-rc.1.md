...
*   **Vhd Release**: Spark3.4-Rel-2024-08-07.1-rc.1
...
|-----|-----|-----|
|1416718|FabricDWConnector: 1.0.10|Python Bindings for Spark Connector for Data Warehouse in Fabric|
|1421822|TokenLibrary:4.2.2|Get Access token retries on IOException. Improve logging to track get access token requests.  Retrieve an access token directly from Azure Entra ID for a given service principal and a certificate that will be downloaded from a given keyvault.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|1422160|Delta:2.4.0.19|Delta version update contains a bug fix when OptimizeWrite enabled and coalesce is used at the end of write job. It also contains changes where we skip collecting commit stats to prevent computing Snapshot state.|
|1421822|TokenLibrary:4.2.2|Get Access token retries on IOException. Improve logging to track get access token requests.  Retrieve an access token directly from Azure Entra ID for a given service principal and a certificate that will be downloaded from a given keyvault.|
...
|Conda|8.0.17|SQLServerODBCDriver|18.1.0|
|CosmosDBConnector|2.1.1|**SStreamOnSparkJar**|**2.3.5 ⬆️ 2.3.5.1**|
|**DSCopilotInstaller**|**1.0.0**|SparkAdvisor|1.0.2|
|DWConnector|1.0.2|**SparkDiagnosticsLibrary**|**1.0.23 ⬆️ 1.0.24**|
|**Delta**|**2.4.0.18 ⬆️ 2.4.0.19**|SparkLighter|2.0.9|
...
|Genesis|0.30.0|**TokenLibrary**|**4.1.2 ⬆️ 4.2.2**|
|HiveMetaStoreClient|1.1.21|TridentCore|1.2.9|
|Impulse|1.2.5|TridentTokenLibrary|1.9.4|
|**KustoConnector**|**1.3.8 ⬆️ 1.5.1**|Vegas|3.4.09.01|
...
|azure-synapse-ml-predict|1.0.0|notebookutils|1.1.2.34.20240702.2|
...
|flaml|2.1.2+20240517|pyperclip|1.8.2|
...
|**TokenLibrary-assembly**|**4.1.2 ⬆️ 4.2.2**|jul-to-slf4j|2.0.6|
...
|commons-crypto|1.1.0|notebook-utils|1.1.2-spark34-20240702.2|
...
|**delta-core**|**2.12-2.4.0.18 ⬆️ 2.12-2.4.0.19**|parquet-common|1.12.3|
|**delta-iceberg**|**2.12-2.4.0.18 ⬆️ 2.12-2.4.0.19**|parquet-encoding|1.12.3|
|**delta-storage**|**2.4.0.18 ⬆️ 2.4.0.19**|parquet-format-structures|1.12.3|
...
|hk2-utils|2.6.1|**spark-kusto-synapse-connector**|**3.4_2.12-1.3.8-uber ⬆️ 3.4_2.12-1.5.1**|
...
|jakarta.inject|2.6.1|**spark_diagnostic_cli**|**2.1.3_spark-3.4.1_20240724.6 ⬆️ 2.1.3_spark-3.4.1_20240731.2**|
...
|jersey-container-servlet-core|2.36|synfs|1.1.2-spark34-20240702.2|
...
|V8|4.4.1|notebookutils|1.1.2.34.20240702.2|
