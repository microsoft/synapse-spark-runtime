...
*   **VHD Name**: 46097759b2f2fc.vhd
*   **Vhd Release**: Spark3.4-Rel-2025-12-03.3-rc.1
...
|-----|-----|-----|
|1848291|NotebookUtils:1.1.63|Released NotebookUtils 1.1.12 with new features, bug fixes, and enhancements, including a new Azure Key Vault API, improved HTTP retry logic, enhanced UDF header processing, cache timeout configuration, and security updates.|
|1849372|Wildfire/spark34:1.9.38.1|New Spark 3.4 Release which includes changes in wildfire-livy|
|1874718|OnelakeSparkCatalog:0.2.26, TridentCore:1.2.30|Introduces updated Persistent Views implementation and fixes a bug from a previous catalog release affecting Spark 3.4 pipelines.|
|1816566|Wildfire/spark34:1.9.37.1|Introduces Spark 3.4 release with updates and improvements in wildfire-spark.|
|1823541|OnelakeSparkCatalog:0.2.21, TridentCore:1.2.28|Adds external table support and APIs for altering, dropping, and renaming partitions for non-delta tables in OneLakeSparkCatalog.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|1887845|OnelakeSparkCatalog:0.2.28|Updates OneLakeSparkCatalog with improvements, including removal of PII from telemetry and test-related changes.|
|1848291|NotebookUtils:1.1.63|Released NotebookUtils 1.1.12 with new features, bug fixes, and enhancements, including a new Azure Key Vault API, improved HTTP retry logic, enhanced UDF header processing, cache timeout configuration, and security updates.|
|1849372|Wildfire/spark34:1.9.38.1|New Spark 3.4 Release which includes changes in wildfire-livy|
|1816566|Wildfire/spark34:1.9.37.1|Introduces Spark 3.4 release with updates and improvements in wildfire-spark.|
|1823541|OnelakeSparkCatalog:0.2.21, TridentCore:1.2.28|Adds external table support and APIs for altering, dropping, and renaming partitions for non-delta tables in OneLakeSparkCatalog.|
|1843032|NotebookUtils:1.1.62.3|Introduces `notebookutils.credentials.getSecretWithConnection` API for secure secret retrieval using Fabric connections and implements secret redaction in DMTS API responses to enhance credential security.|


# Bug Fixes
|Id|Component|Description|
|-----|-----|-----|
|1899032|OnelakeSparkCatalog:0.3.1|Without this fix, tables created by previous version of catalog were not discoverable|
|1848274|OnelakeSparkCatalog:0.2.23, TridentCore:1.2.29|Disables views support in Spark 3.x to prevent conflicts with warehouse artifacts' md-sync process. Provides configuration options for select customers to enable views as needed.|
|1848291|NotebookUtils:1.1.63|Released NotebookUtils 1.1.12 with new features, bug fixes, and enhancements, including a new Azure Key Vault API, improved HTTP retry logic, enhanced UDF header processing, cache timeout configuration, and security updates.|
|1874718|OnelakeSparkCatalog:0.2.26, TridentCore:1.2.30|Introduces updated Persistent Views implementation and fixes a bug from a previous catalog release affecting Spark 3.4 pipelines.|
...
|Autotune|1.11.1.1|**OnelakeSparkCatalog**|**0.2.17 ⬆️ 0.3.1**|
...
|backcall|0.2.0|**notebookutils**|**1.1.11.34.20251021.12 ⬆️ 1.1.12.34**|
...
|chat-magics|0.1.25.2.28|paramiko|3.3.1|
|chat-magics-fabric|0.2.0.25.8.13|parso|0.8.3|
...
|ds-copilot|0.1.25.2.28|pycparser|2.21|
...
|holidays|0.35|semantic-link-sempy|0.11.0|
...
|commons-compress|1.22|**notebook-utils**|**1.1.11-spark34-20251021.12 ⬆️ 1.1.12-spark34**|
...
|delta-storage|2.4.0.25|**parquet-hadoop-ms**|**3.4.3.5.3.20250819.1 ⬆️ 3.4.3.5.3.20251027.3**|
...
|genesis-client|2.12-0.34.0-jar-with-dependencies|proton-j|0.33.8|
|gson|2.8.9|py4j|0.10.9.7|
|guava|4.0.1|qpid-proton-j-extensions|1.2.4|
|**hadoop-aliyun**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|rocksdbjni|7.9.2|
|**hadoop-annotations**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|scala-collection-compat|2.12-2.7.0|
|**hadoop-aws**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|scala-compiler|2.12.17|
|**hadoop-azure**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure-datalake**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|scala-library|2.12.17|
|hadoop-azureml|1.0-fs|scala-parser-combinators|2.12-2.1.1|
|**hadoop-client-api**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|scala-reflect|2.12.17|
|**hadoop-client-runtime**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|scala-xml|2.12-2.1.0|
|**hadoop-cloud-storage**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|scalactic|2.12-3.2.14|
|**hadoop-openstack**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|shims|0.9.38|
|hadoop-shaded-guava|1.1.1|slf4j-api|2.0.6|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.3.20250819.1 ⬆️ 3.3.4.5.3.20251027.3**|snappy-java|1.1.10.5|
|hdinsight-spark-metrics|3.4.0-1.0.11|spark|3.4-rpc-history-server-core_2.12-1.0.0|
...
|hive-llap-common|2.3.9|**spark-avro**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|hive-metastore|2.3.9|spark-avro|2.12-3.4.1|
|hive-serde|2.3.9|**spark-catalyst**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|hive-shims|0.23-2.3.9|**spark-core**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|hive-shims|2.3.9|**spark-enhancement**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|hive-shims-common|2.3.9|spark-enhancementui|2.12-3.3.0|
|hive-shims-scheduler|2.3.9|**spark-graphx**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|hive-storage-api|2.8.1|**spark-hadoop-cloud**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|hk2-api|2.6.1|**spark-hive**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|hk2-locator|2.6.1|spark-kusto-synapse-connector|3.4_2.12-1.5.3|
|hk2-utils|2.6.1|**spark-kvstore**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|httpclient|4.5.14|**spark-launcher**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
...
|httpmime|4.5.13|**spark-microsoft-tools**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|httpmime|4.5.14|**spark-mllib**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|impulse-core_spark|3.4_2.12-1.0.22|**spark-mllib-local**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|impulse-telemetry-mds_spark|3.4_2.12-1.0.22|**spark-network-common**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|ini4j|0.5.4|**spark-network-shuffle**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|isolation-forest|3.4.2_2.12-3.0.4|**spark-repl**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|istack-commons-runtime|3.0.8|**spark-sketch**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|ivy|2.5.1|**spark-sql**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|jackson-annotations|2.14.2|**spark-sql-kafka**|**0_2.12-3.4.3.5.3.20250819.1 ⬆️ 0_2.12-3.4.3.5.3.20251027.3**|
|jackson-core|2.14.2|**spark-streaming**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|jackson-core-asl|1.9.13|**spark-streaming-kafka**|**0_2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|jackson-databind|2.14.2|**spark-streaming-kafka**|**0_2.12-3.4.3.5.3.20250819.1 ⬆️ 0_2.12-3.4.3.5.3.20251027.3**|
|jackson-dataformat-cbor|2.14.2|**spark-tags**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|jackson-datatype-jsr310|2.14.2|**spark-token-provider-kafka**|**0_2.12-3.4.3.5.3.20250819.1 ⬆️ 0_2.12-3.4.3.5.3.20251027.3**|
|jackson-mapper-asl|1.9.13|**spark-unsafe**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
|jackson-module-scala|2.12-2.14.2|**spark-yarn**|**2.12-3.4.3.5.3.20250819.1 ⬆️ 2.12-3.4.3.5.3.20251027.3**|
...
|jersey-container-servlet|2.36|**synfs**|**1.1.11-spark34-20251021.12 ⬆️ 1.1.12-spark34**|
|jersey-container-servlet-core|2.36|threeten-extra|1.7.1|
|jersey-hk2|2.36|tink|1.7.0|
|jersey-server|2.36|transaction-api|1.1|
|jettison|1.1|**trident-core**|**1.2.26 ⬆️ 1.2.30**|
...
|jsch|0.1.54|xz|1.9|
|json|1.8|**zookeeper**|**3.6.3.5.3.20250819.1 ⬆️ 3.6.3.5.3.20251027.3**|
|json|3|**zookeeper-jute**|**3.6.3.5.3.20250819.1 ⬆️ 3.6.3.5.3.20251027.3**|
...
|TTR|0.24.4|**notebookutils**|**1.1.11.34.20251021.12 ⬆️ 1.1.12.34**|
