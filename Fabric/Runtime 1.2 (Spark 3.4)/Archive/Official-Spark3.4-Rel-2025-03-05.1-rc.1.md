...
*   **VHD Name**: 2f791437f90184.vhd
*   **Vhd Release**: Spark3.4-Rel-2025-03-05.1-rc.1
...
|Id|Component|Description|
|-----|-----|-----|
|1590273|DSCopilot:1.1.0|Updated DS Copilot to V2, improving code generation and schema indexing for Spark 3.4.|
...
|1586148|OneLakeClientStarter:1.0.24.3|Fixed a minor bug in the setup script for OneLakeClientStarter, ensuring correct flag population for PL enabling in Spark 3.4. This fix supports One Lake operations when PL is enabled.|
|1588637|NotebookUtils:1.1.56|Improve display function experience and notebookutils.fs.put support instant file flush and some other bug fixes.|
...
|Autotune|1.11.1.1|**OneLakeClientStarter**|**1.0.24.1 ⬆️ 1.0.24.3**|
...
|LibraryMetadataCooker|2.0.3|**Wildfire**|**1.9.25 ⬆️ 1.9.26**|
|MMLSpark|1.4.20|
...
|httpmime|4.5.14|spark-mllib|2.12-3.4.3.5.3.20250203.5|
|httpmime|4.5.13|spark-mllib-local|2.12-3.4.3.5.3.20250203.5|
