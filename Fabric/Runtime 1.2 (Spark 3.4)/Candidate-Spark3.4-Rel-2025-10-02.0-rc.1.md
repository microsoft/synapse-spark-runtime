...
*   **VHD Name**: 77886013a1fffa.vhd
*   **Vhd Release**: Spark3.4-Rel-2025-10-02.0-rc.1
...
|-----|-----|-----|
|1803941|TridentCore:1.1.26, OnelakeSparkCatalog:0.2.17|Introduces Private Link support for OneLakeSparkCatalog, enabling private workspace capabilities and updating Trident Core with helper APIs for OneLake path and URL handling.|
|1769935|SparkClusterLogs:1.104|Adds functionality to publish Clam AV logs to the FssNodeScannerEvent Kusto table, enabling enhanced log management and fraud detection capabilities.|
|1775349|Wildfire/spark34:1.9.36.1|Introduces new Spark 3.4 release with updates to wildfire-spark and wildfire-hadoop components.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|1779658|conda:8.0.43|Updates FLAML to enhance AutoML experiences and address recent bug fixes in Spark 3.4.|
|1775349|Wildfire/spark34:1.9.36.1|Introduces new Spark 3.4 release with updates to wildfire-spark and wildfire-hadoop components.|
...
|Id|Component|Description|
|-----|-----|-----|
|1817152|FabricDWConnector:1.0.21|Upgrades Fabric DW Connector to address expired SAS token issues by using dynamic token retrieval and enhances support for workspace private link configurations with the warehouses API.|
|1779658|conda:8.0.43|Updates FLAML to enhance AutoML experiences and address recent bug fixes in Spark 3.4.|
|1774411|DSCopilot:1.2.2|Fixes DS Copilot lakehouse access issues and adds support for new LLMs, including gpt-4.1 and gpt-5 if available. Updates SQL queries for improved functionality.|
|1778130|SparkRPCHistoryServer:1.8.0|Addressed an issue in SparkRPCHistoryServer where JSON deserialization could result in improper handling of sensitive data in telemetry|
...
|Autotune|1.11.1.1|**OnelakeSparkCatalog**|**0.2.13 ⬆️ 0.2.17**|
...
|**DSCopilot**|**1.2.1 ⬆️ 1.2.2**|SparkDiagnosticsLibrary|1.0.31|
...
|ExternalHiveMetastoreLibraries|0.0.7|**SparkRPCHistoryServer**|**1.6.0 ⬆️ 1.8.0**|
|**FabricDWConnector**|**1.0.11 ⬆️ 1.0.21**|SQLServerODBCDriver|18.1.0|
|FsspecWrapper|1.0.18|SStreamOnSparkJar|2.3.5.1|
|Genesis|0.34.0|TokenLibrary|4.3.8|
|HiveMetaStoreClient|1.1.21.2|**TridentCore**|**1.2.25 ⬆️ 1.2.26**|
|Impulse|1.2.5|TridentTokenLibrary|1.9.14|
|KustoConnector|1.5.3|Vegas|3.4.09.03|
|LibraryManager|1.0.31|VPaaSClient|3.4.01|
|LibraryMetadataCooker|2.0.3|**Wildfire**|**1.9.35.1 ⬆️ 1.9.36.1**|
...
|**chat-magics-fabric**|**0.2.0.25.8.21 ⬆️ 0.2.0.25.8.13**|parso|0.8.3|
...
|**flaml**|**2.3.4.post2 ⬆️ 2.3.6.post1**|pyqt|5.15.9|
...
|holidays|0.35|**semantic-link-sempy**|**0.10.2 ⬆️ 0.11.0**|
...
|delta-storage|2.4.0.25|**parquet-hadoop-ms**|**3.4.3.5.3.20250628.1 ⬆️ 3.4.3.5.3.20250819.1**|
...
|**hadoop-aliyun**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|rocksdbjni|7.9.2|
|**hadoop-annotations**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|scala-collection-compat|2.12-2.7.0|
|**hadoop-aws**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|scala-compiler|2.12.17|
|**hadoop-azure**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure-datalake**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|scala-library|2.12.17|
|hadoop-azureml|1.0-fs|scala-parser-combinators|2.12-2.1.1|
|**hadoop-client-api**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|scala-reflect|2.12.17|
|**hadoop-client-runtime**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|scala-xml|2.12-2.1.0|
|**hadoop-cloud-storage**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|scalactic|2.12-3.2.14|
|**hadoop-openstack**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|shims|0.9.38|
|hadoop-shaded-guava|1.1.1|slf4j-api|2.0.6|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.3.20250628.1 ⬆️ 3.3.4.5.3.20250819.1**|snappy-java|1.1.10.5|
...
|hive-metastore|2.3.9|**spark-avro**|**2.12-3.4.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|hive-serde|2.3.9|**spark-catalyst**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|hive-shims|2.3.9|**spark-core**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|hive-shims|0.23-2.3.9|**spark-enhancement**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|hive-shims-common|2.3.9|spark-enhancementui|2.12-3.3.0|
|hive-shims-scheduler|2.3.9|**spark-graphx**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|hive-storage-api|2.8.1|**spark-hadoop-cloud**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|hk2-api|2.6.1|**spark-hive**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|hk2-locator|2.6.1|spark-kusto-synapse-connector|3.4_2.12-1.5.3|
|hk2-utils|2.6.1|**spark-kvstore**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|httpclient|4.5.14|**spark-launcher**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
...
|httpmime|4.5.14|**spark-microsoft-tools**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|httpmime|4.5.13|**spark-mllib**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|impulse-core_spark|3.4_2.12-1.0.22|**spark-mllib-local**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|impulse-telemetry-mds_spark|3.4_2.12-1.0.22|**spark-network-common**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|ini4j|0.5.4|**spark-network-shuffle**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|isolation-forest|3.4.2_2.12-3.0.4|**spark-repl**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|istack-commons-runtime|3.0.8|**spark-sketch**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|ivy|2.5.1|**spark-sql**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|jackson-annotations|2.14.2|**spark-sql-kafka**|**0_2.12-3.4.3.5.3.20250628.1 ⬆️ 0_2.12-3.4.3.5.3.20250819.1**|
|jackson-core|2.14.2|**spark-streaming**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|jackson-core-asl|1.9.13|**spark-streaming-kafka**|**0_2.12-3.4.3.5.3.20250628.1 ⬆️ 0_2.12-3.4.3.5.3.20250819.1**|
|jackson-databind|2.14.2|**spark-streaming-kafka**|**0_2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|jackson-dataformat-cbor|2.14.2|**spark-tags**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|jackson-datatype-jsr310|2.14.2|**spark-token-provider-kafka**|**0_2.12-3.4.3.5.3.20250628.1 ⬆️ 0_2.12-3.4.3.5.3.20250819.1**|
|jackson-mapper-asl|1.9.13|**spark-unsafe**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
|jackson-module-scala|2.12-2.14.2|**spark-yarn**|**2.12-3.4.3.5.3.20250628.1 ⬆️ 2.12-3.4.3.5.3.20250819.1**|
...
|jettison|1.1|**trident-core**|**1.2.25 ⬆️ 1.2.26**|
...
|jsch|0.1.54|xz|1.9|
|json|3|**zookeeper**|**3.6.3.5.3.20250628.1 ⬆️ 3.6.3.5.3.20250819.1**|
|json|1.8|**zookeeper-jute**|**3.6.3.5.3.20250628.1 ⬆️ 3.6.3.5.3.20250819.1**|
