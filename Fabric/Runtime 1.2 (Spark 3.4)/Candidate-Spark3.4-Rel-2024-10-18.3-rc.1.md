...
*   **Vhd Release**: Spark3.4-Rel-2024-10-18.3-rc.1
...
|-----|-----|-----|
|1498965|MMLSpark:1.4.19|Updated the SynapseML distributed machine learning framework libraries shipped as part of Fabric VHD component https://github.com/microsoft/SynapseML/releases/tag/v1.0.8.|
|1498978|TridentTokenLibrary:1.9.6,Conda:8.0.25|Upgrade SynapseML-Utils and TridentTokenLibrary to support ML 1P Token and MWC Token used in openai calls for billing purposes. Migrate to Fabric Public API in mlflow plugin. Fix pandas broken issue after %pip install.|


# Bug Fixes
|Id|Component|Description|
|-----|-----|-----|
|1499024|Conda:8.0.26|Updates conda env to have synapseml-mlflow updated to have fix for log_params function in lower mlflow version|
|1498978|TridentTokenLibrary:1.9.6,Conda:8.0.25|Upgrade SynapseML-Utils and TridentTokenLibrary to support ML 1P Token and MWC Token used in openai calls for billing purposes. Migrate to Fabric Public API in mlflow plugin. Fix pandas broken issue after %pip install.|
...
|Autotune|1.11.1.1|OnelakeSparkCatalog|0.1.16|
|AzureMLExtensions|1.0.4|Peregrine|0.10.4|
|CSparkMetricUpdate|1.0.8|PostgreSQLJDBCDriver|1.0.3|
|Conda|8.0.26|Python|3.10/2.0.0|
...
|FsspecWrapper|1.0.15|SparkRPCHistoryServer|1.3.0|
|Genesis|0.32.1|SparklyrConnector|1.0.1|
|GlutenUI|1.0.0|TokenLibrary|4.3.4|
|HiveMetaStoreClient|1.1.21|TridentCore|1.2.16|
|Impulse|1.2.5|TridentTokenLibrary|1.9.6|
|KustoConnector|1.5.1|VPaaSClient|3.4.01|
|LibraryManager|1.0.20|Vegas|3.4.09.01|
|LibraryMetadataCooker|2.0.3|Wildfire|1.9.20|
|MMLSpark|1.4.19|
|MachineLearningPredict|1.0.1|
|MlflowLibrary|2.6.0.1|
|MySQLJavaConnector|1.0.3|
|NotebookUtils|1.1.56|
...
|azure-synapse-ml-predict|1.0.0|notebookutils|1.1.5.34.20240930.7|
...
|json-tricks|3.17.3|synapseml-cognitive|1.0.8|
|jsonpointer|2.4|synapseml-core|1.0.8|
|jsonschema|4.19.1|synapseml-deep-learning|1.0.8|
|jsonschema-specifications|2023.7.1|synapseml-internal|1.0.8.0.dev1|
|jsonschema-with-format-nongpl|4.19.1|synapseml-lightgbm|1.0.8|
|jupyter-ui-poll|0.2.2|synapseml-mlflow|1.0.29.post2|
|jupyter_client|8.5.0|synapseml-opencv|1.0.8|
|jupyter_core|5.4.0|synapseml-utils|1.0.24.post1|
|jupyter_events|0.8.0|synapseml-vw|1.0.8|
...
|TokenLibrary-assembly|4.3.4|jta|1.1|
...
|commons-crypto|1.1.0|notebook-utils|1.1.5-spark34-20240930.7|
...
|derby|0.14.2.0|parquet-hadoop-ms|3.4.3.5.3.20241016.1|
...
|hadoop-aliyun|3.3.4.5.3.20241016.1|qpid-proton-j-extensions|1.2.4|
|hadoop-annotations|3.3.4.5.3.20241016.1|rocksdbjni|7.9.2|
|hadoop-aws|3.3.4.5.3.20241016.1|scala-collection-compat|2.12-2.7.0|
|hadoop-azure|3.3.4.5.3.20241016.1|scala-compiler|2.12.17|
|hadoop-azure-datalake|3.3.4.5.3.20241016.1|scala-java8-compat|2.12-0.9.0|
|hadoop-azureml|1.0-fs|scala-library|2.12.17|
|hadoop-client-api|3.3.4.5.3.20241016.1|scala-parser-combinators|2.12-2.1.1|
|hadoop-client-runtime|3.3.4.5.3.20241016.1|scala-reflect|2.12.17|
|hadoop-cloud-storage|3.3.4.5.3.20241016.1|scala-xml|2.12-2.1.0|
|hadoop-openstack|3.3.4.5.3.20241016.1|scalactic|2.12-3.2.14|
|hadoop-shaded-guava|1.1.1|shims|0.9.38|
|hadoop-yarn-server-web-proxy|3.3.4.5.3.20241016.1|slf4j-api|2.0.6|
|hdinsight-spark-metrics|3.4.0-1.0.8|snappy-java|1.1.10.5|
...
|hive-serde|2.3.9|spark-avro|2.12-3.4.3.5.3.20241016.1|
|hive-shims|2.3.9|spark-catalyst|2.12-3.4.3.5.3.20241016.1|
|hive-shims|0.23-2.3.9|spark-core|2.12-3.4.3.5.3.20241016.1|
|hive-shims-common|2.3.9|spark-enhancement|2.12-3.4.3.5.3.20241016.1|
|hive-shims-scheduler|2.3.9|spark-enhancementui|2.12-3.3.0|
|hive-storage-api|2.8.1|spark-graphx|2.12-3.4.3.5.3.20241016.1|
|hk2-api|2.6.1|spark-hadoop-cloud|2.12-3.4.3.5.3.20241016.1|
|hk2-locator|2.6.1|spark-hive|2.12-3.4.3.5.3.20241016.1|
|hk2-utils|2.6.1|spark-kusto-synapse-connector|3.4_2.12-1.5.1|
|httpclient|4.5.14|spark-kvstore|2.12-3.4.3.5.3.20241016.1|
|httpclient5|5.1.3|spark-launcher|2.12-3.4.3.5.3.20241016.1|
...
|httpmime|4.5.13|spark-microsoft-tools|2.12-3.4.3.5.3.20241016.1|
|impulse-core_spark|3.4_2.12-1.0.22|spark-mllib|2.12-3.4.3.5.3.20241016.1|
|impulse-telemetry-mds_spark|3.4_2.12-1.0.22|spark-mllib-local|2.12-3.4.3.5.3.20241016.1|
|ini4j|0.5.4|spark-network-common|2.12-3.4.3.5.3.20241016.1|
|isolation-forest|3.4.2_2.12-3.0.4|spark-network-shuffle|2.12-3.4.3.5.3.20241016.1|
|istack-commons-runtime|3.0.8|spark-repl|2.12-3.4.3.5.3.20241016.1|
|ivy|2.5.1|spark-sketch|2.12-3.4.3.5.3.20241016.1|
|jackson-annotations|2.14.2|spark-sql|2.12-3.4.3.5.3.20241016.1|
|jackson-core|2.14.2|spark-sql-kafka|0_2.12-3.4.3.5.3.20241016.1|
|jackson-core-asl|1.9.13|spark-streaming|2.12-3.4.3.5.3.20241016.1|
|jackson-databind|2.14.2|spark-streaming-kafka|0_2.12-3.4.3.5.3.20241016.1|
|jackson-dataformat-cbor|2.14.2|spark-streaming-kafka|2.12-3.4.3.5.3.20241016.1|
|jackson-datatype-jsr310|2.14.2|spark-tags|2.12-3.4.3.5.3.20241016.1|
|jackson-mapper-asl|1.9.13|spark-token-provider-kafka|0_2.12-3.4.3.5.3.20241016.1|
|jackson-module-scala|2.12-2.14.2|spark-unsafe|2.12-3.4.3.5.3.20241016.1|
|jakarta.annotation-api|1.3.5|spark-yarn|2.12-3.4.3.5.3.20241016.1|
...
|jaxb-runtime|2.3.2|synapseml-cognitive|2.12-1.0.8|
|jcl-over-slf4j|2.0.6|synapseml-core|2.12-1.0.8|
|jdo-api|3.0.1|synapseml-deep-learning|2.12-1.0.8|
|jdom2|2.0.6|synapseml-internal|2.12-1.0.8.0-spark3.4|
|jersey-client|2.36|synapseml-lightgbm|2.12-1.0.8|
|jersey-common|2.36|synapseml-opencv|2.12-1.0.8|
|jersey-container-servlet|2.36|synapseml-vw|2.12-1.0.8|
|jersey-container-servlet-core|2.36|synfs|1.1.5-spark34-20240930.7|
...
|jetty-util-ajax|9.4.54.v20240208|tridenttokenlibrary-assembly|1.9.6|
...
|json|1|xz|1.9|
|json|3|zookeeper|3.6.3.5.3.20241016.1|
|json|1.8|zookeeper-jute|3.6.3.5.3.20241016.1|
...
|TTR|0.24.4|notebookutils|1.1.5.34.20240930.7|
