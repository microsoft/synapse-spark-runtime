...
*   **Vhd Release**: Spark3.3-Rel-2025-02-05.0-rc.1
...
|**Delta**|**2.2.0.19 ⬆️ 2.2.0.21**|SparkAdvisor|1.0.0|
...
|KustoConnector|1.5.1|**TridentTokenLibrary**|**1.9.6 ⬆️ 1.9.7**|
|LibraryManager|1.0.37|VSANodeScanAgent|1.0.1|
...
|**dscopilot-installer**|**0.0.7 ⬆️ 0.0.9**|pthread-stubs|0.4|
...
|**delta-core**|**2.12-2.2.0.19 ⬆️ 2.12-2.2.0.21**|parquet-format-structures|1.12.3|
|**delta-iceberg**|**2.12-2.2.0.19 ⬆️ 2.12-2.2.0.21**|parquet-hadoop|1.12.3|
|**delta-storage**|**2.2.0.19 ⬆️ 2.2.0.21**|parquet-jackson|1.12.3|
...
|hdinsight-spark-metrics|3.3.0-1.0.6|spark|3.3-rpc-history-server-core_2.12-1.0.0|
...
|jettison|1.1|**tridenttokenlibrary-assembly**|**1.9.6 ⬆️ 1.9.7**|
