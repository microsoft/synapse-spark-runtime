...
*   **Vhd Release**: Spark3.3-Rel-2025-01-16.1-rc.1
...
|Autotune|1.11.1.2|**NotebookUtils**|**1.1.45 ⬆️ 1.1.46**|
...
|**Conda**|**1.0.21 ⬆️ 1.0.25**|Python|3.10/1.0.6|
...
|**Delta**|**2.2.0.17 ⬆️ 2.2.0.19**|SparkAdvisor|1.0.0|
|Dotnet|6.0.0|SparkDiagnosticsLibrary|1.0.21|
|EventHubConnector|2.3.26|SparkInitialize|1.0.0|
|**ExternalHiveMetastoreLibraries**|**0.0.7 ⬆️ 0.0.8**|SparkLighter|2.0.8|
...
|**HiveMetaStoreClient**|**1.1.21 ⬆️ 1.1.21.1**|**TokenLibrary**|**3.6.7 ⬆️ 3.6.8**|
|Impulse|1.2.4|TridentCore|1.2.9|
|KustoConnector|1.5.1|**TridentTokenLibrary**|**1.9.4 ⬆️ 1.9.6**|
|**LibraryManager**|**1.0.33 ⬆️ 1.0.37**|VSANodeScanAgent|1.0.1|
|LibraryMetadataCooker|2.0.1|Vegas|3.3.09.01|
|**MMLSpark**|**1.4.17 ⬆️ 1.4.19**|VertiParquet|0.8.6.1|
|**MachineLearningPredict**|**1.0.2 ⬆️ 1.0.3**|**Wildfire**|**1.7.61 ⬆️ 1.7.62**|
...
|bcrypt|3.2.2|**notebookutils**|**1.0.34.33.20240905.1 ⬆️ 1.0.34.33.20241121.2**|
...
|jinja2|3.1.2|**synapseml-cognitive**|**1.0.4.dev1 ⬆️ 1.0.8.dev1**|
|jmespath|1.0.1|**synapseml-core**|**1.0.4.dev1 ⬆️ 1.0.8.dev1**|
|joblib|1.2.0|**synapseml-deep-learning**|**1.0.4.dev1 ⬆️ 1.0.8.dev1**|
|jpeg|9e|**synapseml-internal**|**1.0.4.0.dev1 ⬆️ 1.0.8.0.dev1**|
|jsonpickle|2.2.0|**synapseml-lightgbm**|**1.0.4.dev1 ⬆️ 1.0.8.dev1**|
|jsonschema|4.17.3|**synapseml-mlflow**|**1.0.23 ⬆️ 1.0.30.post1**|
|jupyter_client|8.1.0|**synapseml-opencv**|**1.0.4.dev1 ⬆️ 1.0.8.dev1**|
|jupyter_core|5.3.0|**synapseml-utils**|**1.0.19.post1 ⬆️ 1.0.26**|
|jupyter_events|0.6.3|**synapseml-vw**|**1.0.4.dev1 ⬆️ 1.0.8.dev1**|
...
|**TokenLibrary-assembly**|**3.6.7 ⬆️ 3.6.8**|jsr305|3.0.0|
...
|commons-compress|1.21|**notebook-utils**|**1.0.34-spark33-20240905.1 ⬆️ 1.0.34-spark33-20241121.2**|
...
|**delta-core**|**2.12-2.2.0.17 ⬆️ 2.12-2.2.0.19**|parquet-format-structures|1.12.3|
|**delta-iceberg**|**2.12-2.2.0.17 ⬆️ 2.12-2.2.0.19**|parquet-hadoop|1.12.3|
|**delta-storage**|**2.2.0.17 ⬆️ 2.2.0.19**|parquet-jackson|1.12.3|
...
|**hdinsight-spark-metrics**|**3.3.0-1.0.4 ⬆️ 3.3.0-1.0.6**|spark|3.3-rpc-history-server-app-listener_2.12-1.0.0|
...
|javolution|5.5.1|**synapseml-cognitive**|**2.12-1.0.4-spark3.3 ⬆️ 2.12-1.0.8-spark3.3**|
|jaxb-api|2.2.11|**synapseml-core**|**2.12-1.0.4-spark3.3 ⬆️ 2.12-1.0.8-spark3.3**|
|jaxb-runtime|2.3.2|**synapseml-deep-learning**|**2.12-1.0.4-spark3.3 ⬆️ 2.12-1.0.8-spark3.3**|
|jcl-over-slf4j|1.7.32|**synapseml-internal**|**2.12-1.0.4.0-spark3.3 ⬆️ 2.12-1.0.8.0-spark3.3**|
|jdo-api|3.0.1|**synapseml-lightgbm**|**2.12-1.0.4-spark3.3 ⬆️ 2.12-1.0.8-spark3.3**|
|jdom2|2.0.6|**synapseml-opencv**|**2.12-1.0.4-spark3.3 ⬆️ 2.12-1.0.8-spark3.3**|
|jersey-client|2.36|**synapseml-vw**|**2.12-1.0.4-spark3.3 ⬆️ 2.12-1.0.8-spark3.3**|
|jersey-common|2.36|**synfs**|**1.0.34-spark33-20240905.1 ⬆️ 1.0.34-spark33-20241121.2**|
...
|jettison|1.1|**tridenttokenlibrary-assembly**|**1.9.4 ⬆️ 1.9.6**|
...
|V8|4.4.1|**notebookutils**|**1.0.34.33.20240905.1 ⬆️ 1.0.34.33.20241121.2**|
