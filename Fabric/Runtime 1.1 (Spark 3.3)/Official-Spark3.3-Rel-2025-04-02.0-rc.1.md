...
*   **VHD Name**: 9f80854181c490.vhd
*   **Vhd Release**: Spark3.3-Rel-2025-04-02.0-rc.1
...
|-----|-----|-----|
|1618469|LibraryManager:1.0.39|Enhances internal logging for Purview VNET scenarios in Spark 3.3, addressing timeout issues with external log files to avoid blocking the LibraryManagement process.|
|1583834|CSparkMetricUpdate:1.0.9|Implemented logging security fixes to redact sensitive information in Spark 3.3, addressing issues with secrets being exposed in task events and SQL execution events.|
...
|**CSparkMetricUpdate**|**1.0.8 ⬆️ 1.0.9**|Peregrine|0.10.4|
...
|**KustoConnector**|**1.5.1 ⬆️ 1.5.2**|TridentTokenLibrary|1.9.7|
|**LibraryManager**|**1.0.37 ⬆️ 1.0.39**|VSANodeScanAgent|1.0.1|
|LibraryMetadataCooker|2.0.1|Vegas|3.3.09.01|
|MMLSpark|1.4.20|VertiParquet|0.8.6.1|
...
|jupyter_events|0.6.3|synapseml-vw|1.0.9.dev1|
...
|**SparkCustomEvents**|**3.3.0-1.0.6 ⬆️ 3.3.0-1.0.8**|json4s-scalap|2.12-3.7.0-M11|
...
|**hdinsight-spark-metrics**|**3.3.0-1.0.6 ⬆️ 3.3.0-1.0.8**|spark|3.3-rpc-history-server-app-listener_2.12-1.0.0|
...
|hive-shims-scheduler|2.3.9|**spark-kusto-synapse-connector**|**3.0_2.12-1.5.1 ⬆️ 3.0_2.12-1.5.2**|
