# System Environment
*   **Vhd Release**: Spark3.3-Rel-2024-03-20.0-rc.1
...
|-----|-----|-----|-----|
|1293768|ServiceConfigurationTemplates:spark/3.3.0|Add spark config for PBI spark native connector|Add spark config for PBI spark native connector|
|1288910|Wildfire/spark33:1.7.52|New spark 3.3 release|One CVE fix in Spark, and functionality supporting multiple name spaces. Livy changes related to session idempotency & warm up code.|
|1290309|Autotune:1.11.0|Bump autotune version to 1.11.0|To align with the new 1.11.0 release, there are no client-side changes required. The key enhancements for the Autotune backend include fixes for the state store delta table compaction and an increase in cluster and streaming job resources to enhance system throughput.|
|1250432|MMLSpark:1.4.12|Update SynapseML to v1.0.2|Update SynapseML to v1.0.2 https://github.com/microsoft/SynapseML/releases/tag/v1.0.2|
|1273479|OneLakeClientStarter:spark3/1.0.19.1|Security fixes for Onelake Client Scripts|Secure Onelake Client scripts to avoid any potential Elevation of privileges.|
|1274740|ServiceConfigurationTemplates:Spark33|Disable Autotune by default|Disable Autotune by default, customers can enable via spark settings|
|1276350|CDM:1.19.7|Update CDM connector|Update CDM connector|
...
|1302991|ServiceConfigurationTemplates:spark/3.3.0|Reverts enablement of flag to check OLC status before starting Livy|Reverting change of start Livy Web Server only after checking that OLC service is up.|
|1285746|ServiceConfigurationTemplates:spark/3.3.0|Start Livy Web Server only after checking that OLC service is up|In Fabric, there is no dependency of Livy on OLC service. Sometimes Livy starts up and is ready to accept requests sooner than OLC service becomes ready. When this happens, we can get requests that later will fail, if they depend on OLC service.In this PR, we start Livy - but we pause before starting the Web Server (Livy component) and wait until OLC service is ready.|
|1285750|ServiceConfigurationTemplates:spark/3.3.0|Make explicit dependency between Livy and Yarn NM|When Livy submit a job to Yarn, Yarn NM might not be ready. By making Livy starts after Yarn NM is started, we can reduce the subtle timing issue related with the dependency.|
|1301372|ServiceConfigurationTemplates:spark/3.3.0|Fix needed by spark 3.3 release|Correctly applies changes to Spark 3.3 that were previously applied in a different Spark version.|
|1285031|CSparkMetricUpdate: 1.0.2|Redact information from telemetry|Redact information from telemetry|
|1273047|Vegas:spark33/3.3.08.5|Parquet corruption fixes when Intelligent cache is enabled.|Fixed edge when intelligent cache is enabled, where parquet file corruption might occur if multiple tasks on same host access same parquet file concurrently|
|1276599|SparkDiagnosticsLibrary:1.0.19|Fixed potential security issue when logging spark config to kusto|Removes logging of information that can potentially expose storage keys.|
|1277666|SparkRPCHistoryServer:1.0.28|Fix a security issue of Spark UI for running application|Fix a permission issue in Spark UI|
|1285703|LibraryManager:1.0.23|Synapse Fail session when LM session level fails|Fixes a regression where a failed library management session doesn't cause the session to fail|
...
|**CDM**|**1.19.5 --> 1.19.7**|
|**CSparkMetricUpdate**|**1.0.1 --> 1.0.2**|
|ClusterGateway|spark/2.4.4|
|Conda|1.0.20|
|CosmosDBConnector|1.8.10|
|DWConnector|2.1.1|
|**Delta**|**2.2.0.9 --> 2.2.0.11**|
|Dotnet|6.0.0|
...
|SparkAdvisor|0.0.14|
|**SparkDiagnosticsLibrary**|**1.0.18 --> 1.0.20**|
...
|**Vegas**|**3.3.08.4 --> 3.3.08.5**|
|VertiParquet|0.8.6|
|**Wildfire**|**1.7.50 --> 1.7.52**|
...
|ipykernel|6.17.0|
|**ipykernel**|**6.17.0 --> 6.29.3**|
|ipython|8.6.0|
|**ipython**|**8.6.0 --> 8.22.2**|
...
|notebook|6.5.2|
|notebook-shim|0.2.2|
|**notebookutils**|**3.3.0-20240130.4 --> 3.3.0-20240213.4**|
|numba|0.56.3|
|numpy|1.23.4|
|numpy|1.26.4|
|oauthlib|3.2.2|
...
|statsmodels|0.13.5|
|sympy|1.11.1|
|**synapseml-cognitive**|**0.11.3.dev1 --> 1.0.2.dev1**|
|**synapseml-core**|**0.11.3.dev1 --> 1.0.2.dev1**|
|**synapseml-deep-learning**|**0.11.3.dev1 --> 1.0.2.dev1**|
|**synapseml-internal**|**0.11.3.2.dev1 --> 1.0.2.1.dev1**|
|**synapseml-lightgbm**|**0.11.3.dev1 --> 1.0.2.dev1**|
|**synapseml-opencv**|**0.11.3.dev1 --> 1.0.2.dev1**|
|**synapseml-vw**|**0.11.3.dev1 --> 1.0.2.dev1**|
|tabulate|0.9.0|
|tbb|2021.6.0|
|tensorboard|2.8.0|
...
|ST4|4.0.4|
|**SparkCustomEvents**|**3.3.0-1.0.1 --> 3.3.0-1.0.2**|
|TokenLibrary-assembly|3.5.8|
...
|**autotune-client**|**2.12-1.10.0-3.3-117562362 --> 2.12-1.11.0-3.3-120040110**|
|**autotune-common**|**2.12-1.10.0-3.3-117562362 --> 2.12-1.11.0-3.3-120040110**|
|avro|1.11.0|
|avro-ipc|1.11.0|
|avro-mapred|1.11.0|
...
|**delta-core**|**2.12-2.2.0.9 --> 2.12-2.2.0.11**|
|**delta-iceberg**|**2.12-2.2.0.9 --> 2.12-2.2.0.11**|
|**delta-storage**|**2.2.0.9 --> 2.2.0.11**|
|derby|0.14.2.0|
...
|gson|2.8.6|
|guava|4.0.1|
|**hadoop-aliyun**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|**hadoop-annotations**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|**hadoop-aws**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|**hadoop-azure**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|**hadoop-azure-datalake**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|hadoop-azureml|1.0-fs|
|**hadoop-client-api**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|**hadoop-client-runtime**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|**hadoop-cloud-storage**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|**hadoop-cos**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|**hadoop-openstack**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|hadoop-shaded-guava|1.1.1|
|**hadoop-yarn-server-web-proxy**|**3.3.3.5.2-117504963 --> 3.3.3.5.2-119960880**|
|**hdinsight-spark-metrics**|**3.3.0-1.0.1 --> 3.3.0-1.0.2**|
|hive-beeline|2.3.9|
|hive-cli|2.3.9|
|hive-common|2.3.9|
...
|ini4j|0.5.4|
|**isolation-forest**|**3.2.0_2.12-2.0.8 --> 3.3.3_2.12-3.0.3**|
...
|**notebook-utils**|**3.3.0-20240130.4 --> 3.3.0-20240213.4**|
|objenesis|3.2|
...
|**spark-avro**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-catalyst**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-cdm-connector-assembly-spark**|**3.3-1.19.5 --> 3.3-1.19.7**|
|**spark-core**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-enhancement**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|spark-enhancementui|2.12-3.0.0|
|**spark-graphx**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-hadoop-cloud**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-hive**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-hive-thriftserver**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|spark-kusto-synapse-connector|3.1_2.12-1.3.4|
|**spark-kvstore**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-launcher**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|spark-lighter-contract|2.12-2.0.7_spark-3.3.0|
|spark-lighter-core|2.12-2.0.7_spark-3.3.0|
|**spark-microsoft-tools**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-mllib**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-mllib-local**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-network-common**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-network-shuffle**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-repl**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-sketch**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-sql**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-sql-kafka**|**0_2.12-3.3.1.5.2-117504963 --> 0_2.12-3.3.1.5.2-119960880**|
|**spark-streaming**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-streaming-kafka**|**0_2.12-3.3.1.5.2-117504963 --> 0_2.12-3.3.1.5.2-119960880**|
|**spark-streaming-kafka**|**0_2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-tags**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-token-provider-kafka**|**0_2.12-3.3.1.5.2-117504963 --> 0_2.12-3.3.1.5.2-119960880**|
|**spark-unsafe**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark-yarn**|**2.12-3.3.1.5.2-117504963 --> 2.12-3.3.1.5.2-119960880**|
|**spark_diagnostic_cli**|**2.0.6_spark-3.3.0 --> 2.1.0_spark-3.3.0**|
...
|super-csv|2.2.0|
|**synapseml**|**2.12-0.11.3-spark3.3 --> 2.12-1.0.2-spark3.3**|
|**synapseml-cognitive**|**2.12-0.11.3-spark3.3 --> 2.12-1.0.2-spark3.3**|
|**synapseml-core**|**2.12-0.11.3-spark3.3 --> 2.12-1.0.2-spark3.3**|
|**synapseml-deep-learning**|**2.12-0.11.3-spark3.3 --> 2.12-1.0.2-spark3.3**|
|**synapseml-internal**|**2.12-0.11.3.2-spark3.3 --> 2.12-1.0.2.1-spark3.3**|
|**synapseml-lightgbm**|**2.12-0.11.3-spark3.3 --> 2.12-1.0.2-spark3.3**|
|**synapseml-opencv**|**2.12-0.11.3-spark3.3 --> 2.12-1.0.2-spark3.3**|
|**synapseml-vw**|**2.12-0.11.3-spark3.3 --> 2.12-1.0.2-spark3.3**|
|**synfs**|**3.3.0-20240130.4 --> 3.3.0-20240213.4**|
...
|xz|1.8|
|**zookeeper**|**3.6.2.5.2-117504963 --> 3.6.2.5.2-119960880**|
|**zookeeper-jute**|**3.6.2.5.2-117504963 --> 3.6.2.5.2-119960880**|
|zstd-jni|1.5.2-1|
