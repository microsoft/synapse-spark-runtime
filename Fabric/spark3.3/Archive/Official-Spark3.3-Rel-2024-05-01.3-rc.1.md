# System Environment
*   **Vhd Release**: Spark3.3-Rel-2024-05-01.4-rc.1
...
|Id|Component|Title|Description|
|-----|-----|-----|-----|
|1341632|DWConnector:2.1.3, FabricDWConnector:1.0.0, LibraryManager:1.0.26|Fabric Spark DW Connector - Version 1.0.0 - Spark 3.3.0|a. Using a three-part table name, users can query data from Fabric Data Warehouse artifact attached to the workspace.|
|1335595|Wildfire/spark33:1.7.55|New spark 3.3 release|Configuring special characters in table name, redact oauth2 tokens livy, fixes in the livy server. New versioning structure for spark, hadoop, hive like spark-core_2.12-3.4.1.5.2.20240424.1.jar for better version trackability.|

# Bug Fixes

|Id|Component|Title|Description|
|-----|-----|-----|-----|
|1338729|Autotune:1.11.1.0|Enable autotune by setting spark config from notebook cell|There was a bug to enable autotune by setting spark config from notebook cell. This change contains the fix for this use case.|
|1335595|Wildfire/spark33:1.7.55|New spark 3.3 release|Configuring special characters in table name, redact oauth2 tokens livy, fixes in the livy server. New versioning structure for spark, hadoop, hive like spark-core_2.12-3.4.1.5.2.20240424.1.jar for better version trackability.|
...
|**TokenLibrary-assembly**|**3.6.3 --> 3.6.4**|
...
|**autotune-client**|**2.12-1.11.0-3.3-120040110 --> 2.12-1.11.1-3.3-125200601**|
|**autotune-common**|**2.12-1.11.0-3.3-120040110 --> 2.12-1.11.1-3.3-125200601**|
|avro|1.11.0|
|avro-ipc|1.11.0|
|avro-mapred|1.11.0|
...
|gson|2.8.9|
|guava|4.0.1|
|**hadoop-aliyun**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|**hadoop-annotations**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|**hadoop-aws**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|**hadoop-azure**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|**hadoop-azure-datalake**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|hadoop-azureml|1.0-fs|
|**hadoop-client-api**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|**hadoop-client-runtime**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|**hadoop-cloud-storage**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|**hadoop-cos**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|**hadoop-openstack**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
|hadoop-shaded-guava|1.1.1|
|**hadoop-yarn-server-web-proxy**|**3.3.3.5.2-122281848 --> 3.3.3.5.2.20240424.1**|
...
|**mssql-jdbc**|**8.4.1.jre8 --> 2.4.2.jre8**|
...
|**spark-avro**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-catalyst**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-cdm-connector-assembly-spark**|**3.3-1.19.7 --> 3.3-1.19.5**|
|**spark-core**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-enhancement**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|spark-enhancementui|2.12-3.0.0|
|**spark-graphx**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-hadoop-cloud**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-hive**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-hive-thriftserver**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|spark-kusto-synapse-connector|3.1_2.12-1.3.4|
|**spark-kvstore**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-launcher**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|spark-lighter-contract|2.12-2.0.7_spark-3.3.0|
|spark-lighter-core|2.12-2.0.7_spark-3.3.0|
|**spark-microsoft-tools**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-mllib**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-mllib-local**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-network-common**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-network-shuffle**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-repl**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-sketch**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-sql**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-sql-kafka**|**0_2.12-3.3.1.5.2-122281848 --> 0_2.12-3.3.1.5.2.20240424.1**|
|**spark-streaming**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-streaming-kafka**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-streaming-kafka**|**2.12-3.3.1.5.2-122281848 --> 0_2.12-3.3.1.5.2.20240424.1**|
|**spark-tags**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-token-provider-kafka**|**0_2.12-3.3.1.5.2-122281848 --> 0_2.12-3.3.1.5.2.20240424.1**|
|**spark-unsafe**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
|**spark-yarn**|**2.12-3.3.1.5.2-122281848 --> 2.12-3.3.1.5.2.20240424.1**|
...
|**sqlanalyticsconnector-fabric**|**3.3.0-1.0.0**|
|stax-api|1.0.1|
|stream|2.9.6|
...
|xz|1.8|
|**zookeeper**|**3.6.2.5.2-122281848 --> 3.6.2.5.2.20240424.1**|
|**zookeeper-jute**|**3.6.2.5.2-122281848 --> 3.6.2.5.2.20240424.1**|
|zstd-jni|1.5.2-1|
