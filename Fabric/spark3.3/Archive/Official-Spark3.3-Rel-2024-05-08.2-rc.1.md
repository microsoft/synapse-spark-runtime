# System Environment
*   **Vhd Release**: Spark3.3-Rel-2024-05-08.2-rc.1
...
|-----|-----|-----|-----|
|1353906|DWConnector:2.1.4, FabricDWConnector:1.0.4|Fabric Spark DW Connector - Version 1.0.4 - Spark 3.3.0|Enable Fabric DW Connector Version 1.0.4 to all PBI Environment Types.|
|1335673|TokenLibrary:3.6.5|Fixing VHD build failure due to soft deletion of Jar|Fix Spark VHD creation failure related to soft deletion of jar that was causing conflicts|
|1341632|DWConnector:2.1.3, FabricDWConnector:1.0.0, LibraryManager:1.0.26|Fabric Spark DW Connector - Version 1.0.0 - Spark 3.3.0|Using a three-part table name, users can query data from the Fabric Data Warehouse artifact attached to the workspace, honoring Row-level-security (RLS) and Column-level-security (CLS) constraints configured within the SQL layer; the SQL endpoint is auto-discovered using the warehouse artifact name and other runtime configuration references, leveraging the Trident Token Library to fetch the required access token, which is used to interact with PBI RESTful API endpoints and the SQL Server front end for JDBC connections; the relevant data set that meets the user’s read criteria and RLS/CLS policies is staged to a staging table, a DataFrame reference to the user is initialized with the One Lake path of that staging table, and telemetry is logged to the CSparkExtraEvents table for usage monitoring and to support customer issue triage.|
|1342312|Delta:2.2.0.12|Internal logging improvements|Internal logging improvements.|
|1344674|AutoscaleProbe:3.9.1|Release Autoscale Version 3.9.1|New Autoscale Version contains bugfix for TJS update cores failure and improved cluster snapshot monitoring interval.|
...
|**DWConnector**|**2.1.3 --> 2.1.4**|
|**Delta**|**2.2.0.11 --> 2.2.0.12**|
|Dotnet|6.0.0|
|EventHubConnector|2.3.24|
|ExternalHiveMetastoreLibraries|0.0.6|
|**FabricDWConnector**|**1.0.0 --> 1.0.4**|
...
|**delta-core**|**2.12-2.2.0.11 --> 2.12-2.2.0.12**|
|**delta-iceberg**|**2.12-2.2.0.11 --> 2.12-2.2.0.12**|
|**delta-storage**|**2.2.0.11 --> 2.2.0.12**|
|derby|0.14.2.0|
...
|gson|2.8.9|
|guava|4.0.1|
|hadoop-aliyun|3.3.3.5.2.20240424.1|
|hadoop-annotations|3.3.3.5.2.20240424.1|
|hadoop-aws|3.3.3.5.2.20240424.1|
|hadoop-azure|3.3.3.5.2.20240424.1|
|hadoop-azure-datalake|3.3.3.5.2.20240424.1|
|hadoop-azureml|1.0-fs|
|hadoop-client-api|3.3.3.5.2.20240424.1|
|hadoop-client-runtime|3.3.3.5.2.20240424.1|
|hadoop-cloud-storage|3.3.3.5.2.20240424.1|
|hadoop-cos|3.3.3.5.2.20240424.1|
|hadoop-openstack|3.3.3.5.2.20240424.1|
|hadoop-shaded-guava|1.1.1|
|hadoop-yarn-server-web-proxy|3.3.3.5.2.20240424.1|
...
|spark-avro|2.12-3.3.1.5.2.20240424.1|
|spark-catalyst|2.12-3.3.1.5.2.20240424.1|
|spark-cdm-connector-assembly-spark|3.3-1.19.5|
|spark-core|2.12-3.3.1.5.2.20240424.1|
|spark-enhancement|2.12-3.3.1.5.2.20240424.1|
|spark-enhancementui|2.12-3.0.0|
|spark-graphx|2.12-3.3.1.5.2.20240424.1|
|spark-hadoop-cloud|2.12-3.3.1.5.2.20240424.1|
|spark-hive|2.12-3.3.1.5.2.20240424.1|
|spark-hive-thriftserver|2.12-3.3.1.5.2.20240424.1|
|spark-kusto-synapse-connector|3.1_2.12-1.3.4|
|spark-kvstore|2.12-3.3.1.5.2.20240424.1|
|spark-launcher|2.12-3.3.1.5.2.20240424.1|
|spark-lighter-contract|2.12-2.0.7_spark-3.3.0|
|spark-lighter-core|2.12-2.0.7_spark-3.3.0|
|spark-microsoft-tools|2.12-3.3.1.5.2.20240424.1|
|spark-mllib|2.12-3.3.1.5.2.20240424.1|
|spark-mllib-local|2.12-3.3.1.5.2.20240424.1|
|spark-network-common|2.12-3.3.1.5.2.20240424.1|
|spark-network-shuffle|2.12-3.3.1.5.2.20240424.1|
|spark-repl|2.12-3.3.1.5.2.20240424.1|
|spark-sketch|2.12-3.3.1.5.2.20240424.1|
|spark-sql|2.12-3.3.1.5.2.20240424.1|
|spark-sql-kafka|0_2.12-3.3.1.5.2.20240424.1|
|spark-streaming|2.12-3.3.1.5.2.20240424.1|
|spark-streaming-kafka|2.12-3.3.1.5.2.20240424.1|
|spark-streaming-kafka|0_2.12-3.3.1.5.2.20240424.1|
|spark-tags|2.12-3.3.1.5.2.20240424.1|
|spark-token-provider-kafka|0_2.12-3.3.1.5.2.20240424.1|
|spark-unsafe|2.12-3.3.1.5.2.20240424.1|
|spark-yarn|2.12-3.3.1.5.2.20240424.1|
...
|**sqlanalyticsconnector-fabric**|**3.3.0-1.0.0 --> 3.3.0-1.0.4**|
|stax-api|1.0.1|
|stream|2.9.6|
...
|xz|1.8|
|zookeeper|3.6.2.5.2.20240424.1|
|zookeeper-jute|3.6.2.5.2.20240424.1|
|zstd-jni|1.5.2-1|
