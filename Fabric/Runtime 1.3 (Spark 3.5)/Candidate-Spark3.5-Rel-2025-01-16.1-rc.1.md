...
*   **Vhd Release**: Spark3.5-Rel-2025-01-16.1-rc.1
...
|Id|Component|Description|
|-----|-----|-----|
|1556405|SparkDiagnosticsLibrary:1.0.28|Optimizing Log Levels and Download Package Workflow in Spark 3.5|
...
|1476780|ServiceConfigurationTemplates:various|Added driver MDC settings to include notebook ID in driver and executor logs for HC sessions, enhancing log traceability.|
...
|1484002|OneLakeClientStarter:1.0.24|Improved logging for services startup in Spark 3.5, including exact UTC timestamps in OLC Starter service logs.|
...
|flatbuffers-java|1.12.0|**parquet-hadoop-ms**|**3.5.1.5.4.20241007.4 ⬆️ 3.5.1.5.4.20250107.3**|
...
|httpmime|4.5.13|**spark-kvstore**|**2.12-3.5.1.5.4.20241007.4 ⬆️ 2.12-3.5.1.5.4.20250107.3**|
...
|jersey-container-servlet|2.40|**synapseml-opencv**|**2.12-1.0.4-spark3.5 ⬆️ 2.12-1.0.8-spark3.5**|
