...
*   **VHD Name**: 69186358e660d9.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-05-14.4-rc.1
...
|-----|-----|-----|
|1675681|Wildfire/spark35:1.10.28|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|1676871|OneLakeClientStarter:1.0.26|Upgrading OLC to latest version 2025.154.0.0.  Fix for a known shortcuts issue which leads to 403 errors, OneLake Security redirect support, CPP extension improvements.|
|1675663|FLTSparkExtensions:0.5.0|This PR includes several enhancements and fixes related to Materialized Lake Views (MLVs). Renaming error codes, type checks, and documentation references from MATERIALIZED_VIEW to MATERIALIZED_LAKE_VIEW. Bug fix to support subquery expressions in materialized lake views. Bug fix to unwrap executor exceptions for Data Quality (DQ) in Spark SQL extensions.|
|1675665|OneLakeSparkCatalog:0.2.8|Update Catalog to 0.2.8 in Spark 3.5 VHD, refactoring change that updates naming from Materialized View to Materialized Lake View.|
|1675681|Wildfire/spark35:1.10.28|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy|
...
|-----|-----|-----|-----|
|AutoscaleProbe|3.9.5|**OnelakeSparkCatalog**|**0.2.7 ⬆️ 0.2.8**|
...
|**FLTSparkExtensions**|**0.4.3 ⬆️ 0.5.0**|SparkNativeParquetWriter|1.3.0-20250516.3|
...
|GlutenUI|1.0.8|TridentCore|1.2.22|
...
|LibraryManager|1.0.16|**Wildfire**|**1.10.25 ⬆️ 1.10.28**|
|LibraryMetadataCooker|2.0.3|
|MlflowLibrary|2.11.3.1|
|MMLSpark|1.4.22|
|MySQLJavaConnector|1.0.3|
|NotebookUtils|1.1.59|
|**OneLakeClientStarter**|**1.0.24.3 ⬆️ 1.0.26**|
...
|delta-spark|2.12-3.2.0.19|parquet-common|1.13.1|
|delta-storage|3.2.0.19|parquet-encoding|1.13.1|
|derby|0.14.2.0|parquet-format-structures|1.13.1|
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|**parquet-hadoop-ms**|**3.5.1.5.4.20250416.1 ⬆️ 3.5.1.5.4.20250513.1**|
|fastutil|7.0.2|parquet-jackson|1.13.1|
|flatbuffers-java|1.12.0|pickle|1.3|
|**flt-spark-sql-extensions**|**0.4.3 ⬆️ 0.5.0**|postgresql|2.2.9|
...
|**hadoop-aliyun**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|rocksdbjni|8.3.2|
|**hadoop-annotations**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|scala-collection-compat|2.12-2.7.0|
|**hadoop-aws**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|scala-compiler|2.12.18|
|**hadoop-azure**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure-datalake**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|scala-library|2.12.18|
|hadoop-azureml|1.0-fs|scala-parser-combinators|2.12-2.3.0|
|**hadoop-client-api**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|scala-reflect|2.12.18|
|**hadoop-client-runtime**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|scala-xml|2.12-2.1.0|
|**hadoop-cloud-storage**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|scalactic|2.12-3.2.14|
|**hadoop-openstack**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|scalatra|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-common|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20250416.1 ⬆️ 3.3.4.5.4.20250513.1**|scalatra-metrics|2.12-3.0.0-M1|
...
|hive-shims|2.3.9|**spark-avro**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|hive-shims-common|2.3.9|**spark-catalyst**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|hive-shims-scheduler|2.3.9|**spark-common-utils**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|hive-storage-api|2.8.1|**spark-core**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|hk2-api|2.6.1|**spark-enhancement**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|hk2-locator|2.6.1|spark-enhancementui|2.12-3.3.0|
|hk2-utils|2.6.1|**spark-graphx**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|httpclient|4.5.14|**spark-hadoop-cloud**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|httpclient5|5.1.3|**spark-hive**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|httpcore|4.4.16|spark-jobinsight|2.12-1.0.0-spark3.5|
|httpmime|4.5.13|spark-kusto-synapse-connector|3.5_2.12-1.5.1|
|httpmime|4.5.14|**spark-kvstore**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|impulse-core_spark|3.5_2.12-1.0.30|**spark-launcher**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
...
|isolation-forest|3.5.0_2.12-3.0.5|**spark-microsoft-tools**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|istack-commons-runtime|3.0.8|**spark-mllib**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|ivy|2.5.1|**spark-mllib-local**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-annotations|2.15.2|**spark-network-common**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-core|2.15.2|**spark-network-shuffle**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-core-asl|1.9.13|**spark-onesecurity-client**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-databind|2.15.2|**spark-onesecurity-common**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-server**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-dataformat-xml|2.12.7|**spark-repl**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-datatype-jsr310|2.15.2|**spark-sketch**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-mapper-asl|1.9.13|**spark-sql**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sql-api**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jackson-module-scala|2.12-2.15.2|**spark-sql-kafka**|**0_2.12-3.5.1.5.4.20250416.1 ⬆️ 0_2.12-3.5.1.5.4.20250513.1**|
|jakarta.activation-api|1.2.2|**spark-streaming**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jakarta.annotation-api|1.3.5|**spark-streaming-kafka**|**0_2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jakarta.inject|2.6.1|**spark-streaming-kafka**|**0_2.12-3.5.1.5.4.20250416.1 ⬆️ 0_2.12-3.5.1.5.4.20250513.1**|
|jakarta.servlet-api|4.0.3|**spark-tags**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jakarta.validation-api|2.0.2|**spark-token-provider-kafka**|**0_2.12-3.5.1.5.4.20250416.1 ⬆️ 0_2.12-3.5.1.5.4.20250513.1**|
|jakarta.ws.rs-api|2.1.6|**spark-unsafe**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
|jakarta.xml.bind-api|2.3.2|spark-xml|2.12-0.17.0|
|janino|3.1.9|**spark-yarn**|**2.12-3.5.1.5.4.20250416.1 ⬆️ 2.12-3.5.1.5.4.20250513.1**|
...
|jsr305|3.0.0|xz|1.9|
|jta|1.1|**zookeeper**|**3.6.3.5.4.20250416.1 ⬆️ 3.6.3.5.4.20250513.1**|
|jul-to-slf4j|2.0.7|**zookeeper-jute**|**3.6.3.5.4.20250416.1 ⬆️ 3.6.3.5.4.20250513.1**|
