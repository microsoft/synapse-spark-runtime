...
*   **VHD Name**: cba43272b9dea3.vhd
*   **Vhd Release**: Spark3.5-Rel-2026-01-14.1-rc.1
...
|Id|Component|Description|
|-----|-----|-----|
|1934104|TridentTokenLibrary:1.10.4|Update TTL version to fix get storage token issue during session start|
|1920785|FLTSparkExtensions:0.12.2|Updates FLTSparkExtensions to enhance incremental refresh support for Left Join and Aggregate operators, improve telemetry, address reliability log issues, and correct error code categories.|
...
|KustoConnector|1.5.1|**TridentTokenLibrary**|**1.9.14 ⬆️ 1.10.4**|
...
|chill|2.12-0.10.0|netty-tcnative-boringssl-static|2.0.62.Final-linux-aarch_64|
...
|commons-collections4|4.4|netty-transport-native-epoll|4.1.96.Final-linux-aarch_64|
|commons-compiler|3.1.9|netty-transport-native-epoll|4.1.96.Final-linux-x86_64|
|commons-compress|1.23.0|netty-transport-native-kqueue|4.1.96.Final-osx-aarch_64|
...
|commons-io|2.18.0|notebook-utils|1.1.12-spark35|
...
|hive-shims|2.3.9|**spark-avro**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|hive-shims|0.23-2.3.9|**spark-catalyst**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
...
|jakarta.inject|2.6.1|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 0_2.12-3.5.5.5.4.20260109.1**|
|jakarta.servlet-api|4.0.3|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
...
|json-simple|1.1.1|**transform-token-provider-utils**|**0.0.0 ⬆️ 0.3.0**|
|json-simple|1.1|trident-core|1.2.30|
|json4s-ast|2.12-3.7.0-M11|**tridenttokenlibrary-assembly**|**1.9.14 ⬆️ 1.10.4**|
