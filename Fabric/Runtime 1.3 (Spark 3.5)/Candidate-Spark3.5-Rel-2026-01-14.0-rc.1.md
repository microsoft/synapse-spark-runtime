...
*   **VHD Name**: 1fb5224753e5b1.vhd
*   **Vhd Release**: Spark3.5-Rel-2026-01-14.0-rc.1
*   **Operating System**: CBL-Mariner 2.0.20260102
*   **Apache Spark**: 3.5.5
*   **Java**: 11.0.27
*   **Scala**: 2.12.18
*   **Python**: 3.11/1.0.1
...
|-----|-----|-----|
|1920785|FLTSparkExtensions:0.12.2|Updates FLTSparkExtensions to enhance incremental refresh support for Left Join and Aggregate operators, improve telemetry, address reliability log issues, and correct error code categories.|
|1918393|Wildfire/spark35:1.10.45|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy.|
|1905095|FLT-SparkUtils:0.3.0|Introduces the spark-excel-thin jar as part of the FLT-SparkUtils component for Spark 3.5.|
|1913331|Wildfire/spark35:1.10.44.1|Introduces Spark 3.5 release with updates to wildfire-spark, wildfire-livy, and wildfire-hadoop.|
...
|-----|-----|-----|
|1918393|Wildfire/spark35:1.10.45|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy.|
|1895834|Vegas:spark35/3.5.10|Improves the Vegas locality hinting algorithm for intelligent cache, enhancing cache efficiency, dynamic scaling, and load balancing with optimized hash distribution and minimal data disruption.|
|1901238|SparkAdvisor:1.0.7|Improves SparkAdvisor to update NEE fallback events, ensuring users can better identify and access fallback details in interactive sessions.|
|1910742|LibraryManager:1.0.25|Enhances library manager performance by reducing library snapshot size, improving library processing and deployment execution times by 5-15%.|
|1913331|Wildfire/spark35:1.10.44.1|Introduces Spark 3.5 release with updates to wildfire-spark, wildfire-livy, and wildfire-hadoop.|
|1885394|LibraryManager:1.0.23|Enhances performance and telemetry in Spark 3.x by reducing library snapshot size for faster processing and deployment, and improving telemetry handling for better debugging during TokenLibrary exceptions.|
|1891632|CSparkMetricUpdate:1.0.14|Updates CSparkMetricUpdate to enhance logging by redacting sensitive information and improving job description handling.|
...
|-----|-----|-----|
|1920785|FLTSparkExtensions:0.12.2|Updates FLTSparkExtensions to enhance incremental refresh support for Left Join and Aggregate operators, improve telemetry, address reliability log issues, and correct error code categories.|
|1704900|TridentTokenLibrary :1.10.3|Adds pre-created log file for the token library to address extra log line issues in Spark 3.x clusters.|
|1915102|AutoscaleProbe:3.9.9|Fixes an issue in Autoscale Probe where API call order caused exceptions and unnecessary CPU usage.|
|1889591|LibraryMetadataCooker:2.0.4, LibraryManager:1.0.24|Fixes LMC file uploading and metadata generation issues in layered environments for Spark 3.x clusters.|
|1898244|OnelakeSparkCatalog:0.3.1|Fixes a bug in OnelakeSparkCatalog where tables created with previous versions were not discoverable due to missing headers.|
|1904390|Wildfire/spark35:1.10.43|Introduces Spark 3.5 release with updates to wildfire-spark, including bug fixes and improved security measures for RLS with NEE disabled.|
|1905996|CSparkMetricUpdate:1.0.16|Reverts recent Spark Metrics Listener release to address a regression causing Kusto Connector failures in Spark 3.5 within Fabric.|


# Components
|Name|Version|Name|Version|
|-----|-----|-----|-----|
|Auditd|0.0.2|NotebookUtils|1.1.61|
|**AutoscaleProbe**|**3.9.8 ⬆️ 3.9.9**|OneLakeClientStarter|1.0.26.2|
|AzureMLExtensions|1.0.4|OnelakeSparkCatalog|0.3.1|
|Conda|5.2.21|PostgreSQLJDBCDriver|1.0.3|
|CSparkMetricUpdate|1.0.16|Python|3.11/1.0.1|
|Delta|3.2.1.20251125.5|**R**|**1.0.6 ⬆️ 1.0.7**|
|DSCopilot|1.3.2|**SparkAdvisor**|**1.0.6 ⬆️ 1.0.7**|
...
|**FLTSparkExtensions**|**0.10.3 ⬆️ 0.12.2**|SparkNativeParquetWriter|1.3.0-20250828.2|
|**FLTSparkUtils**|**1.0.1 ⬆️ 0.3.0**|SparkRPCHistoryServer|1.8.0|
|FsspecWrapper|1.0.6|SparkSqlConnector|1.6.9|
|Genesis|0.35.4|SQLServerODBCDriver|18.1.0|
|**GlutenUI**|**1.3.0-20251127.2 ⬆️ 1.3.0-20251211.3**|SStreamOnSparkJar|2.4.1|
|HiveMetaStoreClient|1.1.21.2|TokenLibrary|4.3.8|
|Impulse|1.3.198470504|TridentCore|1.2.30|
|KustoConnector|1.5.1|**TridentTokenLibrary**|**1.9.14 ⬆️ 1.10.3**|
|**LibraryManager**|**1.0.22 ⬆️ 1.0.25**|**Vegas**|**3.5.09.06 ⬆️ 3.5.10**|
|**LibraryMetadataCooker**|**2.0.3 ⬆️ 2.0.4**|VPaaSClient|3.5.03|
|MlflowLibrary|2.11.3.1|**Wildfire**|**1.10.43.1 ⬆️ 1.10.45.1**|
|MMLSpark|1.4.27|
...
|backports.shutil_get_terminal_size|1.0.0|notebookutils|1.1.12.35|
...
|**flt-python**|**0.10.3 ⬆️ 0.12.2**|python-lmdb|1.4.1|
...
|impulse-python-handler|1.3.198470504|sip|6.7.12|
...
|**library-metadata-cooker**|**3.5.0.1 ⬆️ 3.6.0.1**|whichcraft|0.6.1|
...
|**VegasConnector**|**3.5.09 ⬆️ 3.5.10**|libfb303|0.9.3|
...
|derby|0.14.2.0|**parquet-hadoop-ms**|**3.5.5.5.4.20251218.3 ⬆️ 3.5.5.5.4.20260109.1**|
...
|**flt-spark-sql-extensions**|**0.10.3 ⬆️ 0.12.2**|profiler|1.1.1|
|fluent-logger|0.3.4-jar-with-dependencies-provided|proton-j|0.33.8|
|gcs-connector-hadoop3|2.2.14-shaded|py4j|0.10.9.7|
|genesis-client|2.12-0.35.4-jar-with-dependencies|qpid-proton-j-extensions|1.2.4|
|geoanalytics-fabric|2.12-1.0.0-msfabric-1.3|reactive-streams|1.0.3|
|**gluten-velox-bundle-spark**|**3.5_2.12-mariner_2.0_x86_64-1.3.0-20251127.2 ⬆️ 3.5_2.12-mariner_2.0_x86_64-1.3.0-20251211.3**|reactor-core|3.4.34|
|gson|2.8.9|reactor-netty-core|1.0.40|
|guava|4.0.1|reactor-netty-http|1.0.40|
|h3|4.1.1|rocksdbjni|8.3.2|
|**hadoop-aliyun**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|scala-collection-compat|2.12-2.7.0|
|**hadoop-annotations**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|scala-compiler|2.12.18|
|**hadoop-aws**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|scala-library|2.12.18|
|**hadoop-azure-datalake**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|scala-parser-combinators|2.12-2.3.0|
|hadoop-azureml|1.0-fs|scala-reflect|2.12.18|
|**hadoop-client-api**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|scala-xml|2.12-2.1.0|
|**hadoop-client-runtime**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|scalactic|2.12-3.2.14|
|**hadoop-cloud-storage**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|scalatra|2.12-3.0.0-M1|
|**hadoop-openstack**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|scalatra-common|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-metrics|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20251218.3 ⬆️ 3.3.4.5.4.20260109.1**|shims|0.9.45|
...
|hive-serde|2.3.9|**spark-avro**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|hive-shims|0.23-2.3.9|spark-avro|2.12-3.5.0|
|hive-shims|2.3.9|**spark-catalyst**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|hive-shims-common|2.3.9|**spark-common-utils**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|hive-shims-scheduler|2.3.9|**spark-core**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|hive-storage-api|2.8.1|**spark-enhancement**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
...
|httpclient|4.5.14|**spark-graphx**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|httpclient5|5.1.3|**spark-hadoop-cloud**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|httpcore|4.4.16|**spark-hive**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|httpmime|4.5.14|spark-jobinsight|2.12-1.0.0-spark3.5|
|httpmime|4.5.13|spark-kusto-synapse-connector|3.5_2.12-1.5.1|
|impulse-core_spark|3.5_2.12-1.3.198470504|**spark-kvstore**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|impulse-exception_java11|1_2.12-1.3.198470504|**spark-launcher**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
...
|isolation-forest|3.5.0_2.12-3.0.5|**spark-microsoft-tools**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|istack-commons-runtime|3.0.8|**spark-mllib**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|ivy|2.5.1|**spark-mllib-local**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jackson-annotations|2.15.2|spark-mssql-connector-fabric35|1.6.9|
|jackson-core|2.15.2|**spark-network-common**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jackson-core-asl|1.9.13|**spark-network-shuffle**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jackson-databind|2.15.2|**spark-onesecurity-client**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-common**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jackson-dataformat-xml|2.12.7|**spark-onesecurity-server**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jackson-datatype-jsr310|2.15.2|**spark-repl**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jackson-mapper-asl|1.9.13|**spark-sketch**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sql**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jackson-module-scala|2.12-2.15.2|**spark-sql-api**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jakarta.activation-api|1.2.2|**spark-sql-kafka**|**0_2.12-3.5.5.5.4.20251218.3 ⬆️ 0_2.12-3.5.5.5.4.20260109.1**|
|jakarta.annotation-api|1.3.5|**spark-streaming**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jakarta.inject|2.6.1|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jakarta.servlet-api|4.0.3|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 0_2.12-3.5.5.5.4.20260109.1**|
|jakarta.validation-api|2.0.2|**spark-tags**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|jakarta.ws.rs-api|2.1.6|**spark-token-provider-kafka**|**0_2.12-3.5.5.5.4.20251218.3 ⬆️ 0_2.12-3.5.5.5.4.20260109.1**|
|jakarta.xml.bind-api|2.3.2|**spark-unsafe**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
|janino|3.1.9|spark-xml|2.12-0.17.0|
|javassist|3.29.2-GA|**spark-yarn**|**2.12-3.5.5.5.4.20251218.3 ⬆️ 2.12-3.5.5.5.4.20260109.1**|
...
|json-simple|1.1|**transform-token-provider-utils**|**0.0.0 ⬆️ 0.3.0**|
|json-simple|1.1.1|trident-core|1.2.30|
|json4s-ast|2.12-3.7.0-M11|**tridenttokenlibrary-assembly**|**1.9.14 ⬆️ 1.10.3**|
...
|junit-jupiter|5.5.2|**zookeeper**|**3.6.3.5.4.20251218.3 ⬆️ 3.6.3.5.4.20260109.1**|
|junit-jupiter-api|5.5.2|**zookeeper-jute**|**3.6.3.5.4.20251218.3 ⬆️ 3.6.3.5.4.20260109.1**|
...
|V8|5.0.0|notebookutils|1.1.12.35|
