...
*   **VHD Name**: 5e454709a70b43.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-04-17.1-rc.1
...
|-----|-----|-----|
|1632308|SparkJobInsight:1.0.0|Adds the JobInsight library to Spark 3.5, enhancing the analysis of completed spark jobs by providing tools for interactive analysis and downloading spark event files for further examination.|
|1634329|Wildfire/spark35:1.10.24|Release of Spark 3.5 with new features and improvements, including re-enabling the Hadoop native build.|
|1619297|Wildfire/spark35:1.10.22|New Spark 3.5 release includes changes in wildfire-spark and wildfire-livy.|
|1626001|Delta:3.2.0.17, SparkNativeParquetWriter:0.37.0|Introduced performance improvements and extended statistics collection for new catalog tables by updating to Delta 3.2.0.17 and SparkNativeParquetWriter. Includes support for columnar writing and disables cbo join reordering without key column stats.|
|1631548|AutoscaleProbe:3.9.5|Enhance Autoscale Probe to emit repl metrics so as to be able to attribute repl level consumption for system cluster jobs such as Shortcut Transforms|
|1632788|Delta:3.2.0.18, SparkNativeParquetWriter:0.39.0|New Spark 3.5 release updates the Native Execution Engine, Delta, and Native Parquet Writer to improve performance and capabilities.|
...
|-----|-----|-----|
|1634329|Wildfire/spark35:1.10.24|Release of Spark 3.5 with new features and improvements, including re-enabling the Hadoop native build.|
|1640829|TridentTokenLibrary:1.9.10|Updated Trident Token Library to enhance reliable operation by increasing the http socket timeout to address delays in response from Spark Core workload via Token service proxy.|
...
|**FLTSparkExtensions**|**0.2.9 ⬆️ 0.3.1**|**SparkNativeParquetWriter**|**0.30.0 ⬆️ 0.40.0**|
...
|**GlutenUI**|**1.0.4 ⬆️ 1.0.6**|TridentCore|1.2.22|
...
|**LibraryManager**|**1.0.15 ⬆️ 1.0.16**|**Wildfire**|**1.10.21 ⬆️ 1.10.24**|
...
|**delta-spark**|**2.12-3.2.0.15 ⬆️ 2.12-3.2.0.19**|parquet-column|1.13.1|
|**delta-storage**|**3.2.0.15 ⬆️ 3.2.0.19**|parquet-common|1.13.1|
|derby|0.14.2.0|parquet-encoding|1.13.1|
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|parquet-format-structures|1.13.1|
|fastutil|7.0.2|**parquet-hadoop-ms**|**3.5.1.5.4.20250317.1 ⬆️ 3.5.1.5.4.20250408.2**|
...
|**hadoop-aliyun**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|rocksdbjni|8.3.2|
|**hadoop-annotations**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|scala-collection-compat|2.12-2.7.0|
|**hadoop-aws**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|scala-compiler|2.12.18|
|**hadoop-azure**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure-datalake**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|scala-library|2.12.18|
|hadoop-azureml|1.0-fs|scala-parser-combinators|2.12-2.3.0|
|**hadoop-client-api**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|scala-reflect|2.12.18|
|**hadoop-client-runtime**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|scala-xml|2.12-2.1.0|
|**hadoop-cloud-storage**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|scalactic|2.12-3.2.14|
|**hadoop-openstack**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|scalatra|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-common|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20250317.1 ⬆️ 3.3.4.5.4.20250408.2**|scalatra-metrics|2.12-3.0.0-M1|
...
|hive-shims|0.23-2.3.9|**spark-avro**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|hive-shims-common|2.3.9|**spark-catalyst**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|hive-shims-scheduler|2.3.9|**spark-common-utils**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|hive-storage-api|2.8.1|**spark-core**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|hk2-api|2.6.1|**spark-enhancement**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|hk2-locator|2.6.1|spark-enhancementui|2.12-3.3.0|
|hk2-utils|2.6.1|**spark-graphx**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|httpclient|4.5.14|**spark-hadoop-cloud**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|httpclient5|5.1.3|**spark-hive**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|httpcore|4.4.16|**spark-jobinsight**|**2.12-1.0.0-spark3.5**|
|httpmime|4.5.14|spark-kusto-synapse-connector|3.5_2.12-1.5.1|
|httpmime|4.5.13|**spark-kvstore**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|**impulse-core_spark**|**3.5_2.12-1.0.29 ⬆️ 3.5_2.12-1.0.30**|**spark-launcher**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
...
|isolation-forest|3.5.0_2.12-3.0.5|**spark-microsoft-tools**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|istack-commons-runtime|3.0.8|**spark-mllib**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|ivy|2.5.1|**spark-mllib-local**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-annotations|2.15.2|**spark-network-common**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-core|2.15.2|**spark-network-shuffle**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-core-asl|1.9.13|**spark-onesecurity-client**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-databind|2.15.2|**spark-onesecurity-common**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-server**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-dataformat-xml|2.12.7|**spark-repl**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-datatype-jsr310|2.15.2|**spark-sketch**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-mapper-asl|1.9.13|**spark-sql**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sql-api**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jackson-module-scala|2.12-2.15.2|**spark-sql-kafka**|**0_2.12-3.5.1.5.4.20250317.1 ⬆️ 0_2.12-3.5.1.5.4.20250408.2**|
|jakarta.activation-api|1.2.2|**spark-streaming**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jakarta.annotation-api|1.3.5|**spark-streaming-kafka**|**0_2.12-3.5.1.5.4.20250317.1 ⬆️ 0_2.12-3.5.1.5.4.20250408.2**|
|jakarta.inject|2.6.1|**spark-streaming-kafka**|**0_2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jakarta.servlet-api|4.0.3|**spark-tags**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jakarta.validation-api|2.0.2|**spark-token-provider-kafka**|**0_2.12-3.5.1.5.4.20250317.1 ⬆️ 0_2.12-3.5.1.5.4.20250408.2**|
|jakarta.ws.rs-api|2.1.6|**spark-unsafe**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
|jakarta.xml.bind-api|2.3.2|spark-xml|2.12-0.17.0|
|janino|3.1.9|**spark-yarn**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250408.2**|
...
|jsr305|3.0.0|xz|1.9|
|jta|1.1|**zookeeper**|**3.6.3.5.4.20250317.1 ⬆️ 3.6.3.5.4.20250408.2**|
|jul-to-slf4j|2.0.7|**zookeeper-jute**|**3.6.3.5.4.20250317.1 ⬆️ 3.6.3.5.4.20250408.2**|
