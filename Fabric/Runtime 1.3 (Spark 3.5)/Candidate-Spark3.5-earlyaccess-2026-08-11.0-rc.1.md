...
*   **VHD Name**: 17976942dd10bf.vhd
*   **Vhd Release**: Spark3.5-earlyaccess-2026-08-11.0-rc.1
...
|-----|-----|-----|
|2215114|EventStreamsFabricExtension:1.0.0.4|Introduces name-based access for EventStream APIs, replacing GUIDs with workspace name, EventStream name, and stream name for enhanced usability.|
|2205626|Wildfire/spark35:1.10.58|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy, enhancing features and performance.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|2186119|ServiceConfigurationTemplates:spark/3.5.0|Introduces optional YARN rolling log aggregation to collect executor logs from decommissioned nodes during application runtime. Default behavior remains unchanged; rolling aggregation is disabled to prevent storage inefficiencies.|
|2223726|ServiceConfigurationTemplates:spark/3.5.0|Disables OneSecurity shuffle cache, data cache, and timing metrics by default in Spark 3.5 runtime configuration for Fabric clusters to ensure consistent settings across configurations.|
|2208256|ServiceConfigurationTemplates:spark/3.5.0|Set `spark.dynamicAllocation.excludeDeltaSnapshotCache` Spark config to `true`. It is needed so Delta log cache does not prevent executor scale down.|
|2198597|OnelakeSparkCatalog:0.4.17, TridentCore:1.4.5|Integrates V1 OneLake Table API for artifact resolution and adds experimental feature flag support for accessing all artifact types. Fixes namespace resolution errors caused by schema and non-data artifact name collisions.|
|2193655|Impulse:1.5.226604159|This PR updates Impulse version to `1.5.226604159` for the Spark 3.5 VHD component (Mariner 3.0 / Early Access).|
|2199387|FLTSparkExtensions:1.7.2|Releases FLT Spark Extensions 1.7.2, featuring improvements to the FileIngestion feature and enhancements in Pydeequ functionality.|
|2205626|Wildfire/spark35:1.10.58|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy, enhancing features and performance.|
|2208784|Genesis:0.39.0, LibraryManager:1.0.31|Improves reliability during cluster scale-up by ensuring library-cleanup behavior selected at deployment is honored, with changes gated behind a feature flag.|


# Bug Fixes
|Id|Component|Description|
|-----|-----|-----|
|2229624|KustoConnector:2.1.1|Updates the Kusto Spark connector to version 7.1.2 for Spark 3.5, fixing issues with read queries ending in single-line comments that could cause query failures or incorrect column selection.|
|2198597|OnelakeSparkCatalog:0.4.17, TridentCore:1.4.5|Integrates V1 OneLake Table API for artifact resolution and adds experimental feature flag support for accessing all artifact types. Fixes namespace resolution errors caused by schema and non-data artifact name collisions.|
...
|-----|-----|-----|-----|
|AutoscaleProbe|3.9.11|OneLakeClientStarter|1.0.28.1|
|AzureMLExtensions|1.0.5|**OnelakeSparkCatalog**|**0.4.16 ⬆️ 0.4.17**|
|**Conda**|**5.2.26.1 ⬆️ 5.2.27**|PostgreSQLJDBCDriver|1.0.3|
|CSparkMetricUpdate|1.0.19|Python|3.11/1.0.2|
|Delta|3.2.1.20260609.1|R|1.0.7|
|DSCopilot|1.3.2|SparkAdvisor|1.0.8|
|DSCopilotInstaller|1.0.0|SparkDiagnosticsLibrary|1.0.34|
|Esri|1.0.1|SparkJobInsight|1.0.2|
|EventHubConnector|2.3.27|SparkLighter|2.0.5|
|**EventStreamsFabricExtension**|**1.0.0.3 ⬆️ 1.0.0.4**|SparkLineage|0.0.4|
|FabricDWConnector|1.0.25|SparklyrConnector|2.0.2|
|**FLTSparkExtensions**|**1.6.1 ⬆️ 1.7.2**|SparkNativeParquetWriter|3.5.0-20260403.14|
|FLTSparkUtils|0.3.0|SparkRPCHistoryServer|1.11.0|
|FsspecWrapper|1.0.7|SparkSqlConnector|1.8.1|
|**Genesis**|**0.38.0 ⬆️ 0.39.0**|SQLServerODBCDriver|18.1.1|
|**GlutenUI**|**1.3.0-20260601.1 ⬆️ 1.3.0-20260805.1**|SStreamOnSparkJar|2.4.1|
|HiveMetaStoreClient|1.1.28|TokenLibrary|4.3.9|
|**Impulse**|**1.5.224064063.1 ⬆️ 1.5.226604159.1**|**TridentCore**|**1.4.4 ⬆️ 1.4.5**|
|**KustoConnector**|**2.1.0 ⬆️ 2.1.1**|TridentTokenLibrary|1.13.1|
|**LibraryManager**|**1.0.30 ⬆️ 1.0.31**|UpgradeToFabric|1.2.15|
|LibraryMetadataCooker|2.0.5|Vegas|3.5.10|
|MlflowLibrary|2.11.3.1|VPaaSClient|3.5.03|
|MMLSpark|1.4.31|**Wildfire**|**1.10.57.1 ⬆️ 1.10.59.1**|
|MySQLJavaConnector|1.0.3|
|**NotebookUtils**|**1.1.67 ⬆️ 1.1.68**|
...
|libuv|1.44.2|flaml|2.5.0.post4|
|libwebp|1.3.2|**flt-python**|**1.6.1 ⬆️ 1.7.2**|
...
|libxslt|1.1.37|**impulse-python-handler**|**1.5.224064063 ⬆️ 1.5.226604159**|
...
|lzo|2.10|mypy|1.4.1|
|make|4.2.1|nni|3.0|
|markdown|3.4.1|notebookutils|1.1.15.35.20260524.4|
...
|mpfr|4.0.2|**semantic-link-sempy**|**0.11.2 ⬆️ 0.11.3**|
|mpi|1.0|seqeval|1.2.2|
|mpich|4.1.1|simplejson|3.19.3|
|mpmath|1.3.0|spark-mssql-connector-fabric35|1.1.0|
...
|TokenLibrary-assembly|4.3.8|**kusto-spark**|**3.0_2.12-7.1.1 ⬆️ 3.0_2.12-7.1.2**|
...
|commons-lang3|3.12.0|notebook-utils|1.1.15-spark35-20260524.4|
...
|delta-kernel-api|3.2.1.20260609.1|paranamer|2.8|
|delta-kernel-defaults|3.2.1.20260609.1|parquet-column|1.13.1|
|delta-spark|2.12-3.2.1.20260609.1|parquet-common|1.13.1|
|delta-storage|3.2.1.20260609.1|parquet-encoding|1.13.1|
|derby|10.14.2.0|parquet-format-structures|1.13.1|
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|**parquet-hadoop-ms**|**3.5.5.5.4.20260608.1 ⬆️ 3.5.5.5.4.20260805.229821988**|
|fastutil|7.0.2|parquet-jackson|1.13.1|
|flatbuffers-java|1.12.0|pickle|1.3|
|**flt-spark-sql-extensions**|**1.6.1 ⬆️ 1.7.2**|postgresql|42.2.9|
|fluent-logger|0.3.4-jar-with-dependencies-provided|profiler|1.1.1|
|**fmlv-utils**|**1.6.1 ⬆️ 1.7.2**|proton-j|0.33.8|
|gcs-connector-hadoop3|2.2.14-shaded|py4j|0.10.9.7|
|**genesis-client**|**2.12-0.38.0-jar-with-dependencies ⬆️ 2.12-0.39.0-jar-with-dependencies**|qpid-proton-j-extensions|1.2.4|
|geoanalytics-fabric|2.12-1.0.1-msfabric-1.3|reactive-streams|1.0.3|
|**gluten-velox-bundle-spark**|**2.12-azurelinux_3.0_x86_64-1.3.0-20260601.1 ⬆️ 2.12-azurelinux_3.0_x86_64-1.3.0-20260805.1**|reactor-core|3.4.34|
|gson|2.8.9|reactor-netty-core|1.0.40|
|guava|14.0.1|reactor-netty-http|1.0.40|
|h3|4.1.1|rocksdbjni|8.3.2|
|**hadoop-aliyun**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|scala-collection-compat|2.12-2.7.0|
|**hadoop-annotations**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|scala-compiler|2.12.18|
|**hadoop-aws**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|scala-library|2.12.18|
|**hadoop-azure-datalake**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|scala-parser-combinators|2.12-2.3.0|
|hadoop-azureml|1.0-fs|scala-reflect|2.12.18|
|**hadoop-client-api**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|scala-xml|2.12-2.1.0|
|**hadoop-client-runtime**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|scalactic|2.12-3.2.14|
|**hadoop-cloud-storage**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|scalatra|2.12-3.0.0-M1|
|**hadoop-openstack**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|scalatra-common|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-metrics|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20260608.1 ⬆️ 3.3.4.5.4.20260805.229821988**|shims|0.9.45|
...
|hive-shims|2.3.9|**spark-arsenal**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|hive-shims-common|2.3.9|spark-avro|2.12-3.5.0|
|hive-shims-scheduler|2.3.9|**spark-avro**|**2.12-3.5.0 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|hive-storage-api|2.8.1|**spark-catalyst**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|hk2-api|2.6.1|**spark-common-utils**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|hk2-locator|2.6.1|**spark-core**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|hk2-utils|2.6.1|**spark-enhancement**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|httpclient|4.5.14|spark-enhancementui|2.12-3.3.0|
|httpclient5|5.1.3|**spark-eventstream-extensions**|**1.0.10 ⬆️ 1.0.11**|
|httpcore|4.4.16|spark-excel-thin|2.12-3.5.6_0.31.2|
|httpmime|4.5.13|**spark-graphx**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|httpmime|4.5.14|**spark-hadoop-cloud**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|**impulse-core_spark**|**2.12-1.5.224064063 ⬆️ 2.12-1.5.226604159**|**spark-hive**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|**impulse-exception_java11**|**2.12-1.5.224064063 ⬆️ 2.12-1.5.226604159**|spark-jobinsight|2.12-1.0.0-spark3.5|
|**impulse-telemetry-common**|**2.12-1.5.224064063 ⬆️ 2.12-1.5.226604159**|**spark-kusto-synapse-connector**|**3.5_2.12-2.1.0 ⬆️ 3.5_2.12-2.1.1**|
|**impulse-telemetry-mds_spark**|**2.12-1.5.224064063 ⬆️ 2.12-1.5.226604159**|**spark-kvstore**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|**impulse-telemetry-pulse_spark**|**2.12-1.5.224064063 ⬆️ 2.12-1.5.226604159**|**spark-launcher**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
...
|istack-commons-runtime|3.0.8|**spark-microsoft-tools**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|ivy|2.5.1|**spark-mllib**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jackson-annotations|2.15.2|**spark-mllib-local**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jackson-core|2.15.2|spark-mssql-connector-fabric35|1.8.1|
|jackson-core-asl|1.9.13|**spark-network-common**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jackson-databind|2.15.2|**spark-network-shuffle**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-client**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jackson-dataformat-xml|2.12.7|**spark-onesecurity-common**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jackson-datatype-jsr310|2.15.2|**spark-onesecurity-server**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jackson-mapper-asl|1.9.13|**spark-repl**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sketch**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jackson-module-scala|2.12-2.15.2|**spark-sql**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jakarta.activation-api|1.2.2|**spark-sql-api**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jakarta.annotation-api|1.3.5|**spark-sql-kafka**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jakarta.inject|2.6.1|**spark-streaming**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jakarta.servlet-api|4.0.3|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jakarta.validation-api|2.0.2|**spark-tags**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jakarta.ws.rs-api|2.1.6|**spark-token-provider-kafka**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|jakarta.xml.bind-api|2.3.2|**spark-unsafe**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|janino|3.1.9|spark-xml|2.12-0.17.0|
|javassist|3.29.2-GA|**spark-yarn**|**2.12-3.5.5.5.4.20260608.1 ⬆️ 2.12-3.5.5.5.4.20260805.229821988**|
|javatuples|1.2|spark_diagnostic_cli|2.3.0_spark-3.5.1_20260518.3-shaded|
...
|jodd-core|3.5.2|synfs|1.1.15-spark35-20260524.4|
|jsch|0.1.54|threeten-extra|1.7.1|
|json|1.8|tink|1.9.0|
|json|20231013|transaction-api|1.1|
|json-simple|1.1.1|transform-token-provider-utils|0.3.0|
|json-simple|1.1|**trident-core**|**1.4.4 ⬆️ 1.4.5**|
|json4s-ast|2.12-3.7.0-M11|tridenttokenlibrary-assembly|1.13.1|
...
|junit-jupiter|5.5.2|**zookeeper**|**3.6.3.5.4.20260608.1 ⬆️ 3.6.3.5.4.20260805.229821988**|
|junit-jupiter-api|5.5.2|**zookeeper-jute**|**3.6.3.5.4.20260608.1 ⬆️ 3.6.3.5.4.20260805.229821988**|
...
|V8|5.0.0|notebookutils|1.1.15.35.20260524.4|
