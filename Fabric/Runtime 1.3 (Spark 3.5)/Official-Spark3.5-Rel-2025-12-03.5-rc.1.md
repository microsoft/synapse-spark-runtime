...
*   **VHD Name**: 805966857d0359.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-12-03.5-rc.1
*   **Operating System**: CBL-Mariner 2.0.20251106
*   **Apache Spark**: 3.5.5
*   **Java**: 11.0.27
*   **Scala**: 2.12.18
*   **Python**: 3.11/1.0.1
*   **Delta Lake**: 3.2.1.20251125.5

# New Features
|Id|Component|Description|
|-----|-----|-----|
|1887181|FLTSparkExtensions:0.10.3|Implement replace functionality and some Incremental Refresh related fixes for the Fabric Materialized Lake Views. Also, Provide key bug fixes being reported by the customers in regard to MLV lifecycle.|
|1874714|OnelakeSparkCatalog:0.2.26, TridentCore:1.2.30|Introduces updated persistent views implementation and resolves a bug affecting previous catalog release, enabling successful runs in Spark 4.x CI pipeline.|
|1884466|Wildfire/spark35:1.10.42|Introduces Spark 3.5 release featuring updates to wildfire-spark and wildfire-hadoop components.|
|1856812|Wildfire/spark35:1.10.40.1|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy components.|
|1872299|Wildfire/spark35:1.10.41.1|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy, wildfire-hadoop|
|1848298|NotebookUtils:1.1.61|Releases NotebookUtils 1.1.12 with new features, bug fixes, and improvements including Azure Key Vault API, HTTP retry fixes, enhanced UDF header processing, cache timeout configuration, secret redaction, PII protection, and more.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|1905473|CSparkMetricUpdate:1.0.14|Logging changes|
|1883049|Delta:3.2.1.20251125.5|Updates Delta to version 3.2.1.20251125.5 and NEE to 1.3.0-20251127.2, introducing performance, reliability, and compatibility improvements across Delta, Gluten, and Velox components.|
|1886873|OnelakeSparkCatalog:0.2.28|Updates OneLakeSparkCatalog with improvements, including removal of PII from log messages and additional tests.|
|1887181|FLTSparkExtensions:0.10.3|Implement replace functionality and some Incremental Refresh related fixes for the Fabric Materialized Lake Views. Also, Provide key bug fixes being reported by the customers in regard to MLV lifecycle.|
|1866247|Impulse:1.3.198470504|Upgrades Impulse library to version 1.3.198470504 for Spark 3.5, enhancing telemetry, unit test coverage, and adding Log4j 2.24 plugin discovery support for Spark 4.0+.|
|1884466|Wildfire/spark35:1.10.42|Introduces Spark 3.5 release featuring updates to wildfire-spark and wildfire-hadoop components.|
|1856217|MMLSpark:1.4.27|Updates SynapseML libraries to version 1.1.0 for enhanced distributed machine learning capabilities in Fabric VHD components.|
|1856812|Wildfire/spark35:1.10.40.1|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy components.|
|1872299|Wildfire/spark35:1.10.41.1|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy, wildfire-hadoop|
|1832724|Impulse:1.3.193774755|Updates the Impulse library to version 1.3.193774755, introducing compatibility improvements and enhancements for Spark 3.x and 4.x environments.|
|1843034|NotebookUtils:1.1.60.4|Introduces `notebookutils.credentials.getSecretWithConnection` API for secure secret retrieval via Fabric connections and implements automatic redaction of sensitive credentials in DMTS API responses to enhance security.|
|1848298|NotebookUtils:1.1.61|Releases NotebookUtils 1.1.12 with new features, bug fixes, and improvements including Azure Key Vault API, HTTP retry fixes, enhanced UDF header processing, cache timeout configuration, secret redaction, PII protection, and more.|
|1848806|LibraryManager:1.0.22|Enhances LibraryManager reliability with system-level retries for conda network errors, reduces post-execution wait time, and adds functionality improvements for private repository usage.|


# Bug Fixes
|Id|Component|Description|
|-----|-----|-----|
|1905091|Wildfire/spark35:1.10.43|New Spark 3.5 Release which includes changes in wildfire-spark|
|1899035|OnelakeSparkCatalog:0.3.1|Without this fix, tables created by previous version of catalog were not discoverable|
|1874714|OnelakeSparkCatalog:0.2.26, TridentCore:1.2.30|Introduces updated persistent views implementation and resolves a bug affecting previous catalog release, enabling successful runs in Spark 4.x CI pipeline.|
|1848197|OnelakeSparkCatalog:0.2.23, TridentCore:1.2.29|Disables views support to prevent conflicts with md-sync on warehouse artifacts, ensuring smoother operations for customers.|
|1864201|FLTSparkExtensions:0.8.3|Removes log statements from materialized lake view operations to prevent exposure of sensitive customer metadata.|
|1848298|NotebookUtils:1.1.61|Releases NotebookUtils 1.1.12 with new features, bug fixes, and improvements including Azure Key Vault API, HTTP retry fixes, enhanced UDF header processing, cache timeout configuration, secret redaction, PII protection, and more.|
...
|-----|-----|-----|-----|
|Auditd|0.0.2|**NotebookUtils**|**1.1.60.4 ⬆️ 1.1.61**|
|AutoscaleProbe|3.9.8|OneLakeClientStarter|1.0.26.2|
|AzureMLExtensions|1.0.4|**OnelakeSparkCatalog**|**0.2.21 ⬆️ 0.3.1**|
|Conda|5.2.21|PostgreSQLJDBCDriver|1.0.3|
|**CSparkMetricUpdate**|**1.0.12 ⬆️ 1.0.14**|Python|3.11/1.0.1|
|**Delta**|**3.2.0.20251009.1 ⬆️ 3.2.1.20251125.5**|R|1.0.6|
...
|**FLTSparkExtensions**|**0.8.3 ⬆️ 0.10.3**|SparkNativeParquetWriter|1.3.0-20250828.2|
...
|**GlutenUI**|**1.3.0-20251007.3 ⬆️ 1.3.0-20251127.2**|SStreamOnSparkJar|2.4.1|
|HiveMetaStoreClient|1.1.21.2|TokenLibrary|4.3.8|
|**Impulse**|**1.1.0 ⬆️ 1.3.198470504**|**TridentCore**|**1.2.28 ⬆️ 1.2.30**|
|KustoConnector|1.5.1|TridentTokenLibrary|1.9.14|
|**LibraryManager**|**1.0.21 ⬆️ 1.0.22**|Vegas|3.5.09.06|
|LibraryMetadataCooker|2.0.3|VPaaSClient|3.5.03|
|MlflowLibrary|2.11.3.1|**Wildfire**|**1.10.40.1 ⬆️ 1.10.43.1**|
|MMLSpark|1.4.27|
...
|backports.shutil_get_terminal_size|1.0.0|**notebookutils**|**1.1.11.35.20251021.12 ⬆️ 1.1.12.35**|
...
|**flt-python**|**0.8.3 ⬆️ 0.10.3**|python-lmdb|1.4.1|
...
|**impulse-python-handler**|**1.1.0 ⬆️ 1.3.198470504**|sip|6.7.12|
...
|jupyter-ui-poll|1.0.0|synapseml-cognitive|1.1.0|
|jupyter_client|8.6.0|synapseml-core|1.1.0|
|jupyter_console|6.6.3|synapseml-deep-learning|1.1.0|
|jupyter_core|5.5.0|synapseml-internal|1.1.0.0.dev1|
|jupyter_events|0.8.0|synapseml-lightgbm|1.1.0|
|jupyter_server|2.10.0|synapseml-mlflow|1.0.31|
|jupyter_server_terminals|0.4.4|synapseml-opencv|1.1.0|
|jupyterlab|4.0.11|synapseml-utils|1.1.6.post2|
|jupyterlab_pygments|0.1.2|synapseml-vw|1.1.0|
...
|**SparkCustomEvents**|**3.5.0-1.0.12 ⬆️ 3.5.0-1.0.14**|kryo-shaded|4.0.2|
...
|commons-lang|2.6|**notebook-utils**|**1.1.11-spark35-20251021.12 ⬆️ 1.1.12-spark35**|
...
|**delta-kernel-api**|**3.2.0.20251009.1 ⬆️ 3.2.1.20251125.5**|paranamer|2.8|
|**delta-kernel-defaults**|**3.2.0.20251009.1 ⬆️ 3.2.1.20251125.5**|parquet-column|1.13.1|
|**delta-spark**|**2.12-3.2.0.20251009.1 ⬆️ 2.12-3.2.1.20251125.5**|parquet-common|1.13.1|
|**delta-storage**|**3.2.0.20251009.1 ⬆️ 3.2.1.20251125.5**|parquet-encoding|1.13.1|
|derby|0.14.2.0|parquet-format-structures|1.13.1|
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|**parquet-hadoop-ms**|**3.5.5.5.4.20251103.2 ⬆️ 3.5.5.5.4.20251218.3**|
|fastutil|7.0.2|parquet-jackson|1.13.1|
|flatbuffers-java|1.12.0|pickle|1.3|
|**flt-spark-sql-extensions**|**0.8.3 ⬆️ 0.10.3**|postgresql|2.2.9|
...
|**gluten-velox-bundle-spark**|**3.5_2.12-mariner_2.0_x86_64-1.3.0-20251007.3 ⬆️ 3.5_2.12-mariner_2.0_x86_64-1.3.0-20251127.2**|reactive-streams|1.0.3|
|gson|2.8.9|reactor-core|3.4.34|
|guava|4.0.1|reactor-netty-core|1.0.40|
|h3|4.1.1|reactor-netty-http|1.0.40|
|**hadoop-aliyun**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|rocksdbjni|8.3.2|
|**hadoop-annotations**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|scala-collection-compat|2.12-2.7.0|
|**hadoop-aws**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|scala-compiler|2.12.18|
|**hadoop-azure**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure-datalake**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|scala-library|2.12.18|
|hadoop-azureml|1.0-fs|scala-parser-combinators|2.12-2.3.0|
|**hadoop-client-api**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|scala-reflect|2.12.18|
|**hadoop-client-runtime**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|scala-xml|2.12-2.1.0|
|**hadoop-cloud-storage**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|scalactic|2.12-3.2.14|
|**hadoop-openstack**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|scalatra|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-common|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20251103.2 ⬆️ 3.3.4.5.4.20251218.3**|scalatra-metrics|2.12-3.0.0-M1|
|**hdinsight-spark-metrics**|**3.5.0-1.0.12 ⬆️ 3.5.0-1.0.14**|shims|0.9.45|
...
|hive-shims|0.23-2.3.9|**spark-avro**|**2.12-3.5.0 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|hive-shims-common|2.3.9|**spark-catalyst**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|hive-shims-scheduler|2.3.9|**spark-common-utils**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|hive-storage-api|2.8.1|**spark-core**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|hk2-api|2.6.1|**spark-enhancement**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|hk2-locator|2.6.1|spark-enhancementui|2.12-3.3.0|
|hk2-utils|2.6.1|spark-eventstream-extensions|1.0.5|
|httpclient|4.5.14|**spark-graphx**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|httpclient5|5.1.3|**spark-hadoop-cloud**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|httpcore|4.4.16|**spark-hive**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|httpmime|4.5.13|spark-jobinsight|2.12-1.0.0-spark3.5|
|httpmime|4.5.14|spark-kusto-synapse-connector|3.5_2.12-1.5.1|
|**impulse-core_spark**|**3.5_2.12-1.1.0 ⬆️ 3.5_2.12-1.3.198470504**|**spark-kvstore**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|**impulse-exception_java11**|**1_2.12-1.1.0 ⬆️ 1_2.12-1.3.198470504**|**spark-launcher**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|**impulse-telemetry-mds_spark**|**3.5_2.12-1.1.0 ⬆️ 3.5_2.12-1.3.198470504**|spark-lighter-contract|2.12-2.1.0_spark-3.5.1_20240717.4|
|ini4j|0.5.4|spark-lighter-core|2.12-2.0.11_spark-3.5.1_20240717.4|
|isolation-forest|3.5.0_2.12-3.0.5|**spark-microsoft-tools**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|istack-commons-runtime|3.0.8|**spark-mllib**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|ivy|2.5.1|**spark-mllib-local**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jackson-annotations|2.15.2|spark-mssql-connector-fabric35|1.6.9|
|jackson-core|2.15.2|**spark-network-common**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jackson-core-asl|1.9.13|**spark-network-shuffle**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jackson-databind|2.15.2|**spark-onesecurity-client**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-common**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jackson-dataformat-xml|2.12.7|**spark-onesecurity-server**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jackson-datatype-jsr310|2.15.2|**spark-repl**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jackson-mapper-asl|1.9.13|**spark-sketch**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sql**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jackson-module-scala|2.12-2.15.2|**spark-sql-api**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jakarta.activation-api|1.2.2|**spark-sql-kafka**|**0_2.12-3.5.5.5.4.20251103.2 ⬆️ 0_2.12-3.5.5.5.4.20251218.3**|
|jakarta.annotation-api|1.3.5|**spark-streaming**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jakarta.inject|2.6.1|**spark-streaming-kafka**|**0_2.12-3.5.5.5.4.20251103.2 ⬆️ 0_2.12-3.5.5.5.4.20251218.3**|
|jakarta.servlet-api|4.0.3|**spark-streaming-kafka**|**0_2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jakarta.validation-api|2.0.2|**spark-tags**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|jakarta.ws.rs-api|2.1.6|**spark-token-provider-kafka**|**0_2.12-3.5.5.5.4.20251103.2 ⬆️ 0_2.12-3.5.5.5.4.20251218.3**|
|jakarta.xml.bind-api|2.3.2|**spark-unsafe**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
|janino|3.1.9|spark-xml|2.12-0.17.0|
|javassist|3.29.2-GA|**spark-yarn**|**2.12-3.5.5.5.4.20251103.2 ⬆️ 2.12-3.5.5.5.4.20251218.3**|
...
|jersey-hk2|2.40|synapseml-cognitive|2.12-1.1.0|
|jersey-server|2.40|synapseml-core|2.12-1.1.0|
|jettison|1.1|synapseml-deep-learning|2.12-1.1.0|
|jetty-util|9.4.57.v20241219|synapseml-internal|2.12-1.1.0.0-spark3.5|
|jetty-util-ajax|9.4.57.v20241219|synapseml-lightgbm|2.12-1.1.0|
|jline|2.14.6|synapseml-opencv|2.12-1.1.0|
|joda-time|2.12.5|synapseml-vw|2.12-1.1.0|
|jodd-core|3.5.2|**synfs**|**1.1.11-spark35-20251021.12 ⬆️ 1.1.12-spark35**|
|jsch|0.1.54|threeten-extra|1.7.1|
|json|1.8|tink|1.9.0|
|json|3|transaction-api|1.1|
|json-simple|1.1.1|transform-token-provider-utils|0.0.0|
|json-simple|1.1|**trident-core**|**1.2.28 ⬆️ 1.2.30**|
...
|junit-jupiter|5.5.2|**zookeeper**|**3.6.3.5.4.20251103.2 ⬆️ 3.6.3.5.4.20251218.3**|
|junit-jupiter-api|5.5.2|**zookeeper-jute**|**3.6.3.5.4.20251103.2 ⬆️ 3.6.3.5.4.20251218.3**|
...
|V8|5.0.0|**notebookutils**|**1.1.11.35.20251021.12 ⬆️ 1.1.12.35**|
