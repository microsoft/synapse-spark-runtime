...
*   **VHD Name**: eeb042692a8467.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-12-03.6-rc.1
...
|-----|-----|-----|
|1906348|CSparkMetricUpdate:1.0.16|There is a regression with a recent release of SML with version 1.0.14 which broke Kusto Connector component for Spark 3.5 in Fabric.|
...
|**CSparkMetricUpdate**|**1.0.14 ⬆️ 1.0.16**|Python|3.11/1.0.1|
|Delta|3.2.1.20251125.5|R|1.0.6|
...
|FLTSparkExtensions|0.10.3|SparkNativeParquetWriter|1.3.0-20250828.2|
...
|GlutenUI|1.3.0-20251127.2|SStreamOnSparkJar|2.4.1|
...
|LibraryManager|1.0.22|Vegas|3.5.09.06|
|LibraryMetadataCooker|2.0.3|VPaaSClient|3.5.03|
|MlflowLibrary|2.11.3.1|Wildfire|1.10.43.1|
|MMLSpark|1.4.27|
...
|flt-python|0.10.3|python-lmdb|1.4.1|
...
|**SparkCustomEvents**|**3.5.0-1.0.14 ⬆️ 3.5.0-1.0.16**|kryo-shaded|4.0.2|
...
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|parquet-hadoop-ms|3.5.5.5.4.20251218.3|
|fastutil|7.0.2|parquet-jackson|1.13.1|
|flatbuffers-java|1.12.0|pickle|1.3|
|flt-spark-sql-extensions|0.10.3|postgresql|2.2.9|
...
|gluten-velox-bundle-spark|3.5_2.12-mariner_2.0_x86_64-1.3.0-20251127.2|reactive-streams|1.0.3|
|gson|2.8.9|reactor-core|3.4.34|
|guava|4.0.1|reactor-netty-core|1.0.40|
|h3|4.1.1|reactor-netty-http|1.0.40|
|hadoop-aliyun|3.3.4.5.4.20251218.3|rocksdbjni|8.3.2|
|hadoop-annotations|3.3.4.5.4.20251218.3|scala-collection-compat|2.12-2.7.0|
|hadoop-aws|3.3.4.5.4.20251218.3|scala-compiler|2.12.18|
|hadoop-azure|3.3.4.5.4.20251218.3|scala-java8-compat|2.12-0.9.0|
|hadoop-azure-datalake|3.3.4.5.4.20251218.3|scala-library|2.12.18|
|hadoop-azureml|1.0-fs|scala-parser-combinators|2.12-2.3.0|
|hadoop-client-api|3.3.4.5.4.20251218.3|scala-reflect|2.12.18|
|hadoop-client-runtime|3.3.4.5.4.20251218.3|scala-xml|2.12-2.1.0|
|hadoop-cloud-storage|3.3.4.5.4.20251218.3|scalactic|2.12-3.2.14|
|hadoop-openstack|3.3.4.5.4.20251218.3|scalatra|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-common|2.12-3.0.0-M1|
|hadoop-yarn-server-web-proxy|3.3.4.5.4.20251218.3|scalatra-metrics|2.12-3.0.0-M1|
|**hdinsight-spark-metrics**|**3.5.0-1.0.14 ⬆️ 3.5.0-1.0.16**|shims|0.9.45|
...
|hive-shims|0.23-2.3.9|spark-avro|2.12-3.5.5.5.4.20251218.3|
|hive-shims|2.3.9|spark-avro|2.12-3.5.0|
|hive-shims-common|2.3.9|spark-catalyst|2.12-3.5.5.5.4.20251218.3|
|hive-shims-scheduler|2.3.9|spark-common-utils|2.12-3.5.5.5.4.20251218.3|
|hive-storage-api|2.8.1|spark-core|2.12-3.5.5.5.4.20251218.3|
|hk2-api|2.6.1|spark-enhancement|2.12-3.5.5.5.4.20251218.3|
|hk2-locator|2.6.1|spark-enhancementui|2.12-3.3.0|
|hk2-utils|2.6.1|spark-eventstream-extensions|1.0.5|
|httpclient|4.5.14|spark-graphx|2.12-3.5.5.5.4.20251218.3|
|httpclient5|5.1.3|spark-hadoop-cloud|2.12-3.5.5.5.4.20251218.3|
|httpcore|4.4.16|spark-hive|2.12-3.5.5.5.4.20251218.3|
|httpmime|4.5.14|spark-jobinsight|2.12-1.0.0-spark3.5|
|httpmime|4.5.13|spark-kusto-synapse-connector|3.5_2.12-1.5.1|
|impulse-core_spark|3.5_2.12-1.3.198470504|spark-kvstore|2.12-3.5.5.5.4.20251218.3|
|impulse-exception_java11|1_2.12-1.3.198470504|spark-launcher|2.12-3.5.5.5.4.20251218.3|
...
|isolation-forest|3.5.0_2.12-3.0.5|spark-microsoft-tools|2.12-3.5.5.5.4.20251218.3|
|istack-commons-runtime|3.0.8|spark-mllib|2.12-3.5.5.5.4.20251218.3|
|ivy|2.5.1|spark-mllib-local|2.12-3.5.5.5.4.20251218.3|
|jackson-annotations|2.15.2|spark-mssql-connector-fabric35|1.6.9|
|jackson-core|2.15.2|spark-network-common|2.12-3.5.5.5.4.20251218.3|
|jackson-core-asl|1.9.13|spark-network-shuffle|2.12-3.5.5.5.4.20251218.3|
|jackson-databind|2.15.2|spark-onesecurity-client|2.12-3.5.5.5.4.20251218.3|
|jackson-dataformat-cbor|2.15.2|spark-onesecurity-common|2.12-3.5.5.5.4.20251218.3|
|jackson-dataformat-xml|2.12.7|spark-onesecurity-server|2.12-3.5.5.5.4.20251218.3|
|jackson-datatype-jsr310|2.15.2|spark-repl|2.12-3.5.5.5.4.20251218.3|
|jackson-mapper-asl|1.9.13|spark-sketch|2.12-3.5.5.5.4.20251218.3|
|jackson-module-jaxb-annotations|2.15.2|spark-sql|2.12-3.5.5.5.4.20251218.3|
|jackson-module-scala|2.12-2.15.2|spark-sql-api|2.12-3.5.5.5.4.20251218.3|
|jakarta.activation-api|1.2.2|spark-sql-kafka|0_2.12-3.5.5.5.4.20251218.3|
|jakarta.annotation-api|1.3.5|spark-streaming|2.12-3.5.5.5.4.20251218.3|
|jakarta.inject|2.6.1|spark-streaming-kafka|2.12-3.5.5.5.4.20251218.3|
|jakarta.servlet-api|4.0.3|spark-streaming-kafka|0_2.12-3.5.5.5.4.20251218.3|
|jakarta.validation-api|2.0.2|spark-tags|2.12-3.5.5.5.4.20251218.3|
|jakarta.ws.rs-api|2.1.6|spark-token-provider-kafka|0_2.12-3.5.5.5.4.20251218.3|
|jakarta.xml.bind-api|2.3.2|spark-unsafe|2.12-3.5.5.5.4.20251218.3|
|janino|3.1.9|spark-xml|2.12-0.17.0|
|javassist|3.29.2-GA|spark-yarn|2.12-3.5.5.5.4.20251218.3|
...
|junit-jupiter|5.5.2|zookeeper|3.6.3.5.4.20251218.3|
|junit-jupiter-api|5.5.2|zookeeper-jute|3.6.3.5.4.20251218.3|
