...
*   **VHD Name**: 1010102059233c.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-07-30.5-rc.1
*   **Operating System**: CBL-Mariner 2.0.20250729
*   **Apache Spark**: 3.5.1
*   **Java**: 11.0.27
*   **Scala**: 2.12.18
*   **Python**: 3.11/1.0.1
*   **Delta Lake**: 3.2.0.20250905.3
...
|1749881|ServiceConfigurationTemplates:spark35|Reverts driver and executor memory overhead defaults in Spark 3.5 to 384MB.|
|1761071|Delta:3.2.0.20250731.1|Delta 3.2.0.20250731.1 fixes an incompatibility issue between Delta and Spark native API|
|1775493|SparkJobInsight:1.0.1|Fix JobInsight broken by Spark runtime environment change|
|1778555|DSCopilot:1.3.1|Enables GPT-4.1 as the default model in regions where it is deployed within Fabric.|
|1793709|Delta:3.2.0.20250905.3|Hot fix to fix and ensure RLS enablement flag is set and propagated correctly.|
...
|**AutoscaleProbe**|**3.9.7 ⬆️ 3.9.8**|**OnelakeSparkCatalog**|**0.2.8 ⬆️ 0.2.13**|
|AzureMLExtensions|1.0.4|PostgreSQLJDBCDriver|1.0.3|
|Conda|5.2.20|Python|3.11/1.0.1|
|**CSparkMetricUpdate**|**1.0.10 ⬆️ 1.0.11**|R|1.0.6|
|**Delta**|**3.2.0.21 ⬆️ 3.2.0.20250905.3**|SparkAdvisor|1.0.5|
|**DSCopilot**|**1.3.0 ⬆️ 1.3.1**|SparkDiagnosticsLibrary|1.0.30|
|DSCopilotInstaller|1.0.0|**SparkJobInsight**|**1.0.0 ⬆️ 1.0.1**|
|**Esri**|**1.0.0 ⬆️ 1.0.1**|SparkLighter|2.0.4|
|EventHubConnector|2.3.27|**SparkLineage**|**1.26.3 ⬆️ 0.0.1**|
|FabricDWConnector|1.0.14|SparklyrConnector|2.0.1|
|FLTSparkExtensions|0.5.2|**SparkNativeParquetWriter**|**1.3.0-20250516.3 ⬆️ 1.3.0-20250624.2**|
...
|**GlutenUI**|**1.3.0-20250516.7 ⬆️ 1.3.0-20250724.2**|**TridentCore**|**1.2.23 ⬆️ 1.2.25**|
|HiveMetaStoreClient|1.1.21.2|**TridentTokenLibrary**|**1.9.10 ⬆️ 1.9.14**|
|**Impulse**|**1.0.30 ⬆️ 1.1.0**|**Vegas**|**3.5.09.05 ⬆️ 3.5.09.06**|
|KustoConnector|1.5.1|VPaaSClient|3.5.03|
|LibraryManager|1.0.18|**Wildfire**|**1.10.29.1 ⬆️ 1.10.35.1**|
...
|azure-data-lake-store-sdk|2.3.9|mysql-connector-java|8.0.18|
...
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20250519.1 ⬆️ 3.3.4.5.4.20250711.1**|scalatra-metrics|2.12-3.0.0-M1|
...
|jakarta.activation-api|1.2.2|**spark-streaming-kafka**|**2.12-3.5.1.5.4.20250519.1 ⬆️ 2.12-3.5.1.5.4.20250711.1**|
