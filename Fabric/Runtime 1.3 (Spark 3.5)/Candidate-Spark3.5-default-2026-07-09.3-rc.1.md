...
*   **VHD Name**: 44117180b66e22.vhd
*   **Vhd Release**: Spark3.5-default-2026-07-09.3-rc.1
...
|-----|-----|-----|
|2238405|Wildfire/spark35:1.10.59|New Spark NEE Release which includes changes in Gluten, and a new Spark 3.5 Release which includes changes in wildfire-spark.|
|2229290|ServiceConfigurationTemplates:spark/3.5.0|The OneSecurity async-shuffle index cache, data cache, and timing metrics are turned off by default in the Spark 3.5 Mariner 2 runtime configuration.|
|2165180|Delta:3.2.1.20260609.1|Delivers performance optimizations, stability fixes, security-related enhancements, and dependency updates to improve reliability, correctness, and overall platform robustness.|
|2176609|FLTSparkExtensions:1.6.1|Release new version 1.6.1 of FLTSparkExtensions with improvements in FileIngestion feature|
...
|-----|-----|-----|
|2238405|Wildfire/spark35:1.10.59|New Spark NEE Release which includes changes in Gluten, and a new Spark 3.5 Release which includes changes in wildfire-spark.|
|2129712|FLTSparkExtensions:1.4.3|Update FLT-SparkExtensions version to 1.4.3|
|2162534|Wildfire/spark35:1.10.58|Delivers security and RLS/CLS enhancements, stability fixes, query execution improvements, and performance optimizations to improve correctness, observability, scalability, and overall reliability across Spark, Livy, and Hadoop components.|


# Components
|Name|Version|Name|Version|
|-----|-----|-----|-----|
|Auditd|0.0.2|NotebookUtils|1.1.66|
|AutoscaleProbe|3.9.9|OneLakeClientStarter|1.0.28.1|
|AzureMLExtensions|1.0.5|OnelakeSparkCatalog|0.4.9|
|Conda|5.2.25|PostgreSQLJDBCDriver|1.0.3|
...
|**FLTSparkExtensions**|**1.4.3 ⬆️ 1.6.1**|SparkNativeParquetWriter|1.3.0-20250828.2|
|FLTSparkUtils|0.3.0|SparkRPCHistoryServer|1.11.0|
|FsspecWrapper|1.0.7|SparkSqlConnector|1.6.10|
|Genesis|0.37.0|SQLServerODBCDriver|18.1.0|
|**GlutenUI**|**1.3.0-20260317.7 ⬆️ 1.3.0-20260806.4**|SStreamOnSparkJar|2.4.1|
|HiveMetaStoreClient|1.1.28|TokenLibrary|4.3.9|
|Impulse|1.5.214702911|TridentCore|1.3.4|
|KustoConnector|2.0.6|TridentTokenLibrary|1.12.0|
|LibraryManager|1.0.26|UpgradeToFabric|1.2.11|
|LibraryMetadataCooker|2.0.5|Vegas|3.5.10|
|MlflowLibrary|2.11.3.1|VPaaSClient|3.5.03|
|MMLSpark|1.4.31|**Wildfire**|**1.10.53.1 ⬆️ 1.10.59.1**|
...
|libxslt|1.1.37|impulse-python-handler|1.5.214702911|
...
|lzo|2.10|mypy|1.4.1|
|make|4.2.1|nni|3.0|
|markdown|3.4.1|notebookutils|1.1.14.35.20260507.11|
...
|TokenLibrary-assembly|4.3.8|kusto-spark|3.0_2.12-7.0.7-SNAPSHOT|
...
|commons-lang3|3.12.0|notebook-utils|1.1.14-spark35-20260507.11|
...
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|**parquet-hadoop-ms**|**3.5.5.5.4.20260403.6 ⬆️ 3.5.5.5.4.20260807.1**|
...
|genesis-client|2.12-0.37.0-jar-with-dependencies|qpid-proton-j-extensions|1.2.4|
|geoanalytics-fabric|2.12-1.0.1-msfabric-1.3|reactive-streams|1.0.3|
|**gluten-velox-bundle-spark**|**2.12-mariner_2.0_x86_64-1.3.0-20260317.7 ⬆️ 2.12-mariner_2.0_x86_64-1.3.0-20260806.4**|reactor-core|3.4.34|
|gson|2.8.9|reactor-netty-core|1.0.40|
|guava|14.0.1|reactor-netty-http|1.0.40|
|h3|4.1.1|rocksdbjni|8.3.2|
|**hadoop-aliyun**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|scala-collection-compat|2.12-2.7.0|
|**hadoop-annotations**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|scala-compiler|2.12.18|
|**hadoop-aws**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|scala-library|2.12.18|
|**hadoop-azure-datalake**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|scala-parser-combinators|2.12-2.3.0|
|hadoop-azureml|1.0-fs|scala-reflect|2.12.18|
|**hadoop-client-api**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|scala-xml|2.12-2.1.0|
|**hadoop-client-runtime**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|scalactic|2.12-3.2.14|
|**hadoop-cloud-storage**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|scalatra|2.12-3.0.0-M1|
|**hadoop-openstack**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|scalatra-common|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-metrics|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260807.1**|shims|0.9.45|
...
|hive-shims|2.3.9|**spark-arsenal**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|hive-shims-common|2.3.9|spark-avro|2.12-3.5.0|
|hive-shims-scheduler|2.3.9|**spark-avro**|**2.12-3.5.0 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|hive-storage-api|2.8.1|**spark-catalyst**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|hk2-api|2.6.1|**spark-common-utils**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|hk2-locator|2.6.1|**spark-core**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|hk2-utils|2.6.1|**spark-enhancement**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
...
|httpmime|4.5.13|**spark-graphx**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|httpmime|4.5.14|**spark-hadoop-cloud**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|impulse-core_spark|2.12-1.5.214702911|**spark-hive**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|impulse-exception_java11|2.12-1.5.214702911|spark-jobinsight|2.12-1.0.0-spark3.5|
|impulse-telemetry-common|2.12-1.5.214702911|spark-kusto-synapse-connector|3.5_2.12-2.0.6|
|impulse-telemetry-mds_spark|2.12-1.5.214702911|**spark-kvstore**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|impulse-telemetry-pulse_spark|2.12-1.5.214702911|**spark-launcher**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
...
|istack-commons-runtime|3.0.8|**spark-microsoft-tools**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|ivy|2.5.1|**spark-mllib**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-annotations|2.15.2|**spark-mllib-local**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-core|2.15.2|spark-mssql-connector-fabric35|1.6.10|
|jackson-core-asl|1.9.13|**spark-network-common**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-databind|2.15.2|**spark-network-shuffle**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-client**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-dataformat-xml|2.12.7|**spark-onesecurity-common**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-datatype-jsr310|2.15.2|**spark-onesecurity-server**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-mapper-asl|1.9.13|**spark-repl**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sketch**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-module-scala|2.12-2.15.2|**spark-sql**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.activation-api|1.2.2|**spark-sql-api**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.annotation-api|1.3.5|**spark-sql-kafka**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.inject|2.6.1|**spark-streaming**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.servlet-api|4.0.3|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.validation-api|2.0.2|**spark-tags**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.ws.rs-api|2.1.6|**spark-token-provider-kafka**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.xml.bind-api|2.3.2|**spark-unsafe**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|janino|3.1.9|spark-xml|2.12-0.17.0|
|javassist|3.29.2-GA|**spark-yarn**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
...
|jodd-core|3.5.2|synfs|1.1.14-spark35-20260507.11|
...
|junit-jupiter|5.5.2|**zookeeper**|**3.6.3.5.4.20260403.6 ⬆️ 3.6.3.5.4.20260807.1**|
|junit-jupiter-api|5.5.2|**zookeeper-jute**|**3.6.3.5.4.20260403.6 ⬆️ 3.6.3.5.4.20260807.1**|
...
|V8|5.0.0|notebookutils|1.1.14.35.20260507.11|
