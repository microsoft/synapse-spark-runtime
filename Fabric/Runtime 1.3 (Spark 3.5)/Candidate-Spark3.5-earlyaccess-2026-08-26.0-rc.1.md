...
*   **VHD Name**: d69593154d4ada.vhd
*   **Vhd Release**: Spark3.5-earlyaccess-2026-08-26.0-rc.1
...
|-----|-----|-----|
|2264488|FLTSparkExtensions:1.9.3|Improves FMLV declarative file ingestion feature with added capabilities like single file sources, data quality constraints, corrupt row handling for CSV files, and fixes for path issues.|
|2264895|LibraryManager:1.0.32|Enhances user and system error classifications for Environment Publish during the Library Preparation Stage, improving reliability by distinguishing user configuration errors from system and ambiguous failures.|
...
|AutoscaleProbe|3.9.12|OneLakeClientStarter|1.0.28.1|
|AzureMLExtensions|1.0.5|OnelakeSparkCatalog|0.4.17|
|Conda|5.2.27|PostgreSQLJDBCDriver|1.0.3|
|**CSparkMetricUpdate**|**1.0.19 ⬆️ 1.0.17**|Python|3.11/1.0.2|
|Delta|3.2.1.20260609.1|R|1.0.7|
|DSCopilot|1.3.2|**SparkAdvisor**|**1.0.8 ⬆️ 1.0.7**|
|DSCopilotInstaller|1.0.0|**SparkDiagnosticsLibrary**|**1.0.34 ⬆️ 1.0.32**|
|Esri|1.0.1|SparkJobInsight|1.0.2|
|EventHubConnector|2.3.27|**SparkLighter**|**2.0.5 ⬆️ 2.0.4**|
|EventStreamsFabricExtension|1.0.0.4|SparkLineage|0.0.4|
|**FabricDWConnector**|**1.0.25 ⬆️ 1.0.23**|**SparklyrConnector**|**2.0.2 ⬆️ 2.0.1**|
|**FLTSparkExtensions**|**1.9.0 ⬆️ 1.9.3**|**SparkNativeParquetWriter**|**3.5.0-20260403.14 ⬆️ 1.3.0-20250828.2**|
|FLTSparkUtils|0.3.0|SparkRPCHistoryServer|1.11.0|
|FsspecWrapper|1.0.7|**SparkSqlConnector**|**1.8.1 ⬆️ 1.6.10**|
|Genesis|0.39.0|**SQLServerODBCDriver**|**18.1.1 ⬆️ 18.1.0**|
|**GlutenUI**|**1.3.0-20260805.1 ⬆️ 1.3.0-20260811.2**|SStreamOnSparkJar|2.4.1|
|HiveMetaStoreClient|1.1.28|TokenLibrary|4.3.9|
|Impulse|1.5.230534541|TridentCore|1.4.5|
|**KustoConnector**|**2.1.1 ⬆️ 2.0.6**|**TridentTokenLibrary**|**1.13.1 ⬆️ 1.12.0**|
|**LibraryManager**|**1.0.31 ⬆️ 1.0.32**|**UpgradeToFabric**|**1.2.15 ⬆️ 1.2.11**|
|LibraryMetadataCooker|2.0.5|Vegas|3.5.10|
|MlflowLibrary|2.11.3.1|VPaaSClient|3.5.03|
|MMLSpark|1.4.31|**Wildfire**|**1.10.60.1 ⬆️ 1.10.59.1**|
...
|libwebp|1.3.2|**flt-python**|**1.9.0 ⬆️ 1.9.3**|
...
|mpmath|1.3.0|**spark-mssql-connector-fabric35**|**1.1.0 ⬆️ 1.0.0**|
...
|TokenLibrary-assembly|4.3.8|**kusto-spark**|**3.0_2.12-7.1.2 ⬆️ 3.0_2.12-7.0.7-SNAPSHOT**|
...
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|**parquet-hadoop-ms**|**3.5.5.5.4.20260810.1 ⬆️ 3.5.5.5.4.20260807.1**|
|fastutil|7.0.2|parquet-jackson|1.13.1|
|flatbuffers-java|1.12.0|pickle|1.3|
|**flt-spark-sql-extensions**|**1.9.0 ⬆️ 1.9.3**|postgresql|42.2.9|
|fluent-logger|0.3.4-jar-with-dependencies-provided|profiler|1.1.1|
|**fmlv-utils**|**1.9.0 ⬆️ 1.9.3**|proton-j|0.33.8|
...
|**gluten-velox-bundle-spark**|**2.12-azurelinux_3.0_x86_64-1.3.0-20260805.1 ⬆️ 2.12-mariner_2.0_x86_64-1.3.0-20260811.2**|reactor-core|3.4.34|
|gson|2.8.9|reactor-netty-core|1.0.40|
|guava|14.0.1|reactor-netty-http|1.0.40|
|h3|4.1.1|rocksdbjni|8.3.2|
|**hadoop-aliyun**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|scala-collection-compat|2.12-2.7.0|
|**hadoop-annotations**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|scala-compiler|2.12.18|
|**hadoop-aws**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|scala-library|2.12.18|
|**hadoop-azure-datalake**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|scala-parser-combinators|2.12-2.3.0|
|hadoop-azureml|1.0-fs|scala-reflect|2.12.18|
|**hadoop-client-api**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|scala-xml|2.12-2.1.0|
|**hadoop-client-runtime**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|scalactic|2.12-3.2.14|
|**hadoop-cloud-storage**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|scalatra|2.12-3.0.0-M1|
|**hadoop-openstack**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|scalatra-common|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-metrics|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20260810.1 ⬆️ 3.3.4.5.4.20260807.1**|shims|0.9.45|
...
|hive-shims|2.3.9|**spark-arsenal**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
...
|hive-storage-api|2.8.1|**spark-catalyst**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|hk2-api|2.6.1|**spark-common-utils**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|hk2-locator|2.6.1|**spark-core**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|hk2-utils|2.6.1|**spark-enhancement**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
...
|httpmime|4.5.13|**spark-graphx**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|httpmime|4.5.14|**spark-hadoop-cloud**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|impulse-core_spark|2.12-1.5.230534541|**spark-hive**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|impulse-exception_java11|2.12-1.5.230534541|spark-jobinsight|2.12-1.0.0-spark3.5|
|impulse-telemetry-common|2.12-1.5.230534541|**spark-kusto-synapse-connector**|**3.5_2.12-2.1.1 ⬆️ 3.5_2.12-2.0.6**|
|impulse-telemetry-mds_spark|2.12-1.5.230534541|**spark-kvstore**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|impulse-telemetry-pulse_spark|2.12-1.5.230534541|**spark-launcher**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
...
|istack-commons-runtime|3.0.8|**spark-microsoft-tools**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|ivy|2.5.1|**spark-mllib**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-annotations|2.15.2|**spark-mllib-local**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-core|2.15.2|**spark-mssql-connector-fabric35**|**1.8.1 ⬆️ 1.6.10**|
|jackson-core-asl|1.9.13|**spark-network-common**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-databind|2.15.2|**spark-network-shuffle**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-client**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-dataformat-xml|2.12.7|**spark-onesecurity-common**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-datatype-jsr310|2.15.2|**spark-onesecurity-server**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-mapper-asl|1.9.13|**spark-repl**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sketch**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jackson-module-scala|2.12-2.15.2|**spark-sql**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.activation-api|1.2.2|**spark-sql-api**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.annotation-api|1.3.5|**spark-sql-kafka**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.inject|2.6.1|**spark-streaming**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.servlet-api|4.0.3|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.validation-api|2.0.2|**spark-tags**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.ws.rs-api|2.1.6|**spark-token-provider-kafka**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|jakarta.xml.bind-api|2.3.2|**spark-unsafe**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|janino|3.1.9|spark-xml|2.12-0.17.0|
|javassist|3.29.2-GA|**spark-yarn**|**2.12-3.5.5.5.4.20260810.1 ⬆️ 2.12-3.5.5.5.4.20260807.1**|
|javatuples|1.2|**spark_diagnostic_cli**|**2.3.0_spark-3.5.1_20260518.3-shaded ⬆️ 2.2.0_spark-3.5.1_20260223.3-shaded**|
...
|json4s-ast|2.12-3.7.0-M11|**tridenttokenlibrary-assembly**|**1.13.1 ⬆️ 1.12.0**|
...
|junit-jupiter|5.5.2|**zookeeper**|**3.6.3.5.4.20260810.1 ⬆️ 3.6.3.5.4.20260807.1**|
|junit-jupiter-api|5.5.2|**zookeeper-jute**|**3.6.3.5.4.20260810.1 ⬆️ 3.6.3.5.4.20260807.1**|
