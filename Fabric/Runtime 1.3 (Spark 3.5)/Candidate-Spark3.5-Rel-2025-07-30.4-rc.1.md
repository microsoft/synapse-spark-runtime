...
*   **VHD Name**: c052696206d11d.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-07-30.4-rc.1
...
|-----|-----|-----|
|1779861|N/A|In regions where GPT-4.1 is deployed in Fabric it will be the new default model.|
...
|chat-magics-fabric|0.2.0.25.8.21|pexpect|4.8.0|
...
|genesis-client|2.12-0.34.0-jar-with-dependencies|py4j|0.10.9.7|
