...
*   **VHD Name**: 94a64196c8a219.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-07-30.3-rc.1
...
|Id|Component|Description|
|-----|-----|-----|
|1766999|Genesis:0.34.0|Increase timeout for library deployment stage from 10 mins to 30 mins. This is a short-term mitigation for the session acquisition failures due to slow untar performance in LDS|
...
|**Delta**|**3.2.0.21 ⬆️ 3.2.0.20250731.1**|SparkAdvisor|1.0.5|
...
|jakarta.activation-api|1.2.2|**spark-streaming-kafka**|**2.12-3.5.1.5.4.20250519.1 ⬆️ 0_2.12-3.5.1.5.4.20250711.1**|
