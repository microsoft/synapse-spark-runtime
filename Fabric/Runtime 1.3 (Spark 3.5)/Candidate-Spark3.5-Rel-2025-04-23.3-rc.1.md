...
*   **VHD Name**: c8575706367990.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-04-23.3-rc.1
...
|1654571|MMLSpark:1.4.22|Updated the SynapseML distributed machine learning framework libraries shipped as part of Fabric VHD component. https://github.com/microsoft/SynapseML/releases/tag/v1.0.11|
|1662676|OneLakeClientStarter:1.0.24.3|Revert OLC Client to 176.68.0 due to intermittent pipeline auth issues in version 176.96.0|
...
|jakarta.servlet-api|4.0.3|**spark-tags**|**2.12-3.5.1.5.4.20250317.1 ⬆️ 2.12-3.5.1.5.4.20250416.1**|
...
|jul-to-slf4j|2.0.7|**zookeeper-jute**|**3.6.3.5.4.20250317.1 ⬆️ 3.6.3.5.4.20250416.1**|
