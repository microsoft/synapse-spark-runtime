...
*   **VHD Name**: b7725343065c98.vhd
*   **Vhd Release**: Spark3.5-Rel-2026-07-08.0-rc.1
...
|-----|-----|-----|
|2140461|EventStreamsFabricExtension:1.0.0.3|Introduces PrivateLink cross-workspace feature for EventStreamAdapters, enabling secure interaction between notebooks and EventStreamAdapters across workspaces via a private network. Previously, access was limited to the public network.|
...
|Id|Component|Description|
|-----|-----|-----|
|2164961|LibraryManager:1.0.30|Improves LibraryManager resiliency and diagnostics for transient OneLake upload/download failures, adding retries, detailed error classification, and enhanced logging for root-cause analysis. No changes to user-facing behavior.|
|2133690|SparkAdvisor:1.0.8|Improves SparkAdvisor to rate limit fallback events, preventing shared event queue saturation in high-frequency scenarios.|
...
|2161967|FLTSparkExtensions:1.6.1|Released FLTSparkExtensions version 1.6.1 with improvements to the FileIngestion feature and fixes for PyDeequ bugs.|
|2162510|Impulse:1.5.224064063|Updates Impulse library to version 1.5.224064063 for Spark 3.5 VHD, enhancing error classification across token-service, spark-submit, PySpark/JDBC/Delta exceptions, and YARN AM-timeout, along with tooling upgrades.|
|2119895|NotebookUtils:1.1.67|Updates NotebookUtils to 1.1.15 and blobfuse to v2.1.21 for Spark 3.5, delivering customer-facing fixes and improvements for runtime behavior, sovereign cloud OneLake mounts, Plotly rendering, UDF metadata, mount reliability, and Redis connection handling.|
...
|Id|Component|Description|
|-----|-----|-----|
|2147632|LakeMetastore:0.4.16, TridentCore:1.4.4|Forces the use of FQDN-based endpoints for Onelake and Platform APIs, introducing a feature flag to support cross-workspace queries between public and private workspaces.|
|2119895|NotebookUtils:1.1.67|Updates NotebookUtils to 1.1.15 and blobfuse to v2.1.21 for Spark 3.5, delivering customer-facing fixes and improvements for runtime behavior, sovereign cloud OneLake mounts, Plotly rendering, UDF metadata, mount reliability, and Redis connection handling.|
...
|AzureMLExtensions|1.0.5|**OnelakeSparkCatalog**|**0.4.9 ⬆️ 0.4.16**|
...
|DSCopilot|1.3.2|**SparkAdvisor**|**1.0.7 ⬆️ 1.0.8**|
...
|**EventStreamsFabricExtension**|**1.0.0 ⬆️ 1.0.0.3**|SparkLineage|0.0.4|
|**FabricDWConnector**|**1.0.23 ⬆️ 1.0.25**|**SparklyrConnector**|**2.0.1 ⬆️ 2.0.2**|
|**FLTSparkExtensions**|**1.4.3 ⬆️ 1.6.1**|**SparkNativeParquetWriter**|**1.3.0-20250828.2 ⬆️ 3.5.0-20260403.14**|
...
|**Impulse**|**1.5.214702911 ⬆️ 1.5.224064063.1**|**TridentCore**|**1.3.4 ⬆️ 1.4.4**|
|**KustoConnector**|**2.0.6 ⬆️ 2.1.0**|**TridentTokenLibrary**|**1.12.0 ⬆️ 1.13.1**|
|**LibraryManager**|**1.0.26 ⬆️ 1.0.30**|**UpgradeToFabric**|**1.2.11 ⬆️ 1.2.15**|
...
|libwebp|1.3.2|**flt-python**|**1.4.3 ⬆️ 1.6.1**|
...
|libxslt|1.1.37|**impulse-python-handler**|**1.5.214702911 ⬆️ 1.5.224064063**|
...
|**flt-spark-sql-extensions**|**1.4.3 ⬆️ 1.6.1**|postgresql|42.2.9|
|fluent-logger|0.3.4-jar-with-dependencies-provided|profiler|1.1.1|
|**fmlv-utils**|**1.4.3 ⬆️ 1.6.1**|proton-j|0.33.8|
...
|httpclient5|5.1.3|**spark-eventstream-extensions**|**1.0.5 ⬆️ 1.0.10**|
...
|**impulse-core_spark**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.224064063**|**spark-hive**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|**impulse-exception_java11**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.224064063**|spark-jobinsight|2.12-1.0.0-spark3.5|
|**impulse-telemetry-common**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.224064063**|**spark-kusto-synapse-connector**|**3.5_2.12-2.0.6 ⬆️ 3.5_2.12-2.1.0**|
|**impulse-telemetry-mds_spark**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.224064063**|**spark-kvstore**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|**impulse-telemetry-pulse_spark**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.224064063**|**spark-launcher**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
...
|json-simple|1.1|**trident-core**|**1.3.4 ⬆️ 1.4.4**|
