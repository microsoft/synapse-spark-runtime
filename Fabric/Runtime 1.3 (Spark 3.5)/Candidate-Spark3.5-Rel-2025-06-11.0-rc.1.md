...
*   **VHD Name**: 03e113140cfda5.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-06-11.0-rc.1
...
|1697378|Conda:5.2.21|Updates semantic-link-sempy and flaml libraries to improve functionality, error handling, and support for multi-node Spark clusters, ISO language codes, low-code scenarios, and enhanced logging capabilities.|
|1690195|Conda:5.2.19|Updates FQDN usage for generating MWC tokens in workspace private link scenarios and deprecates legacy regional platform FQDN logic in favor of Fabric public API FQDN.|
|1696266|NotebookUtils:1.1.60.2|Updates NotebookUtils to support WS PL FQDN for notebook resources, addressing issues with encrypted SAS URLs in tenant private links and improving compatibility for affected regions.|
...
|1690195|Conda:5.2.19|Updates FQDN usage for generating MWC tokens in workspace private link scenarios and deprecates legacy regional platform FQDN logic in favor of Fabric public API FQDN.|
|1690380|SparkDiagnosticLibrary:1.0.30|Updates the diagnostic library to address a buffer overflow issue, preventing excessive logs in stdout files.|
|1692798|Impulse:1.0.33|Updates Impulse to version 1.0.33, addressing a bug where classification failed due to missing SparkException references and setting isErrorRetriable to true by default.|
|1695874|OneLakeClientStarter:1.0.26.2|Fixes issue where the OneLakeClient service retries infinitely during Spark VM startup, addressing configuration timing conflicts that prevented Yarn RM from starting.|
|1696008|Conda:5.2.20|Removes redundant error messages for token cache misses in the SynapseML-Utils library to improve clarity and reduce latency.|
|1684708|AutoscaleProbe:3.9.7|Fixes a datetime format mismatch in the Livy API that caused exceptions in TridentBilling probes during Autoscale operations.|


# Components
|Name|Version|Name|Version|
|-----|-----|-----|-----|
|AutoscaleProbe|3.9.7|**OnelakeSparkCatalog**|**0.2.8 ⬆️ 0.2.12**|
|AzureMLExtensions|1.0.4|PostgreSQLJDBCDriver|1.0.3|
|**Conda**|**5.2.18 ⬆️ 5.2.21**|Python|3.11/1.0.1|
|CSparkMetricUpdate|1.0.10|R|1.0.6|
|**Delta**|**3.2.0.21 ⬆️ 3.2.0.23**|SparkAdvisor|1.0.5|
...
|FLTSparkExtensions|0.5.1|SparkNativeParquetWriter|1.3.0-20250516.3|
...
|**GlutenUI**|**1.3.0-20250516.7 ⬆️ 1.3.0-20250609.2**|**TridentCore**|**1.2.23 ⬆️ 1.2.24**|
|HiveMetaStoreClient|1.1.21.2|TridentTokenLibrary|1.9.10|
|**Impulse**|**1.0.30 ⬆️ 1.0.33**|Vegas|3.5.09.05|
...
|**flaml**|**2.3.4.post2 ⬆️ 2.3.5.post4**|python-fastjsonschema|2.16.2|
...
|idna|3.4|**semantic-link-sempy**|**0.10.2 ⬆️ 0.11.0**|
...
|**impulse-python-handler**|**1.0.30.1.0.0 ⬆️ 1.0.33**|singledispatch|3.7.0|
...
|jupyterlab|4.0.11|**synapseml-utils**|**1.1.3 ⬆️ 1.1.6.post2**|
...
|commons-lang3|3.12.0|notebook-utils|1.1.11-spark35-20250605.2|
...
|compress-lzf|1.1.2|**openlineage-spark**|**2.12-1.26.0-xml-04242025 ⬆️ 2.12-1.26.0**|
...
|**delta-kernel-api**|**3.2.0.21 ⬆️ 3.2.0.23**|osgi-resource-locator|1.0.3|
|**delta-kernel-defaults**|**3.2.0.21 ⬆️ 3.2.0.23**|paranamer|2.8|
|**delta-spark**|**2.12-3.2.0.21 ⬆️ 2.12-3.2.0.23**|parquet-column|1.13.1|
|**delta-storage**|**3.2.0.21 ⬆️ 3.2.0.23**|parquet-common|1.13.1|
|derby|0.14.2.0|parquet-encoding|1.13.1|
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|parquet-format-structures|1.13.1|
|fastutil|7.0.2|parquet-hadoop-ms|3.5.1.5.4.20250519.1|
|flatbuffers-java|1.12.0|parquet-jackson|1.13.1|
|flt-spark-sql-extensions|0.5.1|pickle|1.3|
...
|**gluten-velox-bundle-spark**|**3.5_2.12-mariner_2.0_x86_64-1.3.0-20250516.7 ⬆️ 3.5_2.12-mariner_2.0_x86_64-1.3.0-20250609.2**|qpid-proton-j-extensions|1.2.4|
|gson|2.8.9|reactive-streams|1.0.3|
|guava|4.0.1|reactor-core|3.4.34|
|h3|4.1.1|reactor-netty-core|1.0.40|
|hadoop-aliyun|3.3.4.5.4.20250519.1|reactor-netty-http|1.0.40|
|hadoop-annotations|3.3.4.5.4.20250519.1|rocksdbjni|8.3.2|
|hadoop-aws|3.3.4.5.4.20250519.1|scala-collection-compat|2.12-2.7.0|
|hadoop-azure|3.3.4.5.4.20250519.1|scala-compiler|2.12.18|
|hadoop-azure-datalake|3.3.4.5.4.20250519.1|scala-java8-compat|2.12-0.9.0|
|hadoop-azureml|1.0-fs|scala-library|2.12.18|
|hadoop-client-api|3.3.4.5.4.20250519.1|scala-parser-combinators|2.12-2.3.0|
|hadoop-client-runtime|3.3.4.5.4.20250519.1|scala-reflect|2.12.18|
|hadoop-cloud-storage|3.3.4.5.4.20250519.1|scala-xml|2.12-2.1.0|
|hadoop-openstack|3.3.4.5.4.20250519.1|scalactic|2.12-3.2.14|
|hadoop-shaded-guava|1.1.1|scalatra|2.12-3.0.0-M1|
|hadoop-yarn-server-web-proxy|3.3.4.5.4.20250519.1|scalatra-common|2.12-3.0.0-M1|
...
|hive-shims-scheduler|2.3.9|spark-catalyst|2.12-3.5.1.5.4.20250519.1|
|hive-storage-api|2.8.1|spark-common-utils|2.12-3.5.1.5.4.20250519.1|
|hk2-api|2.6.1|spark-core|2.12-3.5.1.5.4.20250519.1|
|hk2-locator|2.6.1|spark-enhancement|2.12-3.5.1.5.4.20250519.1|
|hk2-utils|2.6.1|spark-enhancementui|2.12-3.3.0|
|httpclient|4.5.14|spark-graphx|2.12-3.5.1.5.4.20250519.1|
|httpclient5|5.1.3|spark-hadoop-cloud|2.12-3.5.1.5.4.20250519.1|
|httpcore|4.4.16|spark-hive|2.12-3.5.1.5.4.20250519.1|
|httpmime|4.5.13|spark-jobinsight|2.12-1.0.0-spark3.5|
|httpmime|4.5.14|spark-kusto-synapse-connector|3.5_2.12-1.5.1|
|**impulse-core_spark**|**3.5_2.12-1.0.30 ⬆️ 3.5_2.12-1.0.33**|spark-kvstore|2.12-3.5.1.5.4.20250519.1|
|**impulse-exception_java11**|**1_2.12-1.0.33**|spark-launcher|2.12-3.5.1.5.4.20250519.1|
|**impulse-telemetry-mds_spark**|**3.5_2.12-1.0.30 ⬆️ 3.5_2.12-1.0.33**|spark-lighter-contract|2.12-2.1.0_spark-3.5.1_20240717.4|
...
|json|3|**trident-core**|**1.2.23 ⬆️ 1.2.24**|
