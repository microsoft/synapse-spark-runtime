...
*   **VHD Name**: 7f485259a83f65.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-05-26.5-rc.1
...
|Id|Component|Description|
|-----|-----|-----|
|1708659|Conda:5.2.20|SynapseML-Utils has chance to try get token from cache in token library first in live pool. Cache miss is possible and acceptable and shouldn't producing any confusing error.|
...
|**Conda**|**5.2.18 ⬆️ 5.2.20**|Python|3.11/1.0.1|
...
|delta-storage|3.2.0.21|parquet-encoding|1.13.1|
...
|flt-spark-sql-extensions|0.5.1|postgresql|2.2.9|
...
|hk2-api|2.6.1|spark-enhancement|2.12-3.5.1.5.4.20250519.1|
...
|httpmime|4.5.13|spark-kvstore|2.12-3.5.1.5.4.20250519.1|
...
|jakarta.annotation-api|1.3.5|spark-streaming-kafka|0_2.12-3.5.1.5.4.20250519.1|
|jakarta.inject|2.6.1|spark-streaming-kafka|2.12-3.5.1.5.4.20250519.1|
