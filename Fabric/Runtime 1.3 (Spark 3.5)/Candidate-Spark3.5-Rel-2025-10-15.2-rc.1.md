...
*   **VHD Name**: 9bb59435b9dc54.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-10-15.2-rc.1
*   **Operating System**: CBL-Mariner 2.0.20251030
*   **Apache Spark**: 3.5.5
*   **Java**: 11.0.27
*   **Scala**: 2.12.18
*   **Python**: 3.11/1.0.1
...
|-----|-----|-----|
|1865301|Wildfire/spark35:1.10.40.1|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy|
...
|Id|Component|Description|
|-----|-----|-----|
|1865317|MMLSpark:1.4.27|Updated the SynapseML distributed machine learning framework libraries shipped as part of Fabric VHD component.|
|1865301|Wildfire/spark35:1.10.40.1|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy|
|1848929|NotebookUtils:1.1.60.4|Implements comprehensive credential security enhancements for Azure Key Vault and Fabric connections, introducing both a new notebookutils.credentials.getSecretWithConnection API and secret|
|1833923|Wildfire/spark35:1.10.39, Delta/spark35:3.2.0.20251009.1|Introduces Spark 3.5 release with updates to Wildfire Spark, including new features and improvements.|
...
|Id|Component|Description|
|-----|-----|-----|
|1865305|FLTSparkExtensions:0.8.3|Removal of log statements from the create and refresh flow of the materialized lake view that may contain view text information. View Text is considered customer business data and should not be exposed within Microsoft systems.|


# Components
|Name|Version|Name|Version|
|-----|-----|-----|-----|
|Auditd|0.0.2|**NotebookUtils**|**1.1.60.3 ⬆️ 1.1.60.4**|
...
|**FLTSparkExtensions**|**0.8.2 ⬆️ 0.8.3**|SparkNativeParquetWriter|1.3.0-20250828.2|
...
|MlflowLibrary|2.11.3.1|**Wildfire**|**1.10.38.2 ⬆️ 1.10.40.1**|
|**MMLSpark**|**1.4.25 ⬆️ 1.4.27**|
...
|backports.shutil_get_terminal_size|1.0.0|**notebookutils**|**1.1.11.35.20250605.2 ⬆️ 1.1.11.35.20251021.12**|
...
|**flt-python**|**0.8.2 ⬆️ 0.8.3**|python-lmdb|1.4.1|
...
|jupyter-ui-poll|1.0.0|**synapseml-cognitive**|**1.0.14.dev1 ⬆️ 1.1.0**|
|jupyter_client|8.6.0|**synapseml-core**|**1.0.14.dev1 ⬆️ 1.1.0**|
|jupyter_console|6.6.3|**synapseml-deep-learning**|**1.0.14.dev1 ⬆️ 1.1.0**|
|jupyter_core|5.5.0|**synapseml-internal**|**1.0.14.0.dev1 ⬆️ 1.1.0.0.dev1**|
|jupyter_events|0.8.0|**synapseml-lightgbm**|**1.0.14.dev1 ⬆️ 1.1.0**|
|jupyter_server|2.10.0|synapseml-mlflow|1.0.31|
|jupyter_server_terminals|0.4.4|**synapseml-opencv**|**1.0.14.dev1 ⬆️ 1.1.0**|
|jupyterlab|4.0.11|synapseml-utils|1.1.6.post2|
|jupyterlab_pygments|0.1.2|**synapseml-vw**|**1.0.14.dev1 ⬆️ 1.1.0**|
...
|commons-lang|2.6|**notebook-utils**|**1.1.11-spark35-20250605.2 ⬆️ 1.1.11-spark35-20251021.12**|
...
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|**parquet-hadoop-ms**|**3.5.1.5.4.20251029.8 ⬆️ 3.5.5.5.4.20251103.2**|
|fastutil|7.0.2|parquet-jackson|1.13.1|
|flatbuffers-java|1.12.0|pickle|1.3|
|**flt-spark-sql-extensions**|**0.8.2 ⬆️ 0.8.3**|postgresql|2.2.9|
...
|**hadoop-aliyun**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|rocksdbjni|8.3.2|
|**hadoop-annotations**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|scala-collection-compat|2.12-2.7.0|
|**hadoop-aws**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|scala-compiler|2.12.18|
|**hadoop-azure**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure-datalake**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|scala-library|2.12.18|
|hadoop-azureml|1.0-fs|scala-parser-combinators|2.12-2.3.0|
|**hadoop-client-api**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|scala-reflect|2.12.18|
|**hadoop-client-runtime**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|scala-xml|2.12-2.1.0|
|**hadoop-cloud-storage**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|scalactic|2.12-3.2.14|
|**hadoop-openstack**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|scalatra|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-common|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20251029.8 ⬆️ 3.3.4.5.4.20251103.2**|scalatra-metrics|2.12-3.0.0-M1|
...
|hive-shims|0.23-2.3.9|**spark-avro**|**2.12-3.5.0 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|hive-shims-common|2.3.9|**spark-catalyst**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|hive-shims-scheduler|2.3.9|**spark-common-utils**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|hive-storage-api|2.8.1|**spark-core**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|hk2-api|2.6.1|**spark-enhancement**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|hk2-locator|2.6.1|spark-enhancementui|2.12-3.3.0|
|hk2-utils|2.6.1|**spark-eventstream-extensions**|**1.0.5**|
|httpclient|4.5.14|**spark-graphx**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|httpclient5|5.1.3|**spark-hadoop-cloud**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|httpcore|4.4.16|**spark-hive**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|httpmime|4.5.13|spark-jobinsight|2.12-1.0.0-spark3.5|
|httpmime|4.5.14|spark-kusto-synapse-connector|3.5_2.12-1.5.1|
|impulse-core_spark|3.5_2.12-1.1.0|**spark-kvstore**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|impulse-exception_java11|1_2.12-1.1.0|**spark-launcher**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
...
|isolation-forest|3.5.0_2.12-3.0.5|**spark-microsoft-tools**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|istack-commons-runtime|3.0.8|**spark-mllib**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|ivy|2.5.1|**spark-mllib-local**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jackson-annotations|2.15.2|spark-mssql-connector-fabric35|1.6.9|
|jackson-core|2.15.2|**spark-network-common**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jackson-core-asl|1.9.13|**spark-network-shuffle**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jackson-databind|2.15.2|**spark-onesecurity-client**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-common**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jackson-dataformat-xml|2.12.7|**spark-onesecurity-server**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jackson-datatype-jsr310|2.15.2|**spark-repl**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jackson-mapper-asl|1.9.13|**spark-sketch**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sql**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jackson-module-scala|2.12-2.15.2|**spark-sql-api**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jakarta.activation-api|1.2.2|**spark-sql-kafka**|**0_2.12-3.5.1.5.4.20251029.8 ⬆️ 0_2.12-3.5.5.5.4.20251103.2**|
|jakarta.annotation-api|1.3.5|**spark-streaming**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jakarta.inject|2.6.1|**spark-streaming-kafka**|**0_2.12-3.5.1.5.4.20251029.8 ⬆️ 0_2.12-3.5.5.5.4.20251103.2**|
|jakarta.servlet-api|4.0.3|**spark-streaming-kafka**|**0_2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jakarta.validation-api|2.0.2|**spark-tags**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|jakarta.ws.rs-api|2.1.6|**spark-token-provider-kafka**|**0_2.12-3.5.1.5.4.20251029.8 ⬆️ 0_2.12-3.5.5.5.4.20251103.2**|
|jakarta.xml.bind-api|2.3.2|**spark-unsafe**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
|janino|3.1.9|spark-xml|2.12-0.17.0|
|javassist|3.29.2-GA|**spark-yarn**|**2.12-3.5.1.5.4.20251029.8 ⬆️ 2.12-3.5.5.5.4.20251103.2**|
...
|jersey-hk2|2.40|**synapseml-cognitive**|**2.12-1.0.14-spark3.5 ⬆️ 2.12-1.1.0**|
|jersey-server|2.40|**synapseml-core**|**2.12-1.0.14-spark3.5 ⬆️ 2.12-1.1.0**|
|jettison|1.1|**synapseml-deep-learning**|**2.12-1.0.14-spark3.5 ⬆️ 2.12-1.1.0**|
|jetty-util|9.4.57.v20241219|**synapseml-internal**|**2.12-1.0.14.0-spark3.5 ⬆️ 2.12-1.1.0.0-spark3.5**|
|jetty-util-ajax|9.4.57.v20241219|**synapseml-lightgbm**|**2.12-1.0.14-spark3.5 ⬆️ 2.12-1.1.0**|
|jline|2.14.6|**synapseml-opencv**|**2.12-1.0.14-spark3.5 ⬆️ 2.12-1.1.0**|
|joda-time|2.12.5|**synapseml-vw**|**2.12-1.0.14-spark3.5 ⬆️ 2.12-1.1.0**|
|jodd-core|3.5.2|**synfs**|**1.1.11-spark35-20250605.2 ⬆️ 1.1.11-spark35-20251021.12**|
|jsch|0.1.54|threeten-extra|1.7.1|
|json|1.8|tink|1.9.0|
|json|3|transaction-api|1.1|
|json-simple|1.1.1|transform-token-provider-utils|0.0.0|
|json-simple|1.1|**trident-core**|**1.2.26 ⬆️ 1.2.28**|
...
|junit-jupiter|5.5.2|**zookeeper**|**3.6.3.5.4.20251029.8 ⬆️ 3.6.3.5.4.20251103.2**|
|junit-jupiter-api|5.5.2|**zookeeper-jute**|**3.6.3.5.4.20251029.8 ⬆️ 3.6.3.5.4.20251103.2**|
...
|V8|5.0.0|**notebookutils**|**1.1.11.35.20250605.2 ⬆️ 1.1.11.35.20251021.12**|
