...
*   **VHD Name**: 17c952775abcab.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-03-05.2-rc.1
...
|1577151|DSCopilot:1.0.0|Adds DsCopilot to the VHD for Spark 3.5, eliminating installation time for users when initiating Copilot.|
...
|1581900|Delta:3.2.0.15|Improved stats collection to be more performant and addition of OneLakeSecurity support for Row Level Security for Spark and Lakehouses|
...
|1580693|ServiceConfigurationTemplates:spark/3.5.0|Enables Sink Config to send executor metrics to Kusto in Spark 3.5, enhancing monitoring capabilities.|
|1582245|OneLakeSparkCatalog:0.2.1, TridentCore:1.2.19|Update Catalog and Trident-Core jars for upcoming public preview for OneLakeSecurity on Spark with Row Level and Column Level Security support. These changes only affect OneLakeSecurity enabled tables.|
|1589350|DSCopilot:1.1.0|Updated the DS Copilot to V2 features for Spark 3.5, improving code generation and schema indexing.|
|1590331|OneLakeSparkCatalog:0.1.21, TridentCore:1.2.16|Reverts original changes required for RLS/CLS. Will be created in a subsequent PR with other dependencies going together.|
|1593145|DSCopilot:1.2.0|Improved code generation in DSCopilot for Spark and Python runtimes, enhancing runtime detection and logging.|
...
|1573710|Wildfire/spark35:1.10.18|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy|
|1573831|FsspecWrapper:1.0.5|Updated FsspecWrapper in Spark 3.5 to support token provider, enhancing token refresh in long running sessions and resolving token expiration issues when using Pandas with Onelake.|
|1575769|Wildfire/spark35:1.10.19|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy|
|1579195|OneLakeClientSTarter:1.0.24.2|Added new OLC configurations in olcconfig*.json files to support OLC CPP SDK in Spark 3.5, enhancing the OneLakeClientStarter component.|
|1579290|ServiceConfigurationTemplates:spark35|Updated the flag in `cluster-info.json.liquid` for region-wise PrivateLink support to enable `UseWorkspaceDns` in Spark 3.5, reflecting changes in OLCStarter component based on TJS flag update.|
...
|**delta-storage**|**3.2.0.13 ⬆️ 3.2.0.15**|paranamer|2.8|
