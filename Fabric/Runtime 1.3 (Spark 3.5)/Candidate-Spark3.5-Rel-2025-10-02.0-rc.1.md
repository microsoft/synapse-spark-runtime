...
*   **VHD Name**: bf42172001a15b.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-10-02.0-rc.1
...
|-----|-----|-----|
|1821231|Wildfire/spark35:1.10.38|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy components.|
|1807483|Wildfire/spark35:1.10.37.1|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy components.|
|1812435|FLTSparkExtensions:0.8.1|Introduces PySpark support for creating and refreshing Multi-Level Views (MLVs) with improved incremental refresh stability and performance, enabling scalable data processing and addressing key bug fixes in the MLV lifecycle.|
|1803448|TridentCore:1.1.26, OnelakeSparkCatalog:0.2.17|Introduces Private Link support for OneLakeSparkCatalog, enabling enhanced workspace ID handling and private workspace compatibility. Adds helper APIs for OneLake path and URL management within Trident Core.|
...
|-----|-----|-----|
|1821231|Wildfire/spark35:1.10.38|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy components.|
|1803747|Esri:1.0.0|Introduces the GA version of Esri GeoAnalytics libraries into the VHD for enhanced functionality.|
|1805064|MMLSpark:1.4.25|Updates SynapseML to version 1.0.14, enhancing the distributed machine learning framework libraries included in Fabric VHD components.|
|1807483|Wildfire/spark35:1.10.37.1|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy components.|
|1812435|FLTSparkExtensions:0.8.1|Introduces PySpark support for creating and refreshing Multi-Level Views (MLVs) with improved incremental refresh stability and performance, enabling scalable data processing and addressing key bug fixes in the MLV lifecycle.|
|1794526|LibraryManager:1.0.21|Introduces a new approach for python library management, enhancing performance in Environment Publish (LPS) and Session Acquisition (LDS) with significant latency improvements and a user-configurable feature flag for fallback options.|
|1801386|Genesis:0.35.4|Introduces performance improvements for session acquisition in Spark notebooks when an environment is attached, reducing latency by optimizing library management. Also addresses a security vulnerability by updating the Jackson dependency.|
|1801515|Delta:3.2.0.20250912.3|Updates Delta to version 3.2.0.20250912.3, bringing performance and functionality improvements.|
...
|1815972|FabricDWConnector:1.0.21|Upgrades Fabric DW Connector to version 1.0.21, addressing expired SAS token issues and enabling support for workspace private links using warehouses API. Includes dependency updates to mitigate component vulnerabilities.|
|1803191|Wildfire/spark35:1.10.36.3|Releases Spark Hotfix 9W1, addressing multiple bug fixes, including improved ABFSS path parsing, enforced timeouts on IsSystemContextRequired API, and removal of azure-shuffle-blob to resolve log4j-related issues.|
...
|**genesis-client**|**2.12-0.34.0-jar-with-dependencies ⬆️ 2.12-0.35.4-jar-with-dependencies**|py4j|0.10.9.7|
...
|impulse-core_spark|3.5_2.12-1.1.0|**spark-launcher**|**2.12-3.5.1.5.4.20250914.1 ⬆️ 2.12-3.5.1.5.4.20251001.1**|
