...
*   **VHD Name**: fc766803d6b479.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-09-03.3-rc.1
*   **Operating System**: CBL-Mariner 2.0.20250729
*   **Apache Spark**: 3.5.1
*   **Java**: 11.0.27
*   **Scala**: 2.12.18
*   **Python**: 3.11/1.0.1
*   **Delta Lake**: 3.2.0.20250913.2

# New Features
|Id|Component|Description|
|-----|-----|-----|
|1736985|SparkClusterLogs:1.104|Adds functionality to publish Clam AV logs from `/var/log/clamav/fss/clam.log` to the FssNodeScannerEvent Kusto table, enabling enhanced log ingestion and fraud detection for partner teams.|
|1784366|OnelakeSparkCatalog:0.2.16|Introduces new features, improvements, and bug fixes for the Onelake Spark Catalog, including support for mixed-mode Spark SQL, Views, and enhanced performance for APIs. Fixes issues with metadata files in concurrent threads.|
|1778837|Delta:3.2.0.20250828.1, SparkNativeParquetWriter:1.3.0-20250828.2|Introduces Fast Optimize feature, enhances Auto Compact, Describe History, merge, and cross-table query scenarios with performance improvements and additional functionality.|
|1765169|FLTSparkExtensions:0.7.4|Adds support for creating pyspark-based Fabric Materialized Lake Views and includes minor bug fixes.|
|1768733|Wildfire/spark35:1.10.36|Introduces Spark 3.5 release with updates to wildfire-spark, wildfire-livy, and wildfire-hadoop components.|
|1771781|SStreamOnSparkJar:2.4.1|Introduces Structured Stream connector support for Spark 3.5, enabling structured stream reading in the latest version.|
|1766941|FLTSparkExtensions:0.7.1|Introduces support for Incremental Refresh in Fabric Materialized Lake Views, enhancing SPJ-query performance and including minor bug fixes.|
|1755892|SparkSqlConnector:1.6.9|Introduces the SparkSqlConnector for Spark 3.5, enabling enhanced integration with SQL Server databases.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|1793698|Delta:3.2.0.20250905.1|Delta 3.2.0.20250905.1 improves Driver Mode Snapshot and refines RLS logic, ensuring the enablement flag is set and propagated correctly in executors for consistent functionality.|
|1786697|SparkAdvisor:1.0.6|Updates Spark Advisor to handle Native Execution Engine fallback events, enhancing advice population for fallback scenarios.|
|1778837|Delta:3.2.0.20250828.1, SparkNativeParquetWriter:1.3.0-20250828.2|Introduces Fast Optimize feature, enhances Auto Compact, Describe History, merge, and cross-table query scenarios with performance improvements and additional functionality.|
|1783270|CSparkMetricsUpdate:1.0.12|Updates Spark Runtime Telemetry to enhance metrics, including changes to the CSparkGlutenPlanFallbackEvents table.|
|1768733|Wildfire/spark35:1.10.36|Introduces Spark 3.5 release with updates to wildfire-spark, wildfire-livy, and wildfire-hadoop components.|
|1764146|ServiceConfigurationTemplates:spark/3.5.0|Increases `spark.yarn.am.waitTime` to 200 seconds, ensuring sufficient time for Livy driver initialization and Spark context creation in Spark 3.5 clusters.|
...
|Id|Component|Description|
|-----|-----|-----|
|1802123|Delta:3.2.0.20250913.2Spark:1.10.36.2|Hot fix to fix and ensure RLS enablement flag is set and propagated correctly.|
|1788462|SparkDiagnosticsLibrary:1.0.31|Fixes a regression in diagnostic blob storage emitter initialization caused by a Spark runtime environment change.|
|1774083|DSCopilot:1.3.2|Fixes issues with DS Copilot lakehouse access and adds support for new LLMs, including gpt-4.1 and gpt-5.|
|1784366|OnelakeSparkCatalog:0.2.16|Introduces new features, improvements, and bug fixes for the Onelake Spark Catalog, including support for mixed-mode Spark SQL, Views, and enhanced performance for APIs. Fixes issues with metadata files in concurrent threads.|
|1778555|DSCopilot:1.3.1|Enables GPT-4.1 as the default model in regions where it is deployed within Fabric.|
|1773633|SparkJobInsight:1.0.1|Fixes a regression in JobInsight caused by a Spark runtime environment change, ensuring compatibility by packaging necessary dependencies to prevent runtime errors.|
|1739320|SparkRPCHistoryServer:1.8.0|Fixes a potential credential leak to telemetry in SparkRPCHistoryServer during JSON deserialization failures.|
|1756980|LibraryManager:1.0.19|Improves reliability in Fabric Environment Publish by addressing azcopy failures and enhances security by redacting sensitive tokens from user-facing environment logs in LibraryManager.|
|1757454|Delta:3.2.0.20250731.1|Delta 3.2.0.20250731.1 fixes an incompatibility issue between Delta and Spark native API|
...
|AutoscaleProbe|3.9.8|**OnelakeSparkCatalog**|**0.2.13 ⬆️ 0.2.16**|
|AzureMLExtensions|1.0.4|PostgreSQLJDBCDriver|1.0.3|
|**Conda**|**5.2.20 ⬆️ 5.2.21**|Python|3.11/1.0.1|
|**CSparkMetricUpdate**|**1.0.11 ⬆️ 1.0.12**|R|1.0.6|
|**Delta**|**3.2.0.20250905.3 ⬆️ 3.2.0.20250913.2**|**SparkAdvisor**|**1.0.5 ⬆️ 1.0.6**|
|**DSCopilot**|**1.3.1 ⬆️ 1.3.2**|**SparkDiagnosticsLibrary**|**1.0.30 ⬆️ 1.0.31**|
...
|**FLTSparkExtensions**|**0.5.2 ⬆️ 0.7.4**|**SparkNativeParquetWriter**|**1.3.0-20250624.2 ⬆️ 1.3.0-20250828.2**|
...
|**GlutenUI**|**1.3.0-20250724.2 ⬆️ 1.3.0-20250828.2**|**SStreamOnSparkJar**|**2.4.1**|
...
|MlflowLibrary|2.11.3.1|**Wildfire**|**1.10.35.1 ⬆️ 1.10.36.3**|
...
|jakarta.inject|2.6.1|**spark-tags**|**2.12-3.5.1.5.4.20250711.1 ⬆️ 2.12-3.5.1.5.4.20250914.1**|
