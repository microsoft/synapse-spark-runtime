...
*   **VHD Name**: cb675117b93c7c.vhd
*   **Vhd Release**: Spark3.5-earlyaccess-2026-06-23.0-rc.1
*   **Operating System**: Azure Linux 3.0
*   **Apache Spark**: 3.5.5
*   **Java**: 11.0.31
*   **Scala**: 2.12.18
*   **Python**: 3.11/1.0.2
*   **Delta Lake**: 3.2.1.20260609.1

# New Features
|Id|Component|Description|
|-----|-----|-----|
|2152032|KustoConnector:2.1.0|Adds support for OneLake transient storage in the Kusto Spark connector, enabling staging data during distributed reads and ingestion using OneLake URLs and impersonation-based authentication. Eliminates the need for Azure Blob Storage with SAS tokens.|
|2140973|Wildfire/spark35:1.10.57|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy, enhancing features and performance.|
|2143152|FLTSparkExtensions:1.5.0|Introduces FLTSparkExtensions version 1.5.0, including the new FileIngestion feature and various bug fixes.|
|2119895|NotebookUtils:1.1.67|Updates NotebookUtils to 1.1.15 and blobfuse to v2.1.21 for Spark 3.5, delivering customer-facing fixes and improvements for runtime behavior, sovereign cloud OneLake mounts, Plotly rendering, UDF metadata, mount reliability, and Redis connection handling.|
|2078093|Wildfire/spark35:1.10.55.1, Delta:3.2.1.20260414.1|Release of Wildfire Spark 5.4, Gluten/GlutenUI 1.3, and Delta 3.2.1, featuring RLS/CLS fixes, Mariner 3.0 support, improved shuffle handling for reused exchanges, and other enhancements across Spark, Hadoop, Livy, and Velox components.|
|2096117|Delta:3.2.1.20260428.3, OnelakeSparkCatalog:0.4.14|Introduces support for external table shortcuts with Fabric connection options and resolves issues with Delta log validation filtering Fabric-specific properties during shortcut creation. Includes updates to LakeMetaStore and OnelakeSparkCatalog in Spark 3.5.|
|2004633|EventStreamsFabricExtension:1.0.0.1|Introduces a CrossWorkspace feature for EventStreamAdapter, enabling notebooks in one workspace to interact with EventStreamAdapters in another. Updates dependencies to support this functionality.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|2145774|Delta:3.2.1.20260609.1|Updates Delta to version 3.2.1.20260609.1 and incorporates the latest NEE (Gluten/GlutenUI) hotfix for Spark 3.5, improving functionality and stability.|
|2155729|FabricDWConnector:1.0.25|Updates Fabric DW Connector to enhance reliability by adding retries for throttling errors during TDS SQL Endpoint discovery.|
|2140973|Wildfire/spark35:1.10.57|Introduces Spark 3.5 release with updates to wildfire-spark and wildfire-livy, enhancing features and performance.|
|2147170|LibraryManager:1.0.29, Genesis:0.38.0|Enhances experience when users override libraries already present in the built-in python environment. Existing versions are now safely removed before installing the updated version, preventing stale files from persisting on the same paths. This behavior is controlled via a feature flight.|
|2152196|Impulse:1.5.223168344|Upgrades the Impulse library for Spark 3.5 to version 1.5.223168344, updating dependency configurations and ensuring consistency in runtime artifacts for Spark 3.5 VHD builds.|
|2103619|Esri:1.0.1|Updates Esri's geoanalytics library to version 1.0.1, introducing new functionality.|
|2105847|SparkDiagnosticLibrary:1.0.34|Fixes observability bus memory retention issues and improves authentication token refresh handling in the Spark Diagnostic Library. Adds support for configurable authority URLs for sovereign cloud environments.|
|2115963|KustoConnector:2.0.5|Updated Kusto connector with latest spark connector v7.0.6. The latest connector brings the latest Az-Identity to support acquiring the native auth token for sovereign clouds as Bleu and delos.|
|2118217|Conda/spark35:5.2.26|Upgrades Conda environment to version 20260525.1.0 for Spark 3.5 runtime, incorporating FLAML 2.5.0.post4.|
|2119895|NotebookUtils:1.1.67|Updates NotebookUtils to 1.1.15 and blobfuse to v2.1.21 for Spark 3.5, delivering customer-facing fixes and improvements for runtime behavior, sovereign cloud OneLake mounts, Plotly rendering, UDF metadata, mount reliability, and Redis connection handling.|
|2131087|Impulse:1.5.221307261|This PR updates Impulse version to `1.5.221307261` for the Spark 3.5 BBC-VHD component.|
|2141612|TridentTokenLibrary:1.13.1|TridentTokenLibrary Improvements|
|2032228|VhdCtl:5.20.0|Optimizes VHD creation time and improves build performance by upgrading VhdCtl version in Spark 3.x clusters.|
|2043566|Impulse:1.5.214702911|Updates Impulse library to version 1.5.214702911 for Spark 3.5 components, addressing JVM crashes and adding support for the new telemetry module, Pulse.|
|2057938|MMLSpark:1.4.30|Updates SynapseML to version 1.1.3, enhancing the distributed machine learning framework libraries included in the Fabric VHD component.|
|2058752|LibraryManager:1.0.27|Introduces support for Fabric Workspace Identity authentication for Azure Artifact Feed in Spark 3.5, enabling token-based access alongside PAT authentication. Includes improvements in token handling, URL encoding, and credential classification.|
|2072054|Delta:3.2.1.20260424.4|Updates Delta to version 3.2.1.20260424.4, bringing various improvements over the previous release.|
|2072595|UpgradeToFabric:1.2.15|Updates the UpgradeToFabric component to version 1.2.15 for Spark 3.5, improving functionality and ensuring compatibility with the latest FabricUpgrade library enhancements.|
|2076049|FLTSparkExtensions:1.3.0|Enhances FMLV aggregate functionality and scenario coverage with updates to FLTSparkExtensions.|
|2076486|SparkRPCHistoryServer:1.11.0|Improves SparkRPCHistoryServer resource usage profiler to support infinite tasks, resolving limitations that previously affected applications running over 100k tasks in Spark 3.x.|
|2077209|SparkSqlConnector:1.8.1, FabricDWConnector:1.0.24|Updates Spark SQL and DW connectors to address security concerns, enhance datatype mapping, fix bulk copy errors, and allow custom queries for reads. Includes improved compatibility and precision handling for SQL types.|
|2077424|ServiceConfigurationTemplates:spark/3.5.0|Disables OLC SDK by default in Spark 3.5 Mariner 3.0 VHD to flight the feature.|
|2078093|Wildfire/spark35:1.10.55.1, Delta:3.2.1.20260414.1|Release of Wildfire Spark 5.4, Gluten/GlutenUI 1.3, and Delta 3.2.1, featuring RLS/CLS fixes, Mariner 3.0 support, improved shuffle handling for reused exchanges, and other enhancements across Spark, Hadoop, Livy, and Velox components.|
|2079030|OneLakeClientStarter:1.0.28.0|Upgrades OLC Out-of-proc to v317 for GCC support and Mariner 3.0 compatibility in Spark 3.5 VHD. Includes bug fixes and security improvements.|
|2081520|EventStreamsFabricExtension:1.0.0.2|Reverts Kafka version to 3.4.1 for compatibility with Spark 3.5 and EventStreamAdapter APIs.|
|2091107|NotebookUtils:1.1.66|Adds support for GCC sovereign cloud OneLake endpoints in NotebookUtils, enabling proper URL validation and mount operations for various sovereign cloud domain suffixes.|
|2091345|MMLSpark:1.4.31|Updates the SynapseML-Internal distributed machine learning framework library within the Fabric VHD component.|
|2092676|Conda:5.2.25|Update the Spark 3.5 VHD Conda runtime to consume the official Synapse-Conda package that includes semantic-link-sempy 0.11.2.|
|2031569|Delta:3.2.1.20260331.1|Updates Delta to version 3.2.1.20260331.1, introducing improvements over the previous release.|
|2034014|FLTSparkExtensions:1.1.1|Releases FLT-SparkExtensions version 1.1.1 with improvements for Spark 3.x.|
|2037267|SparkSqlConnector:1.7.1|Improves performance of SparkSqlConnector by increasing default batchSize to 100,000, reducing write times by ~32% when handling large datasets.|
|2037802|Impulse:1.5.209142029, SparkDiagnosticsLibrary:1.0.33, SparkLighter:2.0.5, SparklyrConnector:2.0.2, SparkNativeParquetWriter:3.5.0-20260403.14, Wildfire:1.10.54.1|Migrates Spark 3.5 VHD from Mariner 2.0 to Azure Linux 3.0, updating component setup scripts and dependencies for compatibility with the new OS image.|
...
|-----|-----|-----|
|2143152|FLTSparkExtensions:1.5.0|Introduces FLTSparkExtensions version 1.5.0, including the new FileIngestion feature and various bug fixes.|
|2143271|AutoscaleProbe:3.9.11|Releases Autoscale Probe 3.9.11 for Spark 3.x, addressing node management issues and improving reliability in scenarios with NodeManager restarts.|
|2105847|SparkDiagnosticLibrary:1.0.34|Fixes observability bus memory retention issues and improves authentication token refresh handling in the Spark Diagnostic Library. Adds support for configurable authority URLs for sovereign cloud environments.|
|2119282|FLTSparkExtensions:1.4.3|Updates FLT-SparkExtensions version and includes various bug fixes and improvements for Spark 3.x, such as better observability, support for new expressions, schema mismatch fixes, and enhancements for incremental refresh and data validation.|
|2119895|NotebookUtils:1.1.67|Updates NotebookUtils to 1.1.15 and blobfuse to v2.1.21 for Spark 3.5, delivering customer-facing fixes and improvements for runtime behavior, sovereign cloud OneLake mounts, Plotly rendering, UDF metadata, mount reliability, and Redis connection handling.|
|2125023|KustoConnector:2.0.6|Fixes a runtime failure in the Kusto Spark Connector on Microsoft Fabric caused by missing shaded commons-io classes, restoring proper functionality for data ingestion using Write Stream mode.|
|2141295|Conda:5.2.26.1|Fixes inconsistent Python package versions on Spark 3.5 (Azure Linux 3) by reconciling stale Conda metadata, ensuring consistent version resolution for packages like azure-core.|
|2086007|CSparkMetricUpdate:1.0.19, Impulse:1.5.214702911.1|Restores reliable Spark Application Master logging by reverting fluent-logger delivery changes while retaining the Impulse library update. Ensures Spark application diagnostics are effectively captured and routed through the telemetry pipeline.|
|2090632|SparkJobInsight:1.0.2|Fixes a `NumberFormatException` in SparkJobInsight by handling non-numeric executor IDs in `RawEvent.executorIdToLong`, improving compatibility with Spark 3.x event logs containing FallbackStorage's virtual BlockManager.|
|2013622|SparkRPCHistoryServer:1.9.1|Updates SparkRPCHistoryServer to run as trusted-service-user instead of root, addressing a security issue that could lead to potential system damage.|


# Components
|Name|Version|Name|Version|
|-----|-----|-----|-----|
|**AutoscaleProbe**|**3.9.9 ⬆️ 3.9.11**|OneLakeClientStarter|1.0.28.1|
|AzureMLExtensions|1.0.5|**OnelakeSparkCatalog**|**0.4.9 ⬆️ 0.4.14**|
|**Conda**|**5.2.25 ⬆️ 5.2.26.1**|PostgreSQLJDBCDriver|1.0.3|
|**CSparkMetricUpdate**|**1.0.17 ⬆️ 1.0.19**|Python|3.11/1.0.2|
|**Delta**|**3.2.1.20260427.3 ⬆️ 3.2.1.20260609.1**|R|1.0.7|
|DSCopilot|1.3.2|SparkAdvisor|1.0.7|
|DSCopilotInstaller|1.0.0|**SparkDiagnosticsLibrary**|**1.0.32 ⬆️ 1.0.34**|
|Esri|1.0.1|SparkJobInsight|1.0.2|
|EventHubConnector|2.3.27|**SparkLighter**|**2.0.4 ⬆️ 2.0.5**|
|**EventStreamsFabricExtension**|**1.0.0 ⬆️ 1.0.0.2**|SparkLineage|0.0.4|
|**FabricDWConnector**|**1.0.23 ⬆️ 1.0.25**|**SparklyrConnector**|**2.0.1 ⬆️ 2.0.2**|
|**FLTSparkExtensions**|**1.4.3 ⬆️ 1.5.0**|**SparkNativeParquetWriter**|**1.3.0-20250828.2 ⬆️ 3.5.0-20260403.14**|
|FLTSparkUtils|0.3.0|SparkRPCHistoryServer|1.11.0|
|FsspecWrapper|1.0.7|**SparkSqlConnector**|**1.6.10 ⬆️ 1.8.1**|
|**Genesis**|**0.37.0 ⬆️ 0.38.0**|**SQLServerODBCDriver**|**18.1.0 ⬆️ 18.1.1**|
|**GlutenUI**|**1.3.0-20260317.7 ⬆️ 1.3.0-20260601.1**|SStreamOnSparkJar|2.4.1|
|HiveMetaStoreClient|1.1.28|TokenLibrary|4.3.9|
|**Impulse**|**1.5.214702911 ⬆️ 1.5.223168344.1**|TridentCore|1.3.4|
|**KustoConnector**|**2.0.6 ⬆️ 2.1.0**|**TridentTokenLibrary**|**1.12.0 ⬆️ 1.13.1**|
|**LibraryManager**|**1.0.26 ⬆️ 1.0.29**|**UpgradeToFabric**|**1.2.11 ⬆️ 1.2.15**|
|LibraryMetadataCooker|2.0.5|Vegas|3.5.10|
|MlflowLibrary|2.11.3.1|VPaaSClient|3.5.03|
|MMLSpark|1.4.31|**Wildfire**|**1.10.53.1 ⬆️ 1.10.57.1**|
|MySQLJavaConnector|1.0.3|
|**NotebookUtils**|**1.1.66 ⬆️ 1.1.67**|
...
|libuv|1.44.2|**flaml**|**2.5.0.post1 ⬆️ 2.5.0.post4**|
|libwebp|1.3.2|**flt-python**|**1.4.3 ⬆️ 1.5.0**|
|libwebp-base|1.3.2|fluent-logger|0.10.0|
|libxcb|1.15|fsspec|2024.6.1|
|libxgboost|2.0.3|geoanalytics-fabric|1.0.1|
|libxkbcommon|1.0.1|gson|0.0.4|
|libxml2|2.10.4|hcrystalball|0.1.10|
|libxslt|1.1.37|**impulse-python-handler**|**1.5.214702911 ⬆️ 1.5.223168344**|
...
|lzo|2.10|mypy|1.4.1|
|make|4.2.1|nni|3.0|
|markdown|3.4.1|**notebookutils**|**1.1.14.35.20260507.11 ⬆️ 1.1.15.35.20260524.4**|
...
|mpfr|4.0.2|semantic-link-sempy|0.11.2|
|mpi|1.0|seqeval|1.2.2|
|mpich|4.1.1|simplejson|3.19.3|
|mpmath|1.3.0|**spark-mssql-connector-fabric35**|**1.0.0 ⬆️ 1.1.0**|
|msal|2023.12.01|sqlanalyticsfabricconnectorpy|1.0.1|
|msal-extensions|2023.12.01|synapseml|1.1.3|
|msgpack-python|1.0.3|synapseml-internal|1.1.3.1|
...
|SparkCustomEvents|3.5.0-1.0.17|kryo-shaded|4.0.2|
|TokenLibrary-assembly|4.3.8|**kusto-spark**|**3.0_2.12-7.0.7-SNAPSHOT ⬆️ 3.0_2.12-7.1.1**|
|VPaaSConnector|3.5.01|lapack|3.0.3|
|VegasConnector|3.5.10|leveldbjni-all|1.8|
|activation|1.1.1|libfb303|0.9.3|
|aircompressor|2.0.3|libthrift|0.12.0|
...
|audience-annotations|0.5.0|microsoft-catalog-metastore-client|1.1.28|
...
|azure-core|1.47.0|netty-all|4.1.124.Final|
|azure-core-http-netty|1.14.1|netty-buffer|4.1.124.Final|
...
|azure-json|1.1.0|netty-codec-http2|4.1.124.Final|
...
|commons-codec|1.16.1|netty-transport|4.1.124.Final|
|commons-collections|3.2.2|netty-transport-classes-epoll|4.1.124.Final|
|commons-collections4|4.4|netty-transport-classes-kqueue|4.1.124.Final|
|commons-compiler|3.1.9|netty-transport-native-epoll|4.1.124.Final-linux-aarch_64|
|commons-compress|1.23.0|netty-transport-native-epoll|4.1.124.Final-linux-riscv64|
|commons-crypto|1.1.0|netty-transport-native-epoll|4.1.124.Final-linux-x86_64|
|commons-dbcp|1.4|netty-transport-native-kqueue|4.1.124.Final-osx-aarch_64|
|commons-io|2.11.0|netty-transport-native-kqueue|4.1.124.Final-osx-x86_64|
|commons-io|2.18.0|netty-transport-native-unix-common|4.1.124.Final|
|commons-lang|2.6|nimbus-jose-jwt|9.37.2|
|commons-lang3|3.12.0|**notebook-utils**|**1.1.14-spark35-20260507.11 ⬆️ 1.1.15-spark35-20260524.4**|
...
|deequ|3.0.3-spark-3.5|osgi-resource-locator|1.0.3|
|**delta-kernel-api**|**3.2.1.20260427.3 ⬆️ 3.2.1.20260609.1**|paranamer|2.8|
|**delta-kernel-defaults**|**3.2.1.20260427.3 ⬆️ 3.2.1.20260609.1**|parquet-column|1.13.1|
|**delta-spark**|**2.12-3.2.1.20260427.3 ⬆️ 2.12-3.2.1.20260609.1**|parquet-common|1.13.1|
|**delta-storage**|**3.2.1.20260427.3 ⬆️ 3.2.1.20260609.1**|parquet-encoding|1.13.1|
|derby|10.14.2.0|parquet-format-structures|1.13.1|
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|**parquet-hadoop-ms**|**3.5.5.5.4.20260403.6 ⬆️ 3.5.5.5.4.20260608.1**|
|fastutil|7.0.2|parquet-jackson|1.13.1|
|flatbuffers-java|1.12.0|pickle|1.3|
|**flt-spark-sql-extensions**|**1.4.3 ⬆️ 1.5.0**|postgresql|42.2.9|
|fluent-logger|0.3.4-jar-with-dependencies-provided|profiler|1.1.1|
|**fmlv-utils**|**1.4.3 ⬆️ 1.5.0**|proton-j|0.33.8|
|gcs-connector-hadoop3|2.2.14-shaded|py4j|0.10.9.7|
|**genesis-client**|**2.12-0.37.0-jar-with-dependencies ⬆️ 2.12-0.38.0-jar-with-dependencies**|qpid-proton-j-extensions|1.2.4|
|geoanalytics-fabric|2.12-1.0.1-msfabric-1.3|reactive-streams|1.0.3|
|**gluten-velox-bundle-spark**|**2.12-mariner_2.0_x86_64-1.3.0-20260317.7 ⬆️ 2.12-azurelinux_3.0_x86_64-1.3.0-20260601.1**|reactor-core|3.4.34|
|gson|2.8.9|reactor-netty-core|1.0.40|
|guava|14.0.1|reactor-netty-http|1.0.40|
|h3|4.1.1|rocksdbjni|8.3.2|
|**hadoop-aliyun**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|scala-collection-compat|2.12-2.7.0|
|**hadoop-annotations**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|scala-compiler|2.12.18|
|**hadoop-aws**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|scala-library|2.12.18|
|**hadoop-azure-datalake**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|scala-parser-combinators|2.12-2.3.0|
|hadoop-azureml|1.0-fs|scala-reflect|2.12.18|
|**hadoop-client-api**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|scala-xml|2.12-2.1.0|
|**hadoop-client-runtime**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|scalactic|2.12-3.2.14|
|**hadoop-cloud-storage**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|scalatra|2.12-3.0.0-M1|
|**hadoop-openstack**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|scalatra-common|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-metrics|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20260403.6 ⬆️ 3.3.4.5.4.20260608.1**|shims|0.9.45|
|hdinsight-spark-metrics|3.5.0-1.0.17|slf4j-api|2.0.7|
|hive-common|2.3.9|snappy-java|1.1.10.5|
|hive-exec|2.3.9-core|spark|3.5-advisor-core_2.12-1.0.18|
|hive-llap-common|2.3.9|spark|3.5-diagnosis-utils-cluster-info-property-provider_2.12-1.0.0|
|hive-metastore|2.3.9|spark|3.5-diagnosis-utils-cluster-info-property_2.12-1.0.0|
...
|hive-shims|2.3.9|**spark-arsenal**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|hive-shims-common|2.3.9|spark-avro|2.12-3.5.0|
|hive-shims-scheduler|2.3.9|**spark-avro**|**2.12-3.5.0 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|hive-storage-api|2.8.1|**spark-catalyst**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|hk2-api|2.6.1|**spark-common-utils**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|hk2-locator|2.6.1|**spark-core**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|hk2-utils|2.6.1|**spark-enhancement**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|httpclient|4.5.14|spark-enhancementui|2.12-3.3.0|
|httpclient5|5.1.3|**spark-eventstream-extensions**|**1.0.5 ⬆️ 1.0.9**|
|httpcore|4.4.16|spark-excel-thin|2.12-3.5.6_0.31.2|
|httpmime|4.5.13|**spark-graphx**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|httpmime|4.5.14|**spark-hadoop-cloud**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|**impulse-core_spark**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.223168344**|**spark-hive**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|**impulse-exception_java11**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.223168344**|spark-jobinsight|2.12-1.0.0-spark3.5|
|**impulse-telemetry-common**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.223168344**|**spark-kusto-synapse-connector**|**3.5_2.12-2.0.6 ⬆️ 3.5_2.12-2.1.0**|
|**impulse-telemetry-mds_spark**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.223168344**|**spark-kvstore**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|**impulse-telemetry-pulse_spark**|**2.12-1.5.214702911 ⬆️ 2.12-1.5.223168344**|**spark-launcher**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
...
|istack-commons-runtime|3.0.8|**spark-microsoft-tools**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|ivy|2.5.1|**spark-mllib**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jackson-annotations|2.15.2|**spark-mllib-local**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jackson-core|2.15.2|**spark-mssql-connector-fabric35**|**1.6.10 ⬆️ 1.8.1**|
|jackson-core-asl|1.9.13|**spark-network-common**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jackson-databind|2.15.2|**spark-network-shuffle**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-client**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jackson-dataformat-xml|2.12.7|**spark-onesecurity-common**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jackson-datatype-jsr310|2.15.2|**spark-onesecurity-server**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jackson-mapper-asl|1.9.13|**spark-repl**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sketch**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jackson-module-scala|2.12-2.15.2|**spark-sql**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jakarta.activation-api|1.2.2|**spark-sql-api**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jakarta.annotation-api|1.3.5|**spark-sql-kafka**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jakarta.inject|2.6.1|**spark-streaming**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jakarta.servlet-api|4.0.3|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jakarta.validation-api|2.0.2|**spark-tags**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jakarta.ws.rs-api|2.1.6|**spark-token-provider-kafka**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|jakarta.xml.bind-api|2.3.2|**spark-unsafe**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|janino|3.1.9|spark-xml|2.12-0.17.0|
|javassist|3.29.2-GA|**spark-yarn**|**2.12-3.5.5.5.4.20260403.6 ⬆️ 2.12-3.5.5.5.4.20260608.1**|
|javatuples|1.2|**spark_diagnostic_cli**|**2.2.0_spark-3.5.1_20260223.3-shaded ⬆️ 2.3.0_spark-3.5.1_20260518.3-shaded**|
|javax.jdo|3.2.0-m3|sparklyr-connector|3.5.1-1.0.0267535|
|javolution|5.5.1|**sparknativeparquetwriter-azl3**|**2.12-3.5.0-20260403.14**|
...
|jersey-hk2|2.40|synapseml-cognitive|2.12-1.1.3|
|jersey-server|2.40|synapseml-core|2.12-1.1.3|
|jettison|1.1|synapseml-deep-learning|2.12-1.1.3|
|jetty-util|9.4.57.v20241219|synapseml-internal|2.12-1.1.3.1|
|jetty-util-ajax|9.4.57.v20241219|synapseml-lightgbm|2.12-1.1.3|
|jline|2.14.6|synapseml-opencv|2.12-1.1.3|
|joda-time|2.12.5|synapseml-vw|2.12-1.1.3|
|jodd-core|3.5.2|**synfs**|**1.1.14-spark35-20260507.11 ⬆️ 1.1.15-spark35-20260524.4**|
|jsch|0.1.54|threeten-extra|1.7.1|
|json|1.8|tink|1.9.0|
|json|20231013|transaction-api|1.1|
|json-simple|1.1.1|transform-token-provider-utils|0.3.0|
|json-simple|1.1|trident-core|1.3.4|
|json4s-ast|2.12-3.7.0-M11|**tridenttokenlibrary-assembly**|**1.12.0 ⬆️ 1.13.1**|
...
|junit-jupiter|5.5.2|**zookeeper**|**3.6.3.5.4.20260403.6 ⬆️ 3.6.3.5.4.20260608.1**|
|junit-jupiter-api|5.5.2|**zookeeper-jute**|**3.6.3.5.4.20260403.6 ⬆️ 3.6.3.5.4.20260608.1**|
...
|V8|5.0.0|**notebookutils**|**1.1.14.35.20260507.11 ⬆️ 1.1.15.35.20260524.4**|
