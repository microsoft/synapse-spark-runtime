...
*   **VHD Name**: bae96584164681.vhd
*   **Vhd Release**: Spark3.5-Rel-2026-01-28.0-rc.1
...
|1933829|Wildfire/spark35:1.10.46|Introduces new Spark 3.5 release with updates and improvements to wildfire-spark.|
|1935945|OnelakeSparkCatalog:0.4.2, TridentCore:1.2.31|Introduces cross workspace-artifact access using Onelake Resolution API for Spark 3.5, with shared artifact support enabled behind a feature flag.|
...
|-----|-----|-----|
|1934945|FLTSparkExtensions:0.14.0|Updates FLT-SparkExtensions to version 0.14.0, including improvements for IR, enhancements for PySpark MLVs, and bug fixes.|
|1931625|SparkRPCHistoryServer:1.8.1|Fixes JSON deserialization failure in SparkRPCHistoryServer when reading KV store, addressing issues caused by super-long events in Spark 3.5.|
|1933121|TridentTokenLibrary:1.10.4|Update TTL version to fix get storage token issue during session start|
...
|AzureMLExtensions|1.0.4|**OnelakeSparkCatalog**|**0.3.1 ⬆️ 0.4.2**|
|Conda|5.2.21|PostgreSQLJDBCDriver|1.0.3|
|CSparkMetricUpdate|1.0.16|Python|3.11/1.0.1|
|Delta|3.2.1.20251125.5|R|1.0.7|
...
|**FLTSparkExtensions**|**0.12.2 ⬆️ 0.14.0**|SparkNativeParquetWriter|1.3.0-20250828.2|
|FLTSparkUtils|0.3.0|**SparkRPCHistoryServer**|**1.8.0 ⬆️ 1.8.1**|
|FsspecWrapper|1.0.6|SparkSqlConnector|1.6.9|
|**Genesis**|**0.35.4 ⬆️ 0.36.1**|SQLServerODBCDriver|18.1.0|
|**GlutenUI**|**1.3.0-20251211.3 ⬆️ 1.3.0-20260122.1**|SStreamOnSparkJar|2.4.1|
|**HiveMetaStoreClient**|**1.1.21.2 ⬆️ 1.1.21.3**|TokenLibrary|4.3.8|
|Impulse|1.3.198470504|**TridentCore**|**1.2.30 ⬆️ 1.2.31**|
|KustoConnector|1.5.1|TridentTokenLibrary|1.10.4|
|LibraryManager|1.0.25|Vegas|3.5.10|
|LibraryMetadataCooker|2.0.4|VPaaSClient|3.5.03|
|MlflowLibrary|2.11.3.1|**Wildfire**|**1.10.45.1 ⬆️ 1.10.46.1**|
|MMLSpark|1.4.27|
...
|**flt-python**|**0.12.2 ⬆️ 0.14.0**|python-lmdb|1.4.1|
...
|library-metadata-cooker|3.6.0.1|whichcraft|0.6.1|
