...
*   **VHD Name**: 338663908db6ee.vhd
*   **Vhd Release**: Spark3.5-earlyaccess-2026-09-24.0.rc.1.0-rc
...
|-----|-----|-----|
|2314894|Wildfire/spark35:1.10.60|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy|
...
|-----|-----|-----|
|2314894|Wildfire/spark35:1.10.60|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy|
|2306810|KustoConnector:2.1.2|Updates the Kusto Spark connector to 2.1.2 (OSS 7.1.3). Distributed reads discover transient export storage through the Kusto DM export storage API instead of `.show export containers`, so reads succeed when storage is restricted to Private Link. Existing workloads are unaffected: the connector falls back to the old path when the API is unavailable, and writes are unchanged.|
|2286044|FLTSparkExtensions:1.10.0|Updates FLT-SparkExtensions to 1.10.0 for Spark 3.5 Mariner2: hint-less delete support and LEFT OUTER JOIN (both-side changes) for incremental refresh of Materialized Lake Views (MLV), several SAM aggregate merge-correctness fixes, richer refresh/CDC telemetry, and reliability hardening for CREATE OR REPLACE.|
|2295359|- OneLakeClientStarter:1.0.30.0|Upgrade OLC out-of-proc|


# Bug Fixes
|Id|Component|Description|
|-----|-----|-----|
|2318309|Conda:5.2.27.1|Revert the stale conda record deletion which impacted azure-common library, as the original fix is not required for Azure Linux 2.0|
|2305924|AutoscaleProbe:3.9.13|This release contains the latest autoscale probe build 20260916.3.0 for Spark 3.5 (Mariner 2).|
|2317968|EventStreamsFabricExtension:1.0.0.5|Reverts the Spark 3.5 EventStreams Fabric Extension to version 1.0.5 to restore reliable authentication in multi-cluster production regions.|


# Components
|Name|Version|Name|Version|
|-----|-----|-----|-----|
|Auditd|0.0.2|NotebookUtils|1.1.68|
|**AutoscaleProbe**|**3.9.12 ⬆️ 3.9.13**|**OneLakeClientStarter**|**1.0.28.1 ⬆️ 1.0.30.0**|
|AzureMLExtensions|1.0.5|OnelakeSparkCatalog|0.4.17|
|**Conda**|**5.2.27 ⬆️ 5.2.27.1**|PostgreSQLJDBCDriver|1.0.3|
|CSparkMetricUpdate|1.0.17|Python|3.11/1.0.2|
|Delta|3.2.1.20260609.1|R|1.0.7|
|DSCopilot|1.3.2|SparkAdvisor|1.0.7|
|DSCopilotInstaller|1.0.0|SparkDiagnosticsLibrary|1.0.32|
|Esri|1.0.1|SparkJobInsight|1.0.2|
|EventHubConnector|2.3.27|SparkLighter|2.0.4|
|**EventStreamsFabricExtension**|**1.0.0.4 ⬆️ 1.0.0.5**|SparkLineage|0.0.4|
|FabricDWConnector|1.0.23|SparklyrConnector|2.0.1|
|**FLTSparkExtensions**|**1.9.3 ⬆️ 1.10.0**|SparkNativeParquetWriter|1.3.0-20250828.2|
|FLTSparkUtils|0.3.0|SparkRPCHistoryServer|1.11.0|
|FsspecWrapper|1.0.7|SparkSqlConnector|1.6.10|
|Genesis|0.39.0|SQLServerODBCDriver|18.1.0|
|**GlutenUI**|**1.3.0-20260811.2 ⬆️ 1.3.0-20260907.7**|SStreamOnSparkJar|2.4.1|
|HiveMetaStoreClient|1.1.28|TokenLibrary|4.3.9|
|Impulse|1.5.230534541|TridentCore|1.4.5|
|**KustoConnector**|**2.0.6 ⬆️ 2.1.2**|TridentTokenLibrary|1.12.0|
|LibraryManager|1.0.32|UpgradeToFabric|1.2.11|
...
|libwebp|1.3.2|**flt-python**|**1.9.3 ⬆️ 1.10.0**|
...
|libxslt|1.1.37|impulse-python-handler|1.5.230534541|
...
|TokenLibrary-assembly|4.3.8|**kusto-spark**|**3.0_2.12-7.0.7-SNAPSHOT ⬆️ 3.0_2.12-7.1.3**|
...
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|**parquet-hadoop-ms**|**3.5.5.5.4.20260807.1 ⬆️ 3.5.5.5.4.20260921.11**|
|fastutil|7.0.2|parquet-jackson|1.13.1|
|flatbuffers-java|1.12.0|pickle|1.3|
|**flt-spark-sql-extensions**|**1.9.3 ⬆️ 1.10.0**|postgresql|42.2.9|
|fluent-logger|0.3.4-jar-with-dependencies-provided|profiler|1.1.1|
|**fmlv-utils**|**1.9.3 ⬆️ 1.10.0**|proton-j|0.33.8|
...
|**gluten-velox-bundle-spark**|**2.12-mariner_2.0_x86_64-1.3.0-20260811.2 ⬆️ 2.12-mariner_2.0_x86_64-1.3.0-20260907.7**|reactor-core|3.4.34|
|gson|2.8.9|reactor-netty-core|1.0.40|
|guava|14.0.1|reactor-netty-http|1.0.40|
|h3|4.1.1|rocksdbjni|8.3.2|
|**hadoop-aliyun**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|scala-collection-compat|2.12-2.7.0|
|**hadoop-annotations**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|scala-compiler|2.12.18|
|**hadoop-aws**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|scala-library|2.12.18|
|**hadoop-azure-datalake**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|scala-parser-combinators|2.12-2.3.0|
|hadoop-azureml|1.0-fs|scala-reflect|2.12.18|
|**hadoop-client-api**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|scala-xml|2.12-2.1.0|
|**hadoop-client-runtime**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|scalactic|2.12-3.2.14|
|**hadoop-cloud-storage**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|scalatra|2.12-3.0.0-M1|
|**hadoop-openstack**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|scalatra-common|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-metrics|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20260807.1 ⬆️ 3.3.4.5.4.20260921.11**|shims|0.9.45|
...
|hive-shims|2.3.9|**spark-arsenal**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|hive-shims-common|2.3.9|spark-avro|2.12-3.5.0|
|hive-shims-scheduler|2.3.9|**spark-avro**|**2.12-3.5.0 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|hive-storage-api|2.8.1|**spark-catalyst**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|hk2-api|2.6.1|**spark-common-utils**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|hk2-locator|2.6.1|**spark-core**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|hk2-utils|2.6.1|**spark-enhancement**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|httpclient|4.5.14|spark-enhancementui|2.12-3.3.0|
|httpclient5|5.1.3|**spark-eventstream-extensions**|**1.0.11 ⬆️ 1.0.5**|
|httpcore|4.4.16|spark-excel-thin|2.12-3.5.6_0.31.2|
|httpmime|4.5.13|**spark-graphx**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|httpmime|4.5.14|**spark-hadoop-cloud**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|impulse-core_spark|2.12-1.5.230534541|**spark-hive**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|impulse-exception_java11|2.12-1.5.230534541|spark-jobinsight|2.12-1.0.0-spark3.5|
|impulse-telemetry-common|2.12-1.5.230534541|**spark-kusto-synapse-connector**|**3.5_2.12-2.0.6 ⬆️ 3.5_2.12-2.1.2**|
|impulse-telemetry-mds_spark|2.12-1.5.230534541|**spark-kvstore**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|impulse-telemetry-pulse_spark|2.12-1.5.230534541|**spark-launcher**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
...
|istack-commons-runtime|3.0.8|**spark-microsoft-tools**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|ivy|2.5.1|**spark-mllib**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jackson-annotations|2.15.2|**spark-mllib-local**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jackson-core|2.15.2|spark-mssql-connector-fabric35|1.6.10|
|jackson-core-asl|1.9.13|**spark-network-common**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jackson-databind|2.15.2|**spark-network-shuffle**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jackson-dataformat-cbor|2.15.2|**spark-onesecurity-client**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jackson-dataformat-xml|2.12.7|**spark-onesecurity-common**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jackson-datatype-jsr310|2.15.2|**spark-onesecurity-server**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jackson-mapper-asl|1.9.13|**spark-repl**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jackson-module-jaxb-annotations|2.15.2|**spark-sketch**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jackson-module-scala|2.12-2.15.2|**spark-sql**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jakarta.activation-api|1.2.2|**spark-sql-api**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jakarta.annotation-api|1.3.5|**spark-sql-kafka**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jakarta.inject|2.6.1|**spark-streaming**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jakarta.servlet-api|4.0.3|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jakarta.validation-api|2.0.2|**spark-tags**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jakarta.ws.rs-api|2.1.6|**spark-token-provider-kafka**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|jakarta.xml.bind-api|2.3.2|**spark-unsafe**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|janino|3.1.9|spark-xml|2.12-0.17.0|
|javassist|3.29.2-GA|**spark-yarn**|**2.12-3.5.5.5.4.20260807.1 ⬆️ 2.12-3.5.5.5.4.20260921.11**|
|javatuples|1.2|spark_diagnostic_cli|2.2.0_spark-3.5.1_20260223.3-shaded|
...
|json4s-ast|2.12-3.7.0-M11|tridenttokenlibrary-assembly|1.12.0|
...
|junit-jupiter|5.5.2|**zookeeper**|**3.6.3.5.4.20260807.1 ⬆️ 3.6.3.5.4.20260921.11**|
|junit-jupiter-api|5.5.2|**zookeeper-jute**|**3.6.3.5.4.20260807.1 ⬆️ 3.6.3.5.4.20260921.11**|
