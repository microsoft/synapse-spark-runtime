...
*   **VHD Name**: 50f245594eea62.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-05-26.0-rc.1
...
|1661097|Impulse:1.0.31.1|Releases Impulse library version 1.0.31.1, including updates to ImpulseException library and enhancements to Delta and Python error classifiers. Adds ImpulseException jar to the VHD.|
|1666709|LibraryManager:1.0.17|Introduces support for specifying custom AzureArtifactFeed repositories for library packages in Fabric, along with improvements like refactoring and symlink changes.|
...
|jakarta.inject|2.6.1|**spark-streaming-kafka**|**2.12-3.5.1.5.4.20250513.1 ⬆️ 2.12-3.5.1.5.4.20250519.1**|
...
|jsr305|3.0.0|xz|1.9|
|jta|1.1|**zookeeper**|**3.6.3.5.4.20250513.1 ⬆️ 3.6.3.5.4.20250519.1**|
