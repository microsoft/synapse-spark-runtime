...
*   **Vhd Release**: Spark3.5-Rel-2024-10-09.0-rc.1
...
|-----|-----|-----|
|1471192|NotebookUtils:1.1.53|Support notebookutils.udf.run in Fabric, fix Mount issue in Gov Cloud, bug fix to address unexpected display results of custom class objects in JSON conversion, fix display ploars dataframe missing column name, and support redacting spark conf|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|1476991|NotebookUtils:1.1.54|Update Notebookutils to 1.1.5 to be compatible with illegal spark.fabric.environmentDetails format|
|1471192|NotebookUtils:1.1.53|Support notebookutils.udf.run in Fabric, fix Mount issue in Gov Cloud, bug fix to address unexpected display results of custom class objects in JSON conversion, fix display ploars dataframe missing column name, and support redacting spark conf|
|1471897|Wildfire/spark35:1.10.11|New Spark 3.5 component release, including improvements and fixes in Hadoop, Spark and Livy including security fix.|
|1463864|Conda:5.0.2|Upgrade semantic-link-sempy to 0.8.0 in Spark 3.5 pyspark default runtime|
...
|1471192|NotebookUtils:1.1.53|Support notebookutils.udf.run in Fabric, fix Mount issue in Gov Cloud, bug fix to address unexpected display results of custom class objects in JSON conversion, fix display ploars dataframe missing column name, and support redacting spark conf|
|1471897|Wildfire/spark35:1.10.11|New Spark 3.5 component release, including improvements and fixes in Hadoop, Spark and Livy including security fix.|
|1474486|TokenLibrary:4.3.4|Enable System SasToken Refresh for Synapse and non-Spark Java Consumers|
|1466640|Wildfire/spark35:1.10.10|New Spark 3.5 component release, including improvements and fixes in Hadoop, Spark and Livy including security fix.|
...
|FabricDWConnector|1.0.10|**TokenLibrary**|**4.3.3 ⬆️ 4.3.4**|
