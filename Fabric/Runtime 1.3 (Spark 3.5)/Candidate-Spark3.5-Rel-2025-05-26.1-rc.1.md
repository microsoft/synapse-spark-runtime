...
*   **VHD Name**: 02118635fcc2f4.vhd
*   **Vhd Release**: Spark3.5-Rel-2025-05-26.1-rc.1
...
|1649570|TridentCore:1.2.23, ServiceConfigurationTemplates:spark/3.5.0|Adds a flag in cluster-info.json to capture workspace private endpoint availability and updates methods for constructing workspace-specific MWC host names for Spark clusters.|
...
|**OneLakeClientStarter**|**1.0.24.3 ⬆️ 1.0.26.1**|
...
|commons-lang|2.6|**notebook-utils**|**1.1.10-spark35-20250317.2 ⬆️ 1.1.11-spark35**|
