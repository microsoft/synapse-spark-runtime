...
*   **VHD Name**: ace96776631b1e.vhd
*   **Vhd Release**: Spark3.5-EarlyAccess-2026-04-16.0-rc.1
*   **Operating System**: Azure Linux 3.0
*   **Apache Spark**: 3.5.5
*   **Java**: 11.0.30
*   **Scala**: 2.12.18
*   **Python**: 3.11/1.0.2
*   **Delta Lake**: 3.2.1.20260331.1

# New Features
|Id|Component|Description|
|-----|-----|-----|
|1994903|UpgradeToFabric:1.2.11|Adds the upgrade_to_fabric Python library as a pre-installed VHD component for Spark 3.5 clusters. This moves the library from a runtime download to being baked into the VM image, improving reliability and removing the dependency on external blob storage at job execution time.|
|2004633|EventStreamsFabricExtension:1.0.0.1|Invalid PR Description|
|2018401|SparkRPCHistoryServer:1.9.0|Add support for preview UI feature, which is a new app loading mechanism of history server, which can speed up app loading time for large Spark application.|
|2032642|Wildfire/spark35:1.10.53|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy, wildfire-hadoop|
|2011616|Wildfire/spark35:1.10.52|New Spark 3.5 Release which includes changes in wildfire-spark|
|2013124|NotebookUtils:1.1.64|PowerQuery module for Spark and Python notebooks, TelemetryUtils deadlock fix, snapshot request throttling fix, OneLake proxy URL subfolder path fix, lightweight environment metadata check improvement, CI/CD pipeline migration.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|2037802|Impulse:1.5.209142029, SparkDiagnosticsLibrary:1.0.33, SparkLighter:2.0.5, SparklyrConnector:2.0.2, SparkNativeParquetWriter:3.5.0-20260403.14, Wildfire:1.10.54.1|Invalid PR Description|
|2031569|Delta:3.2.1.20260331.1|Invalid PR Description|
|2034014|FLTSparkExtensions:1.1.1|Invalid PR Description|
|2032642|Wildfire/spark35:1.10.53|New Spark 3.5 Release which includes changes in wildfire-spark, wildfire-livy, wildfire-hadoop|
|2037267|SparkSqlConnector:1.7.1|Invalid PR Description|
|2011210|FLTSparkExtensions:1.0.1|Improve error messaging and classification|
|2011616|Wildfire/spark35:1.10.52|New Spark 3.5 Release which includes changes in wildfire-spark|
|2013124|NotebookUtils:1.1.64|PowerQuery module for Spark and Python notebooks, TelemetryUtils deadlock fix, snapshot request throttling fix, OneLake proxy URL subfolder path fix, lightweight environment metadata check improvement, CI/CD pipeline migration.|
...
|2001573|TridentTokenLibrary:1.12.0|Dependency upgrades for Trident Token Library|


# Bug Fixes
|Id|Component|Description|
|-----|-----|-----|
|2013622|SparkRPCHistoryServer:1.9.1|Invalid PR Description|
|2019718|ServiceConfigurationTemplates:spark/3.5.0, SparkNativeParquetWriter:spark35|Rolls back SNPW to version 1.3.0-20250828.2 (before page index writing was added) to prevent new corruption. Also disables column index filtering on the read side to protect against already-corrupted files, and reverts the statistics truncate length config to the pre-update value.|
|1850575|ServiceConfigurationTemplates:spark/3.5.0|Introduces a safeguard to enforce a 4096-byte limit on column chunk statistics in Parquet files, preventing oversized footers and ensuring compatibility with downstream clients|
|2013124|NotebookUtils:1.1.64|PowerQuery module for Spark and Python notebooks, TelemetryUtils deadlock fix, snapshot request throttling fix, OneLake proxy URL subfolder path fix, lightweight environment metadata check improvement, CI/CD pipeline migration.|
...
|AzureMLExtensions|1.0.5|**OnelakeSparkCatalog**|**0.4.4 ⬆️ 0.4.9**|
|Conda|5.2.22|PostgreSQLJDBCDriver|1.0.3|
|**CSparkMetricUpdate**|**1.0.16 ⬆️ 1.0.17**|Python|3.11/1.0.2|
|**Delta**|**3.2.1.20260209.3 ⬆️ 3.2.1.20260331.1**|R|1.0.7|
|DSCopilot|1.3.2|SparkAdvisor|1.0.7|
|DSCopilotInstaller|1.0.0|**SparkDiagnosticsLibrary**|**1.0.31 ⬆️ 1.0.33**|
|Esri|1.0.0|SparkJobInsight|1.0.1|
|EventHubConnector|2.3.27|**SparkLighter**|**2.0.4 ⬆️ 2.0.5**|
|**EventStreamsFabricExtension**|**1.0.0 ⬆️ 1.0.0.1**|SparkLineage|0.0.4|
|**FabricDWConnector**|**1.0.21 ⬆️ 1.0.23**|**SparklyrConnector**|**2.0.1 ⬆️ 2.0.2**|
|**FLTSparkExtensions**|**0.18.2 ⬆️ 1.1.1**|**SparkNativeParquetWriter**|**1.3.0-20250828.2 ⬆️ 3.5.0-20260403.14**|
|FLTSparkUtils|0.3.0|**SparkRPCHistoryServer**|**1.8.1 ⬆️ 1.9.1**|
|FsspecWrapper|1.0.7|**SparkSqlConnector**|**1.6.9 ⬆️ 1.7.1**|
|**Genesis**|**0.36.3 ⬆️ 0.37.0**|**SQLServerODBCDriver**|**18.1.0 ⬆️ 18.1.1**|
|**GlutenUI**|**1.3.0-20260209.3 ⬆️ 1.3.0-20260406.3**|SStreamOnSparkJar|2.4.1|
|**HiveMetaStoreClient**|**1.1.21.3 ⬆️ 1.1.28**|TokenLibrary|4.3.9|
|**Impulse**|**1.3.198470504.1 ⬆️ 1.5.209142029**|**TridentCore**|**1.3.2 ⬆️ 1.3.4**|
|**KustoConnector**|**1.5.1 ⬆️ 2.0.2**|**TridentTokenLibrary**|**1.10.4 ⬆️ 1.12.0**|
|**LibraryManager**|**1.0.25 ⬆️ 1.0.26**|**UpgradeToFabric**|**1.2.11**|
|LibraryMetadataCooker|2.0.5|Vegas|3.5.10|
|MlflowLibrary|2.11.3.1|VPaaSClient|3.5.03|
|MMLSpark|1.4.29|**Wildfire**|**1.10.48.1 ⬆️ 1.10.54.1**|
|MySQLJavaConnector|1.0.3|
|**NotebookUtils**|**1.1.63 ⬆️ 1.1.65**|
...
|libwebp|1.3.2|**flt-python**|**0.18.2 ⬆️ 1.1.1**|
...
|libxslt|1.1.37|**impulse-python-handler**|**1.3.198470504 ⬆️ 1.5.209142029**|
...
|lzo|2.10|mypy|1.4.1|
|make|4.2.1|nni|3.0|
|markdown|3.4.1|**notebookutils**|**1.1.13.35.20260208.7 ⬆️ 1.1.14.35.20260324.6**|
...
|**SparkCustomEvents**|**3.5.0-1.0.16 ⬆️ 3.5.0-1.0.17**|**kusto-spark**|**3.0_2.12-5.2.2-SNAPSHOT ⬆️ 3.0_2.12-7.0.4**|
...
|**aircompressor**|**0.27 ⬆️ 2.0.3**|lightgbmlib|3.3.510|
...
|**arrow-memory-unsafe**|**12.0.1**|metrics4-scala|2.12-4.2.9|
|arrow-vector|12.0.1|**microsoft-catalog-metastore-client**|**1.1.21 ⬆️ 1.1.28**|
...
|aws-java-sdk-bundle|1.12.262|**netty-all**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-core|1.47.0|**netty-buffer**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-core-http-netty|1.14.1|**netty-codec**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-data-lake-store-sdk|2.3.9|netty-codec-dns|4.1.101.Final|
|azure-eventhubs|3.3.0|**netty-codec-http**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-eventhubs-spark|2.12-2.3.22|**netty-codec-http2**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-json|1.1.0|**netty-codec-socks**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-keyvault-core|1.0.0|**netty-common**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-storage|7.0.1|**netty-handler**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-storage-blob|12.25.3|**netty-handler-proxy**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-storage-common|12.24.3|**netty-resolver**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|azure-storage-internal-avro|12.10.3|netty-resolver-dns|4.1.101.Final|
...
|commons-cli|1.5.0|**netty-transport**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|commons-codec|1.16.1|**netty-transport-classes-epoll**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|commons-collections|3.2.2|**netty-transport-classes-kqueue**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|commons-collections4|4.4|**netty-transport-native-epoll**|**4.1.96.Final-linux-aarch_64 ⬆️ 4.1.124.Final-linux-aarch_64**|
|commons-compiler|3.1.9|**netty-transport-native-epoll**|**4.1.96.Final-linux-aarch_64 ⬆️ 4.1.124.Final-linux-riscv64**|
|commons-compress|1.23.0|**netty-transport-native-epoll**|**4.1.96.Final-linux-aarch_64 ⬆️ 4.1.124.Final-linux-x86_64**|
|commons-crypto|1.1.0|**netty-transport-native-kqueue**|**4.1.96.Final-osx-aarch_64 ⬆️ 4.1.124.Final-osx-aarch_64**|
|commons-dbcp|1.4|**netty-transport-native-kqueue**|**4.1.96.Final-osx-aarch_64 ⬆️ 4.1.124.Final-osx-x86_64**|
|commons-io|2.11.0|**netty-transport-native-unix-common**|**4.1.96.Final ⬆️ 4.1.124.Final**|
|commons-io|2.18.0|nimbus-jose-jwt|9.37.2|
|commons-lang|2.6|**notebook-utils**|**1.1.13-spark35-20260208.7 ⬆️ 1.1.14-spark35-20260324.6**|
...
|**delta-kernel-api**|**3.2.1.20260209.3 ⬆️ 3.2.1.20260331.1**|paranamer|2.8|
|**delta-kernel-defaults**|**3.2.1.20260209.3 ⬆️ 3.2.1.20260331.1**|parquet-column|1.13.1|
|**delta-spark**|**2.12-3.2.1.20260209.3 ⬆️ 2.12-3.2.1.20260331.1**|parquet-common|1.13.1|
|**delta-storage**|**3.2.1.20260209.3 ⬆️ 3.2.1.20260331.1**|parquet-encoding|1.13.1|
|derby|10.14.2.0|parquet-format-structures|1.13.1|
|dropwizard-metrics-hadoop-metrics2-reporter|0.1.2|**parquet-hadoop-ms**|**3.5.5.5.4.20260211.1 ⬆️ 3.5.5.5.4.20260407.2**|
|fastutil|7.0.2|parquet-jackson|1.13.1|
|flatbuffers-java|1.12.0|pickle|1.3|
|**flt-spark-sql-extensions**|**0.18.2 ⬆️ 1.1.1**|postgresql|42.2.9|
|fluent-logger|0.3.4-jar-with-dependencies-provided|profiler|1.1.1|
|**fmlv-utils**|**1.1.1**|proton-j|0.33.8|
|gcs-connector-hadoop3|2.2.14-shaded|py4j|0.10.9.7|
|**genesis-client**|**2.12-0.36.3-jar-with-dependencies ⬆️ 2.12-0.37.0-jar-with-dependencies**|qpid-proton-j-extensions|1.2.4|
|geoanalytics-fabric|2.12-1.0.0-msfabric-1.3|reactive-streams|1.0.3|
|**gluten-velox-bundle-spark**|**2.12-mariner_2.0_x86_64-1.3.0-20260209.3 ⬆️ 2.12-azurelinux_3.0_x86_64-1.3.0-20260406.3**|reactor-core|3.4.34|
|gson|2.8.9|reactor-netty-core|1.0.40|
|guava|14.0.1|reactor-netty-http|1.0.40|
|h3|4.1.1|rocksdbjni|8.3.2|
|**hadoop-aliyun**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|scala-collection-compat|2.12-2.7.0|
|**hadoop-annotations**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|scala-compiler|2.12.18|
|**hadoop-aws**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|scala-library|2.12.18|
|**hadoop-azure-datalake**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|scala-parser-combinators|2.12-2.3.0|
|hadoop-azureml|1.0-fs|scala-reflect|2.12.18|
|**hadoop-client-api**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|scala-xml|2.12-2.1.0|
|**hadoop-client-runtime**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|scalactic|2.12-3.2.14|
|**hadoop-cloud-storage**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|scalatra|2.12-3.0.0-M1|
|**hadoop-openstack**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|scalatra-common|2.12-3.0.0-M1|
|hadoop-shaded-guava|1.1.1|scalatra-metrics|2.12-3.0.0-M1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.4.20260211.1 ⬆️ 3.3.4.5.4.20260407.2**|shims|0.9.45|
|**hdinsight-spark-metrics**|**3.5.0-1.0.16 ⬆️ 3.5.0-1.0.17**|slf4j-api|2.0.7|
|hive-common|2.3.9|snappy-java|1.1.10.5|
|hive-exec|2.3.9-core|spark|3.5-advisor-core_2.12-1.0.18|
|hive-llap-common|2.3.9|**spark**|**3.5-advisor-core_2.12-1.0.18 ⬆️ 3.5-diagnosis-utils-cluster-info-property-provider_2.12-1.0.0**|
|hive-metastore|2.3.9|**spark**|**3.5-advisor-core_2.12-1.0.18 ⬆️ 3.5-diagnosis-utils-cluster-info-property_2.12-1.0.0**|
...
|hive-shims|2.3.9|**spark-arsenal**|**2.12-3.5.5.5.4.20260407.2**|
|hive-shims-common|2.3.9|spark-avro|2.12-3.5.0|
|hive-shims-scheduler|2.3.9|**spark-avro**|**2.12-3.5.0 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|hive-storage-api|2.8.1|**spark-catalyst**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|hk2-api|2.6.1|**spark-common-utils**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|hk2-locator|2.6.1|**spark-core**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|hk2-utils|2.6.1|**spark-enhancement**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|httpclient|4.5.14|spark-enhancementui|2.12-3.3.0|
|httpclient5|5.1.3|**spark-eventstream-extensions**|**1.0.5 ⬆️ 1.0.8**|
|httpcore|4.4.16|spark-excel-thin|2.12-3.5.6_0.31.2|
|httpmime|4.5.13|**spark-graphx**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|httpmime|4.5.14|**spark-hadoop-cloud**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|**impulse-core_spark**|**2.12-1.3.198470504 ⬆️ 2.12-1.5.209142029**|**spark-hive**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|**impulse-exception_java11**|**2.12-1.3.198470504 ⬆️ 2.12-1.5.209142029**|spark-jobinsight|2.12-1.0.0-spark3.5|
|**impulse-telemetry-common**|**2.12-1.5.209142029**|**spark-kusto-synapse-connector**|**3.5_2.12-1.5.1 ⬆️ 3.5_2.12-2.0.2**|
|**impulse-telemetry-mds_spark**|**2.12-1.3.198470504 ⬆️ 2.12-1.5.209142029**|**spark-kvstore**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|ini4j|0.5.4|**spark-launcher**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
...
|ivy|2.5.1|**spark-microsoft-tools**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jackson-annotations|2.15.2|**spark-mllib**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jackson-core|2.15.2|**spark-mllib-local**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jackson-core-asl|1.9.13|**spark-mssql-connector-fabric35**|**1.6.9 ⬆️ 1.7.1**|
|jackson-databind|2.15.2|**spark-network-common**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jackson-dataformat-cbor|2.15.2|**spark-network-shuffle**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jackson-dataformat-xml|2.12.7|**spark-onesecurity-client**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jackson-datatype-jsr310|2.15.2|**spark-onesecurity-common**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jackson-mapper-asl|1.9.13|**spark-onesecurity-server**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jackson-module-jaxb-annotations|2.15.2|**spark-repl**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jackson-module-scala|2.12-2.15.2|**spark-sketch**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jakarta.activation-api|1.2.2|**spark-sql**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jakarta.annotation-api|1.3.5|**spark-sql-api**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jakarta.inject|2.6.1|**spark-sql-kafka**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jakarta.servlet-api|4.0.3|**spark-streaming**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jakarta.validation-api|2.0.2|**spark-streaming-kafka**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jakarta.ws.rs-api|2.1.6|**spark-tags**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|jakarta.xml.bind-api|2.3.2|**spark-token-provider-kafka**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|janino|3.1.9|**spark-unsafe**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|javassist|3.29.2-GA|spark-xml|2.12-0.17.0|
|javatuples|1.2|**spark-yarn**|**2.12-3.5.5.5.4.20260211.1 ⬆️ 2.12-3.5.5.5.4.20260407.2**|
|javax.jdo|3.2.0-m3|spark_diagnostic_cli|2.1.7_spark-3.5.1_20250901.3-shaded|
|javolution|5.5.1|sparklyr-connector|3.5.1-1.0.0267535|
|jaxb-api|2.2.11|**sparknativeparquetwriter-azl3**|**2.12-3.5.0-20260403.14**|
|jaxb-runtime|2.3.2|spire|2.12-0.17.0|
|jcip-annotations|1.0-1|spire-macros|2.12-0.17.0|
...
|jersey-server|2.40|synapseml-cognitive|2.12-1.1.1|
|jettison|1.1|synapseml-core|2.12-1.1.1|
|jetty-util|9.4.57.v20241219|synapseml-deep-learning|2.12-1.1.1|
|jetty-util-ajax|9.4.57.v20241219|synapseml-internal|2.12-1.1.1.0|
|jline|2.14.6|synapseml-lightgbm|2.12-1.1.1|
|joda-time|2.12.5|synapseml-opencv|2.12-1.1.1|
|jodd-core|3.5.2|synapseml-vw|2.12-1.1.1|
|jsch|0.1.54|**synfs**|**1.1.13-spark35-20260208.7 ⬆️ 1.1.14-spark35-20260324.6**|
...
|json4s-ast|2.12-3.7.0-M11|**trident-core**|**1.3.2 ⬆️ 1.3.4**|
|json4s-core|2.12-3.7.0-M11|**tridenttokenlibrary-assembly**|**1.10.4 ⬆️ 1.12.0**|
|json4s-jackson|2.12-3.7.0-M11|univocity-parsers|2.9.1|
|json4s-scalap|2.12-3.7.0-M11|vw-jni|9.3.0|
|jsr305|3.0.0|wildfly-openssl|1.0.7.Final|
|jta|1.1|woodstox-core|6.2.4|
|jul-to-slf4j|2.0.7|xbean-asm9-shaded|4.23|
|junit-jupiter|5.5.2|xz|1.9|
|junit-jupiter-api|5.5.2|**zookeeper**|**3.6.3.5.4.20260211.1 ⬆️ 3.6.3.5.4.20260407.2**|
|junit-jupiter-engine|5.5.2|**zookeeper-jute**|**3.6.3.5.4.20260211.1 ⬆️ 3.6.3.5.4.20260407.2**|
...
|V8|5.0.0|**notebookutils**|**1.1.13.35.20260208.7 ⬆️ 1.1.14.35.20260324.6**|
