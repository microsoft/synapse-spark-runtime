# System Environment
*   **Vhd Release**: Spark3.3-Rel-2024-03-20.2-rc.1
...
|**delta-core**|**2.12-2.2.0.10 --> 2.12-2.2.0.11**|
|**delta-iceberg**|**2.12-2.2.0.10 --> 2.12-2.2.0.11**|
|**delta-storage**|**2.2.0.10 --> 2.2.0.11**|
|derby|0.14.2.0|
...
|**spark_diagnostic_cli**|**2.0.7_spark-3.3.0 --> 2.1.0_spark-3.3.0**|
