...
|cachetools|5.2.0|packaging|24.2|
...
|dbus|1.13.6|protobuf|3.20.1|
|debugpy|1.6.3|psutil|5.9.4|
|decorator|5.1.1|psutil|7.0.0|
|decorator|5.2.1|pthread-stubs|0.4|
|defusedxml|0.7.1|ptyprocess|0.7.0|
|dill|0.3.6|pure-eval|0.2.3|
|distlib|0.3.6|pure_eval|0.2.2|
|distro|1.8.0|py-xgboost|1.7.1|
|docker|6.0.1|py4j|0.10.9.5|
|dotnetcore2|3.1.23|py4j|0.10.9.7|
|entrypoints|0.4|pyarrow|9.0.0|
|et_xmlfile|1.0.1|pyasn1|0.4.8|
|exceptiongroup|1.2.2|pyasn1-modules|0.2.7|
|executing|2.2.0|pycosat|0.6.4|
|executing|1.2.0|pycparser|2.21|
...
|flatbuffers|2.0.7|pyparsing|3.2.3|
|fluent-logger|0.10.0|pyparsing|3.0.9|
|fontconfig|2.14.1|pyperclip|1.8.2|
|fonttools|4.38.0|pyqt|5.9.2|
...
|glib-tools|2.74.1|qt|5.9.7|
|glog|0.6.0|re2|2022.06.01|
|gmp|6.2.1|readline|8.1.2|
|gmpy2|2.1.2|readline|8.2|
|google-auth|2.14.0|regex|2022.10.31|
|google-auth-oauthlib|0.4.6|requests|2.28.1|
|google-pasta|0.2.0|requests-oauthlib|1.3.1|
|greenlet|1.1.3.post0|retrying|1.3.3|
|grpc-cpp|1.46.4|rsa|4.9|
|grpcio|1.46.4|ruamel-yaml|0.17.4|
|gst-plugins-base|1.14.0|ruamel-yaml-clib|0.2.6|
|gstreamer|1.14.0|ruamel_yaml|0.15.80|
|h5py|3.7.0|s2n|1.0.10|
|hdf5|1.12.2|salib|1.4.6.1|
|html5lib|1.1|scikit-image|0.19.3|
|humanfriendly|10.0|scikit-learn|1.1.3|
|hummingbird-ml|0.4.0|scipy|1.9.3|
|icu|58.2|seaborn|0.11.1|
|idna|3.4|seaborn-base|0.11.1|
|imagecodecs|2022.9.26|secretstorage|3.3.3|
|imageio|2.9.0|send2trash|1.8.0|
|importlib-metadata|5.0.0|setuptools|65.5.1|
|impulse-python-handler|1.0.22.1.0.0|shap|0.39.0|
|interpret|0.2.4|sip|4.19.13|
|interpret-core|0.2.4|six|1.16.0|
|ipykernel|6.17.0|six|1.17.0|
|ipykernel|6.29.5|skl2onnx|1.8.0.1|
|ipython|8.6.0|sklearn-pandas|2.2.0|
|ipython-genutils|0.2.0|slicer|0.0.7|
|ipywidgets|7.7.0|smart_open|6.2.0|
|isodate|0.6.0|smmap|3.0.5|
|itsdangerous|2.1.2|snappy|1.1.9|
|jdcal|1.4.1|sniffio|1.3.0|
|jedi|0.18.1|soupsieve|2.3.2.post1|
|jedi|0.19.2|sqlalchemy|1.4.43|
...
|jupyter-core|5.7.2|synapseml-core|1.0.9.dev1|
