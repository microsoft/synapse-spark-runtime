# System Environment
*   **Vhd Release**: Spark3.3-Rel-2024-02-21.1-rc.1
...
|notebook|6.5.2|
|notebook-shim|0.2.2|
|notebookutils|3.3.0-20240130.4|
|numba|0.56.3|
|numpy|1.23.4|
|numpy|1.26.4|
|oauthlib|3.2.2|
...
|autotune-client|2.12-1.10.0-3.3-117562362|
|autotune-common|2.12-1.10.0-3.3-117562362|
|avro|1.11.0|
|avro-ipc|1.11.0|
|avro-mapred|1.11.0|
...
|delta-core|2.12-2.2.0.10|
|delta-iceberg|2.12-2.2.0.10|
|delta-storage|2.2.0.10|
|derby|0.14.2.0|
...
|gson|2.8.6|
|guava|4.0.1|
|hadoop-aliyun|3.3.3.5.2-117504963|
|hadoop-annotations|3.3.3.5.2-117504963|
|hadoop-aws|3.3.3.5.2-117504963|
|hadoop-azure|3.3.3.5.2-117504963|
|hadoop-azure-datalake|3.3.3.5.2-117504963|
|hadoop-azureml|1.0-fs|
|hadoop-client-api|3.3.3.5.2-117504963|
|hadoop-client-runtime|3.3.3.5.2-117504963|
|hadoop-cloud-storage|3.3.3.5.2-117504963|
|hadoop-cos|3.3.3.5.2-117504963|
|hadoop-openstack|3.3.3.5.2-117504963|
|hadoop-shaded-guava|1.1.1|
|hadoop-yarn-server-web-proxy|3.3.3.5.2-117504963|
...
|notebook-utils|3.3.0-20240130.4|
|objenesis|3.2|
...
|spark-avro|2.12-3.3.1.5.2-117504963|
|spark-catalyst|2.12-3.3.1.5.2-117504963|
|**spark-cdm-connector-assembly-spark**|**3.3-1.19.5 --> 3.3-1.19.7**|
|spark-core|2.12-3.3.1.5.2-117504963|
|spark-enhancement|2.12-3.3.1.5.2-117504963|
|spark-enhancementui|2.12-3.0.0|
|spark-graphx|2.12-3.3.1.5.2-117504963|
|spark-hadoop-cloud|2.12-3.3.1.5.2-117504963|
|spark-hive|2.12-3.3.1.5.2-117504963|
|spark-hive-thriftserver|2.12-3.3.1.5.2-117504963|
|spark-kusto-synapse-connector|3.1_2.12-1.3.4|
|spark-kvstore|2.12-3.3.1.5.2-117504963|
|spark-launcher|2.12-3.3.1.5.2-117504963|
|spark-lighter-contract|2.12-2.0.7_spark-3.3.0|
|spark-lighter-core|2.12-2.0.7_spark-3.3.0|
|spark-microsoft-tools|2.12-3.3.1.5.2-117504963|
|spark-mllib|2.12-3.3.1.5.2-117504963|
|spark-mllib-local|2.12-3.3.1.5.2-117504963|
|spark-network-common|2.12-3.3.1.5.2-117504963|
|spark-network-shuffle|2.12-3.3.1.5.2-117504963|
|spark-repl|2.12-3.3.1.5.2-117504963|
|spark-sketch|2.12-3.3.1.5.2-117504963|
|spark-sql|2.12-3.3.1.5.2-117504963|
|spark-sql-kafka|0_2.12-3.3.1.5.2-117504963|
|spark-streaming|2.12-3.3.1.5.2-117504963|
|spark-streaming-kafka|0_2.12-3.3.1.5.2-117504963|
|spark-streaming-kafka|2.12-3.3.1.5.2-117504963|
|spark-tags|2.12-3.3.1.5.2-117504963|
|spark-token-provider-kafka|0_2.12-3.3.1.5.2-117504963|
|spark-unsafe|2.12-3.3.1.5.2-117504963|
|spark-yarn|2.12-3.3.1.5.2-117504963|
|**spark_diagnostic_cli**|**2.0.6_spark-3.3.0 --> 2.0.7_spark-3.3.0**|
...
|xz|1.8|
|zookeeper|3.6.2.5.2-117504963|
|zookeeper-jute|3.6.2.5.2-117504963|
|zstd-jni|1.5.2-1|
