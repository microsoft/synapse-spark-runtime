# System Environment
*   **Vhd Release**: Spark3.2-Rel-2024-01-10.0-rc.1
...
|-----|-----|-----|-----|
|1229622|Wildfire/spark32:1.7.27|Livy: Prevent pooling for appid when not needed. Use dedicated pool for stopping sessions|Prevent pooling for appid when not needed.  Use dedicated pool for stopping sessions.|
...
|1171110|Wildfire/spark32:1.7.25|Increase spark.nonjvm.error.buffer.size for better error classification|We employ error messages to categorize error codes. In the context of using PySpark, the configuration parameter, spark.nonjvm.error.buffer.size, determines the size of the message used for error classification. It's worth noting that certain error scenarios, such as stack overflow errors, may necessitate a larger amount of log data to accurately classify the issue.|
...
|1218781|Impulse:1.1.7|Impulse Release 1.0.18|Fix Impulse Listener Memory Leak, improve error code classification and ensure PII and EUII is scrubbed from Microsoft's internal logs.|
|1224622|Wildfire/spark32:1.7.34|Enabling Dedicated Thread Pool for Cancelling Session|Cancelling a job can be delayed because it's thread pool is shared with session creation. This change will make Livy to use dedicate thread pool so that cancelling can be done regardless how many session creation requests are there.|
...
|**spark-avro**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-catalyst**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|spark-cdm-connector-assembly-spark|3.2-1.19.4|3.2-1.19.4|
|**spark-core**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-enhancement**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|spark-enhancementui|2.12-3.0.0|2.12-3.0.0|
|**spark-graphx**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-hadoop-cloud**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-hive**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-hive-thriftserver**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|spark-kusto-synapse-connector|3.1_2.12-1.1.1|3.1_2.12-1.1.1|
|**spark-kvstore**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-launcher**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|spark-lighter-contract|2.12-1.0.1_spark-3.2.1|2.12-1.0.1_spark-3.2.1|
|spark-lighter-core|2.12-1.0.1_spark-3.2.1|2.12-1.0.1_spark-3.2.1|
|**spark-microsoft-tools**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-mllib**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-mllib-local**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|spark-mssql-connector|1.2.0|1.2.0|
|**spark-network-common**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-network-shuffle**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-repl**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-sketch**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-sql**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-sql-kafka**|**0_2.12-3.2.2.5.1-100879434**|**0_2.12-3.2.2.5.1-112607094**|
|**spark-streaming**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-streaming-kafka**|**2.12-3.2.2.5.1-100879434**|**0_2.12-3.2.2.5.1-112607094**|
|**spark-streaming-kafka**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-tags**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-token-provider-kafka**|**0_2.12-3.2.2.5.1-100879434**|**0_2.12-3.2.2.5.1-112607094**|
|**spark-unsafe**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|**spark-yarn**|**2.12-3.2.2.5.1-100879434**|**2.12-3.2.2.5.1-112607094**|
|spark_diagnostic_cli|2.0.2_spark-3.2.0|2.0.2_spark-3.2.0|
|sparknativeparquetwriter|2.12-0.8.1|2.12-0.8.1|
...
|sqlanalyticsconnector|3.2.0-2.1.2|3.2.0-2.1.2|
|stax-api|1.0.1|1.0.1|
|stream|2.9.6|2.9.6|
|structuredstreamforspark|2.12-3.2.0-2.3.0|2.12-3.2.0-2.3.0|
|super-csv|2.2.0|2.2.0|
|synapseml|2.12-0.10.1-22-95f451ab-SNAPSHOT|2.12-0.10.1-22-95f451ab-SNAPSHOT|
|synapseml-cognitive|2.12-0.10.1-22-95f451ab-SNAPSHOT|2.12-0.10.1-22-95f451ab-SNAPSHOT|
|synapseml-core|2.12-0.10.1-22-95f451ab-SNAPSHOT|2.12-0.10.1-22-95f451ab-SNAPSHOT|
|synapseml-deep-learning|2.12-0.10.1-22-95f451ab-SNAPSHOT|2.12-0.10.1-22-95f451ab-SNAPSHOT|
|synapseml-internal|2.12-0.0.0-105-28644623-SNAPSHOT|2.12-0.0.0-105-28644623-SNAPSHOT|
|synapseml-lightgbm|2.12-0.10.1-22-95f451ab-SNAPSHOT|2.12-0.10.1-22-95f451ab-SNAPSHOT|
|synapseml-opencv|2.12-0.10.1-22-95f451ab-SNAPSHOT|2.12-0.10.1-22-95f451ab-SNAPSHOT|
|synapseml-vw|2.12-0.10.1-22-95f451ab-SNAPSHOT|2.12-0.10.1-22-95f451ab-SNAPSHOT|
|synfs|3.2.0-20230515.7|3.2.0-20230515.7|
|threeten-extra|1.5.0|1.5.0|
|tink|1.6.0|1.6.0|
|transaction-api|1.1|1.1|
|trident-core|1.1.27|1.1.27|
|tridentsystemtokenlibrary-assembly|1.4.8|1.4.8|
|tridenttokenlibrary-assembly|1.4.8|1.4.8|
...
|xz|1.8|1.8|
|**zookeeper**|**3.6.2.5.1-100879434**|**3.6.2.5.1-112607094**|
|**zookeeper-jute**|**3.6.2.5.1-100879434**|**3.6.2.5.1-112607094**|
|zstd-jni|1.5.0-4|1.5.0-4|
...
|googlesheets4|1.0.1|1.0.1|
|gower|1.0.1|1.0.1|
|grDevices|4.3.2|4.3.2|
|graphics|4.3.2|4.3.2|
|grid|4.3.2|4.3.2|
|gtable|0.3.1|0.3.1|
|hardhat|1.2.0|1.2.0|
|haven|2.5.1|2.5.1|
|hexbin|1.28.2|1.28.2|
...
|modeldata|1.1.0|1.1.0|
|modelenv|0.1.0|0.1.0|
|modelr|0.1.10|0.1.10|
|munsell|0.5.0|0.5.0|
...
|openssl|2.0.5|2.0.5|
|pROC|1.18.0|1.18.0|
|parallel|4.3.2|4.3.2|
|parallelly|1.34.0|1.34.0|
|parsnip|1.0.3|1.0.3|
|patchwork|1.1.2|1.1.2|
|pillar|1.8.1|1.8.1|
...
|whisker|0.4.1|0.4.1|
|withr|2.5.0|2.5.0|
|workflows|1.1.2|1.1.2|
|workflowsets|1.0.0|1.0.0|
|xfun|0.37|0.37|
|xgboost|1.6.0.1|1.6.0.1|
|xml2|1.3.3|1.3.3|
|xopen|1.0.0|1.0.0|
|xtable|1.8-4|1.8-4|
|xts|0.12.2|0.12.2|
