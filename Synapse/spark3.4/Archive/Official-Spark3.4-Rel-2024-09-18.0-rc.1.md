...
|backports-tempfile|1.0|numpy|2.1.1|
...
|cycler|0.12.1|**platformdirs**|**3.11.0 ⬆️ 4.3.6**|
...
|libgcc|14.1.0|**urllib3**|**2.1.0 ⬆️ 2.2.3**|
...
|hive-shims|0.23-2.3.9|**spark-core**|**2.12-3.4.3.5.3.20240828.1 ⬆️ 2.12-3.4.3.5.3.20240904.5**|
