# System Environment
*   **Vhd Release**: Spark3.4-Rel-2024-08-07.0-rc.1
...
|-----|-----|-----|-----|
|1416718|FabricDWConnector: 1.0.10|Python Bindings for Spark Connector for Data Warehouse in Fabric|Python Bindings for Spark Connector for Data Warehouse in Fabric|
|1421822|TokenLibrary:4.2.2|Logging and exception handling improvements. Service Principal + Certificate authentication|Get Access token retries on IOException. Improve logging to track get access token requests.  Retrieve an access token directly from Azure Entra ID for a given service principal and a certificate that will be downloaded from a given keyvault.|

# Improvements

|Id|Component|Title|Description|
|-----|-----|-----|-----|
|1422160|Delta:2.4.0.19|Delta version 2.4.0.19|Delta version update contains a bug fix when OptimizeWrite enabled and coalesce is used at the end of write job. It also contains changes where we skip collecting commit stats to prevent computing Snapshot state.|
|1421822|TokenLibrary:4.2.2|Logging and exception handling improvements. Service Principal + Certificate authentication|Get Access token retries on IOException. Improve logging to track get access token requests.  Retrieve an access token directly from Azure Entra ID for a given service principal and a certificate that will be downloaded from a given keyvault.|
...
|libpq|16.2|
|libprotobuf|4.24.4|
|library-metadata-cooker|3.4.1.1|
...
|nest-asyncio|1.6.0|
|networkx|3.2.1|
|notebookutils|1.1.2.34.20240702.2|
|nspr|4.35|
|nss|3.98|
|numba|0.59.0|
|numpy|1.23.5|
...
|**delta-core**|**2.12-2.4.0.18 --> 2.12-2.4.0.19**|
|**delta-iceberg**|**2.12-2.4.0.18 --> 2.12-2.4.0.19**|
|**delta-storage**|**2.4.0.18 --> 2.4.0.19**|
|derby|0.14.2.0|
...
|gson|2.8.9|
|guava|4.0.1|
|hadoop-aliyun|3.3.4.5.3.20240722.5|
|hadoop-annotations|3.3.4.5.3.20240722.5|
|hadoop-aws|3.3.4.5.3.20240722.5|
|hadoop-azure|3.3.4.5.3.20240722.5|
|hadoop-azure-datalake|3.3.4.5.3.20240722.5|
|hadoop-azureml|1.0-fs|
|hadoop-client-api|3.3.4.5.3.20240722.5|
|hadoop-client-runtime|3.3.4.5.3.20240722.5|
|hadoop-cloud-storage|3.3.4.5.3.20240722.5|
|hadoop-openstack|3.3.4.5.3.20240722.5|
|hadoop-shaded-guava|1.1.1|
|hadoop-yarn-server-web-proxy|3.3.4.5.3.20240722.5|
...
|httpmime|4.5.14|
|httpmime|4.5.13|
|impulse-core_spark|3.4_2.12-1.0.22|
|impulse-telemetry-mds_spark|3.4_2.12-1.0.22|
|ini4j|0.5.4|
...
|kafka-clients|3.3.2|
|kryo-shaded|4.0.2|
|**kusto-spark**|**3.0_2.12-5.2.2-SNAPSHOT**|
|lapack|3.0.3|
|leveldbjni-all|1.8|
|libfb303|0.9.3|
|libthrift|0.12.0|
...
|notebook-utils|1.1.2-spark34-20240702.2|
|objenesis|3.2|
...
|orc-core|1.8.7-shaded-protobuf|
|orc-mapreduce|1.8.7-shaded-protobuf|
|orc-shims|1.8.7|
|oro|2.0.8|
...
|spark-avro|2.12-3.4.3.5.3.20240722.5|
|spark-catalyst|2.12-3.4.3.5.3.20240722.5|
|spark-core|2.12-3.4.3.5.3.20240722.5|
|spark-enhancement|2.12-3.4.3.5.3.20240722.5|
|spark-enhancementui|2.12-3.3.0|
|spark-graphx|2.12-3.4.3.5.3.20240722.5|
|spark-hadoop-cloud|2.12-3.4.3.5.3.20240722.5|
|spark-hive|2.12-3.4.3.5.3.20240722.5|
|**spark-kusto-synapse-connector**|**3.4_2.12-1.3.8-uber --> 3.4_2.12-1.5.1**|
|spark-kvstore|2.12-3.4.3.5.3.20240722.5|
|spark-launcher|2.12-3.4.3.5.3.20240722.5|
|spark-lighter-contract|2.12-2.0.9_spark-3.4.0_20240703.5|
|spark-lighter-core|2.12-2.0.11_spark-3.4.0_20240703.5|
|spark-microsoft-tools|2.12-3.4.3.5.3.20240722.5|
|spark-mllib|2.12-3.4.3.5.3.20240722.5|
|spark-mllib-local|2.12-3.4.3.5.3.20240722.5|
|spark-network-common|2.12-3.4.3.5.3.20240722.5|
|spark-network-shuffle|2.12-3.4.3.5.3.20240722.5|
|spark-repl|2.12-3.4.3.5.3.20240722.5|
|spark-sketch|2.12-3.4.3.5.3.20240722.5|
|spark-sql|2.12-3.4.3.5.3.20240722.5|
|spark-sql-kafka|0_2.12-3.4.3.5.3.20240722.5|
|spark-streaming|2.12-3.4.3.5.3.20240722.5|
|spark-streaming-kafka|0_2.12-3.4.3.5.3.20240722.5|
|spark-streaming-kafka|2.12-3.4.3.5.3.20240722.5|
|spark-tags|2.12-3.4.3.5.3.20240722.5|
|spark-token-provider-kafka|0_2.12-3.4.3.5.3.20240722.5|
|spark-unsafe|2.12-3.4.3.5.3.20240722.5|
|spark-yarn|2.12-3.4.3.5.3.20240722.5|
|**spark_diagnostic_cli**|**2.1.3_spark-3.4.1_20240724.6 --> 2.1.3_spark-3.4.1_20240731.2**|
|sparklyr-connector|3.4.1-1.0.0273341|
|sparknativeparquetwriter|2.12-0.15.4|
|spire|2.12-0.17.0|
...
|synfs|1.1.2-spark34-20240702.2|
...
|xz|1.9|
|zookeeper|3.6.3.5.3.20240722.5|
|zookeeper-jute|3.6.3.5.3.20240722.5|
|zstd-jni|1.5.2-5|
