...
*   **VHD Name**: 1c3963430de186.vhd
*   **Vhd Release**: Spark3.4-Rel-2025-10-30.1-rc.1
...
|Id|Component|Description|
|-----|-----|-----|
|1814761|NotebookUtils:1.1.63.2|Allows you to cancel a R code cell when running interactively in notebooks by specifying this spark conf: `spark.livy.synapse.r.cancelImprovement.enabled true`|
...
|**NotebookUtils**|**1.1.62.2 ⬆️ 1.1.63.2**|

# Python Modules
|Name|Version|Name|Version|
|-----|-----|-----|-----|
|_libgcc_mutex|0.1|libuuid|2.41.2|
...
|attrs|23.2.0|matplotlib|3.10.7|
|aws-c-auth|0.7.11|matplotlib|3.8.2|
|aws-c-cal|0.6.9|matplotlib-base|3.8.2|
|aws-c-common|0.9.12|matplotlib-inline|0.1.6|
|aws-c-compression|0.2.17|matplotlib-inline|0.2.1|
...
|azure-graphrbac|0.61.1|msal|1.27.0|
...
|azure-storage-file-datalake|12.14.0|mypy-extensions|1.0.0|
...
|azureml-mlflow|1.55.0|ncurses|6.4|
...
|ca-certificates|2024.2.2|openpyxl|3.1.2|
|ca-certificates|2025.10.5|openssl|3.2.1|
|cached-property|1.5.2|openssl|3.5.4|
|cached_property|1.5.2|opt_einsum|3.3.0|
|cachetools|5.3.3|orc|1.9.2|
|cairo|1.18.0|overrides|7.7.0|
|certifi|2025.10.5|packaging|25.0|
|certifi|2024.2.2|packaging|23.2|
|cffi|1.16.0|pandas|1.5.3|
|cffi|2.0.0|pandas|2.3.3|
|charset-normalizer|3.4.4|pandasql|0.7.3|
|charset-normalizer|3.3.2|pandocfilters|1.5.0|
|click|8.1.7|paramiko|3.4.0|
|cloudpickle|2.2.1|parso|0.8.3|
|clr_loader|0.2.6|parso|0.8.5|
|colorama|0.4.6|pathos|0.3.2|
|comm|0.2.2|pathspec|0.12.1|
|comm|0.2.3|patsy|0.5.6|
...
|dash|2.16.1|platformdirs|4.5.0|
...
|debugpy|1.8.17|prettytable|3.9.0|
|decorator|5.2.1|prometheus_client|0.20.0|
...
|executing|2.2.1|pure_eval|0.2.2|
...
|font-ttf-ubuntu|0.83|pycparser|2.23|
...
|googleapis-common-protos|1.63.0|pytz|2023.4|
...
|kiwisolver|1.4.9|synapseml-opencv|1.0.9|
...
|ld_impl_linux-64|2.44|tensorboard-data-server|0.7.0|
...
|libarrow-flight-sql|14.0.2|tomli|2.3.0|
|libarrow-gandiva|14.0.2|tomli|2.0.1|
|libarrow-substrait|14.0.2|toolz|0.12.1|
|libbrotlicommon|1.1.0|tornado|6.5.2|
...
|libedit|3.1.20191231|tzdata|2025.2|
|libev|4.33|tzdata|2024a|
|libevent|2.1.12|ucx|1.15.0|
|libexpat|2.7.1|unicodedata2|15.1.0|
|libexpat|2.6.2|unixodbc|2.3.12|
|libffi|3.5.2|uri-template|1.3.0|
|libffi|3.4.2|urllib3|2.1.0|
|libflac|1.4.3|urllib3|2.5.0|
|libgcc|15.2.0|virtualenv|20.23.1|
|libgcc-ng|15.2.0|wcwidth|0.2.13|
|libgcc-ng|13.2.0|wcwidth|0.2.14|
...
|libglib|2.80.0|wheel|0.45.1|
|libgomp|15.2.0|wheel|0.42.0|
...
|libsqlite|3.50.4|yarl|1.9.4|
|libssh2|1.11.0|zeromq|4.3.5|
|libstdcxx|15.2.0|zipp|3.17.0|
...
|hive-llap-common|2.3.9|**spark-avro**|**2.12-3.4.3.5.3.20250511.1 ⬆️ 2.12-3.4.3.5.3.20250911.1**|
...
|hive-shims|0.23-2.3.9|**spark-core**|**2.12-3.4.3.5.3.20250511.1 ⬆️ 2.12-3.4.3.5.3.20250911.1**|
|hive-shims|2.3.9|**spark-enhancement**|**2.12-3.4.3.5.3.20250511.1 ⬆️ 2.12-3.4.3.5.3.20250911.1**|
...
|httpmime|4.5.13|**spark-microsoft-tools**|**2.12-3.4.3.5.3.20250511.1 ⬆️ 2.12-3.4.3.5.3.20250911.1**|
|httpmime|4.5.14|**spark-mllib**|**2.12-3.4.3.5.3.20250511.1 ⬆️ 2.12-3.4.3.5.3.20250911.1**|
...
|jackson-core-asl|1.9.13|**spark-streaming-kafka**|**2.12-3.4.3.5.3.20250511.1 ⬆️ 2.12-3.4.3.5.3.20250911.1**|
|jackson-databind|2.14.2|**spark-streaming-kafka**|**2.12-3.4.3.5.3.20250511.1 ⬆️ 0_2.12-3.4.3.5.3.20250911.1**|
...
|jsch|0.1.54|xz|1.9|
|json|1.8|**zookeeper**|**3.6.3.5.3.20250511.1 ⬆️ 3.6.3.5.3.20250911.1**|
|json|3|**zookeeper-jute**|**3.6.3.5.3.20250511.1 ⬆️ 3.6.3.5.3.20250911.1**|
