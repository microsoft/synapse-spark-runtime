...
*   **VHD Name**: 2ed4327785cb22.vhd
*   **Vhd Release**: Spark3.4-Rel-2025-02-26.3-rc.1
...
|-----|-----|-----|
|1577125|DSCopilot:1.0.0|Adds DsCopilot to the VHD in Spark 3.4, eliminating installation time for users when initiating the Copilot, thereby reducing the initiation time.|


# Improvements
|Id|Component|Description|
|-----|-----|-----|
|1588637|NotebookUtils:1.1.56|Improve display function experience and notebookutils.fs.put support instant file flush and some other bug fixes.|
|1573836|FsspecWrapper:1.0.17|Updated FsspecWrapper in Spark 3.4 to support token provider, enhancing long-running notebook sessions by automatically refreshing tokens, thereby avoiding expiration issues when interacting with OneLake using Pandas.|
|1579800|ServiceConfigurationTemplates:no version|Updates the flag in cluster-info.json.liquid for region-wise PrivateLink enablement, allowing the use of Workspace DNS in Spark 3.4.|
...
|-----|-----|-----|
|1588637|NotebookUtils:1.1.56|Improve display function experience and notebookutils.fs.put support instant file flush and some other bug fixes.|
|1583833|CSparkMetricUpdate:1.0.10|Security enhancements were made to address credential leakage in Spark 3.4's logging, specifically redacting sensitive information in the CSparkTaskEvents "EndReason" column.|
|1532391|OneLakeClientStarter/1.0.24.2|Fixes SSL certificate issue in Spark 3.4 by setting the SSL_CERT_FILE environment variable, addressing problems when using urllib and httpx.|
|1578132|Wildfire:1.9.26|Addresses a ClassNotFoundException issue due to JDK-8300596 from Java 8 Update 381 by increasing the limit of manifest file size in Spark 3.4.|
...
|-----|-----|-----|-----|
|AutoscaleProbe|3.9.4|**NotebookUtils**|**1.1.59 ⬆️ 1.1.60**|
|Autotune|1.11.1.1|**OneLakeClientStarter**|**1.0.24 ⬆️ 1.0.24.2**|
|AzureMLExtensions|1.0.4|OnelakeSparkCatalog|0.1.21|
|**CSparkMetricUpdate**|**1.0.9 ⬆️ 1.0.10**|Peregrine|0.10.4|
|**Conda**|**8.0.29 ⬆️ 8.0.30**|PostgreSQLJDBCDriver|1.0.3|
...
|gst-plugins-base|1.22.9|**pyzmq**|**25.1.2 ⬆️ 26.3.0**|
