# System Environment
*   **Vhd Release**: Spark3.4-Rel-2024-04-24.0-rc.1
*   **Operating System**: CBL-Mariner 2.0.20240403
*   **Java**: 11.0.23
*   **Scala**: 2.12.17
*   **Python**: 3.10/2.0.0
*   **Delta Lake**: 2.4.0.9
...
|-----|-----|-----|-----|
|1322080|KustoConnector:1.3.5|Upgraded Kusto Connector with latest dependencies|Kusto Connector with upgraded dependencies such as kusto-spark, kusto-sdk, etc|
|1304967|TokenLibrary:4.1.1, TridentTokenLibrary:1.6.5|Various Fixes and Features for the TokenLibraries|Livesite Fixes for the TokenLibraries and New Features like mssparkutils env api for Fabric and AKV based client creds token providers.|
|1310312|Wildfire/spark34:1.9.6|New spark 3.4 stack release. Support columnar write in spark, upgrade livy server to scala 2.12 and compile with java 11 to fix CG alerts. Remove livy config logging. add more logs in zookeeper to debug startup delays|New spark 3.4 stack release. Support columnar write in spark, upgrade livy server to scala 2.12 and compile with java 11 to fix CG alerts. Remove livy config logging. add more logs in zookeeper to debug startup delays.|
|1316459|Vegas:spark34/3.4.09|Intelligent Cache locality using consistent hashing|Intelligent cache uses placement information to schedule spark tasks on executors. Now we are using consistent hashing to provide locality information.|
...
|1323487|Impulse:1.2.3|Impulse Release 1.0.20|New error code classifications for Python, Kafka, and Spark Structured Streaming.|
...
|1326830|ServiceConfigurationTemplates:spark/3.4.0|Dependency changes in Livy and yarn-nm service startup|Ensure system services are started in correct order so that components are ready before job is submitted.|
|1326294|R/spark34:1.0.4|Fix help function not working in R sessions|Adds less package which is needed for R base. This change will allow users to use help() or ? functions in R session|
...
|**NotebookUtils**|**1.1.47 --> 1.1.48**|
|**OneLakeClientStarter**|**1.0.19.2 --> 1.0.19.4**|
...
|nest-asyncio|1.6.0|
|networkx|3.2.1|
|**notebookutils**|**3.4.1-20240306.3 --> 3.4.1-20240309.2**|
|nspr|4.35|
|nss|3.98|
|numba|0.59.0|
|numpy|1.23.5|
...
|gson|2.8.9|
|guava|4.0.1|
|**hadoop-aliyun**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
|**hadoop-annotations**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
|**hadoop-aws**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
|**hadoop-azure**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
|**hadoop-azure-datalake**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
|hadoop-azureml|1.0-fs|
|**hadoop-client-api**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
|**hadoop-client-runtime**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
|**hadoop-cloud-storage**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
|**hadoop-openstack**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
|hadoop-shaded-guava|1.1.1|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.3-120054199 --> 3.3.4.5.3-122540985**|
...
|**notebook-utils**|**3.4.1-20240306.3 --> 3.4.1-20240309.2**|
|objenesis|3.2|
...
|**spark-avro**|**2.12-3.4.1 --> 2.12-3.4.1.5.3-122540985**|
|**spark-catalyst**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-core**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-enhancement**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|spark-enhancementui|2.12-3.3.0|
|**spark-graphx**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-hadoop-cloud**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-hive**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-kusto-synapse-connector**|**3.1_2.12-1.3.4 --> 3.0_2.12-1.3.5-jar-with-dependencies**|
|**spark-kvstore**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-launcher**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|spark-lighter-contract|2.12-2.0.8_spark-3.4.0|
|spark-lighter-core|2.12-2.0.8_spark-3.4.0|
|**spark-microsoft-tools**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-mllib**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-mllib-local**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-network-common**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-network-shuffle**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-repl**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-sketch**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-sql**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-sql-kafka**|**0_2.12-3.4.1.5.3-120054199 --> 0_2.12-3.4.1.5.3-122540985**|
|**spark-streaming**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-streaming-kafka**|**2.12-3.4.1.5.3-120054199 --> 0_2.12-3.4.1.5.3-122540985**|
|**spark-streaming-kafka**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-tags**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-token-provider-kafka**|**0_2.12-3.4.1.5.3-120054199 --> 0_2.12-3.4.1.5.3-122540985**|
|**spark-unsafe**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
|**spark-yarn**|**2.12-3.4.1.5.3-120054199 --> 2.12-3.4.1.5.3-122540985**|
...
|**synfs**|**3.4.1-20240306.3 --> 3.4.1-20240309.2**|
...
|xz|1.9|
|**zookeeper**|**3.6.3.5.3-120054199 --> 3.6.3.5.3-122540985**|
|**zookeeper-jute**|**3.6.3.5.3-120054199 --> 3.6.3.5.3-122540985**|
|zstd-jni|1.5.2-5|
