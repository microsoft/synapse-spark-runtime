...
*   **VHD Name**: b5369373bbabc4.vhd
*   **Vhd Release**: Spark3.4-Rel-2025-12-15.0-rc.1
...
|-----|-----|-----|
|1845280|CosmosDBConnector:2.2.9|Upgrade Spark3.4 OLTP version from 4.37.2.|
|1870110|Wildfire/spark34:1.9.36.2|New Spark 3.4 Release which includes changes in wildfire-spark, wildfire-livy|
|1879521|Wildfire:1.9.36.3|Update multiple JVM keystores with certificates to support ADF DEP scenarios.|
|1848296|NotebookUtils:1.1.64|New getSecretWithConnection API for Azure Key Vault, HTTP retry logic fixes, mount attribute cache timeout configuration, secret redaction for connection API, and various other improvements and bug fixes.|
...
|Id|Component|Description|
|-----|-----|-----|
|1899479|NotebookUtils:1.1.65|This upgrade aims to fix notebookutils previous version unexpected throw `NoActiveSparkSessionException` in SJD.|
|1845280|CosmosDBConnector:2.2.9|Upgrade Spark3.4 OLTP version from 4.37.2.|
|1858360|Wildfire:1.9.35.2|Install keystores.json during Spark setup to list all available JVM keystore paths on the VM.|
|1848296|NotebookUtils:1.1.64|New getSecretWithConnection API for Azure Key Vault, HTTP retry logic fixes, mount attribute cache timeout configuration, secret redaction for connection API, and various other improvements and bug fixes.|
...
|Autotune|1.11.1.1|OnelakeSparkCatalog|0.2.12|
|AzureMLExtensions|1.0.4|Peregrine|0.10.4|
|Conda|8.0.43|PostgreSQLJDBCDriver|1.0.3|
|**CosmosDBConnector**|**2.2.5 ⬆️ 2.2.9**|Python|3.10/2.0.0|
|CSparkMetricUpdate|1.0.12|R|1.0.7|
|Delta|2.4.0.25|SparkAdvisor|1.0.5|
|DSCopilot|1.2.0|SparkDiagnosticsLibrary|1.0.31|
...
|FabricDWConnector|1.0.12|SQLServerODBCDriver|18.1.0|
|FsspecWrapper|1.0.18|SStreamOnSparkJar|2.3.5.1|
|Genesis|0.33.1|TokenLibrary|4.3.8|
|HiveMetaStoreClient|1.1.21.2|TridentCore|1.2.25|
|Impulse|1.2.5|TridentTokenLibrary|1.9.14|
|KustoConnector|1.5.3|Vegas|3.4.09.03|
|LibraryManager|1.0.30|VPaaSClient|3.4.01|
|LibraryMetadataCooker|2.0.3|**Wildfire**|**1.9.35.1 ⬆️ 1.9.36.3**|
|MachineLearningPredict|1.0.2|
|MlflowLibrary|2.6.0.1|
|MMLSpark|1.4.20|
|MySQLJavaConnector|1.0.3|
|**NotebookUtils**|**1.1.63.2 ⬆️ 1.1.65**|
...
|azure-datalake-store|0.0.51|msal|1.34.0|
...
|azureml-telemetry|1.55.0|**notebookutils**|**1.1.11.34.20250605.2 ⬆️ 1.1.12.34.20251214.2**|
...
|**ca-certificates**|**2024.2.2 ⬆️ 2025.11.12**|**openssl**|**3.2.1 ⬆️ 3.6.0**|
...
|font-ttf-source-code-pro|2.038|pycparser|2.23|
...
|**fonttools**|**4.49.0 ⬆️ 4.61.1**|pyjwt|2.8.0|
|fonttools|4.49.0|pyjwt|2.10.1|
|fqdn|1.5.1|pynacl|1.5.0|
|freetype|2.12.1|pyodbc|5.0.1|
|frozenlist|1.4.1|pyopenssl|23.3.0|
|fsspec|2024.2.0|pyparsing|3.2.5|
...
|google-pasta|0.2.0|pytz|2025.2|
...
|ipykernel|7.1.0|ruamel_yaml|0.15.80|
|ipython|8.37.0|s2n|1.4.1|
|ipython|8.14.0|salib|1.4.8|
|**ipywidgets**|**8.0.7 ⬆️ 8.1.8**|scikit-learn|1.3.2|
...
|**jupyter-client**|**8.6.3 ⬆️ 8.7.0**|soupsieve|2.5|
|jupyter-core|5.9.1|sqlalchemy|2.0.28|
|jupyter-ui-poll|0.2.2|sqlanalyticsconnectorpy|1.0.1|
|**jupyter-ui-poll**|**0.2.2 ⬆️ 1.1.0**|sqlparse|0.4.4|
...
|**jupyterlab-widgets**|**3.0.15 ⬆️ 3.0.16**|synapseml-cognitive|1.0.9|
...
|kiwisolver|1.4.9|synapseml-vw|1.0.9|
...
|**ld_impl_linux-64**|**2.44 ⬆️ 2.45**|tensorflow|2.15.0|
...
|libarrow-gandiva|14.0.2|tomli|2.3.0|
|libarrow-substrait|14.0.2|toolz|0.12.1|
|libbrotlicommon|1.1.0|**tornado**|**6.5.2 ⬆️ 6.5.3**|
...
|libcurl|8.5.0|typing-extensions|4.15.0|
|libdeflate|1.19|typing_extensions|4.10.0|
|libebm|0.5.0|typing_utils|0.1.0|
|libedit|3.1.20191231|tzdata|2024a|
|libev|4.33|**tzdata**|**2025.2 ⬆️ 2025.3**|
|libevent|2.1.12|ucx|1.15.0|
|libexpat|2.6.2|unicodedata2|15.1.0|
|**libexpat**|**2.7.1 ⬆️ 2.7.3**|unixodbc|2.3.12|
|libffi|3.4.2|uri-template|1.3.0|
|libffi|3.5.2|urllib3|2.1.0|
|libflac|1.4.3|**urllib3**|**2.1.0 ⬆️ 2.6.2**|
|libgcc|15.2.0|virtualenv|20.23.1|
|libgcc-ng|13.2.0|wcwidth|0.2.13|
|libgcc-ng|15.2.0|wcwidth|0.2.14|
...
|libgomp|15.2.0|wheel|0.45.1|
|libgoogle-cloud|2.12.0|**widgetsnbextension**|**4.0.14 ⬆️ 4.0.15**|
...
|**libsqlite**|**3.45.2 ⬆️ 3.51.1**|yarl|1.9.4|
...
|libuuid|2.38.1|zstd|1.5.7|
|libuuid|2.41.2|zstd|1.5.5|
...
|SparkCustomEvents|3.4.0-1.0.11|jta|1.1|
...
|aliyun-sdk-oss|3.13.0|kusto-spark|3.0_2.12-5.3.1|
...
|**azure-cosmos-analytics-spark**|**4_2-12_synapse-2.2.5 ⬆️ 4_2-12_synapse-2.2.9**|minlog|1.3.0|
...
|commons-compress|1.22|**notebook-utils**|**1.1.11-spark34-20250605.2 ⬆️ 1.1.12-spark34-20251214.2**|
...
|delta-core|2.12-2.4.0.25|parquet-encoding|1.12.3|
|delta-iceberg|2.12-2.4.0.25|parquet-format-structures|1.12.3|
|delta-storage|2.4.0.25|**parquet-hadoop-ms**|**3.4.3.5.3.20250911.1 ⬆️ 3.4.3.5.3.20251112.1**|
...
|**hadoop-aliyun**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|rocksdbjni|7.9.2|
|**hadoop-annotations**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|scala-collection-compat|2.12-2.7.0|
|**hadoop-aws**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|scala-compiler|2.12.17|
|**hadoop-azure**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|scala-java8-compat|2.12-0.9.0|
|**hadoop-azure-datalake**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|scala-library|2.12.17|
|hadoop-azureml|1.0-fs|scala-parser-combinators|2.12-2.1.1|
|**hadoop-client-api**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|scala-reflect|2.12.17|
|**hadoop-client-runtime**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|scala-xml|2.12-2.1.0|
|**hadoop-cloud-storage**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|scalactic|2.12-3.2.14|
|**hadoop-openstack**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|shims|0.9.38|
|hadoop-shaded-guava|1.1.1|slf4j-api|2.0.6|
|**hadoop-yarn-server-web-proxy**|**3.3.4.5.3.20250911.1 ⬆️ 3.3.4.5.3.20251112.1**|snappy-java|1.1.10.5|
|hdinsight-spark-metrics|3.4.0-1.0.11|spark|3.4-rpc-history-server-app-listener_2.12-1.0.0|
...
|hive-metastore|2.3.9|**spark-avro**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|hive-serde|2.3.9|**spark-catalyst**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|hive-shims|2.3.9|**spark-core**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|hive-shims|0.23-2.3.9|**spark-enhancement**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|hive-shims-common|2.3.9|spark-enhancementui|2.12-3.3.0|
|hive-shims-scheduler|2.3.9|**spark-graphx**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|hive-storage-api|2.8.1|**spark-hadoop-cloud**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|hk2-api|2.6.1|**spark-hive**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|hk2-locator|2.6.1|spark-kusto-synapse-connector|3.4_2.12-1.5.3|
|hk2-utils|2.6.1|**spark-kvstore**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|httpclient|4.5.14|**spark-launcher**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
...
|httpmime|4.5.14|**spark-microsoft-tools**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|httpmime|4.5.13|**spark-mllib**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|impulse-core_spark|3.4_2.12-1.0.22|**spark-mllib-local**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|impulse-telemetry-mds_spark|3.4_2.12-1.0.22|**spark-network-common**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|ini4j|0.5.4|**spark-network-shuffle**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|isolation-forest|3.4.2_2.12-3.0.4|**spark-repl**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|istack-commons-runtime|3.0.8|**spark-sketch**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|ivy|2.5.1|**spark-sql**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|jackson-annotations|2.14.2|**spark-sql-kafka**|**0_2.12-3.4.3.5.3.20250911.1 ⬆️ 0_2.12-3.4.3.5.3.20251112.1**|
|jackson-core|2.14.2|**spark-streaming**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|jackson-core-asl|1.9.13|**spark-streaming-kafka**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 0_2.12-3.4.3.5.3.20251112.1**|
|jackson-databind|2.14.2|**spark-streaming-kafka**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|jackson-dataformat-cbor|2.14.2|**spark-tags**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|jackson-datatype-jsr310|2.14.2|**spark-token-provider-kafka**|**0_2.12-3.4.3.5.3.20250911.1 ⬆️ 0_2.12-3.4.3.5.3.20251112.1**|
|jackson-mapper-asl|1.9.13|**spark-unsafe**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
|jackson-module-scala|2.12-2.14.2|**spark-yarn**|**2.12-3.4.3.5.3.20250911.1 ⬆️ 2.12-3.4.3.5.3.20251112.1**|
...
|jersey-container-servlet|2.36|**synfs**|**1.1.11-spark34-20250605.2 ⬆️ 1.1.12-spark34-20251214.2**|
|jersey-container-servlet-core|2.36|threeten-extra|1.7.1|
|jersey-hk2|2.36|tink|1.7.0|
|jersey-server|2.36|transaction-api|1.1|
|jettison|1.1|trident-core|1.2.25|
|jetty-util|9.4.54.v20240208|tridenttokenlibrary-assembly|1.9.14|
...
|jsch|0.1.54|xz|1.9|
|json|3|**zookeeper**|**3.6.3.5.3.20250911.1 ⬆️ 3.6.3.5.3.20251112.1**|
|json|1.8|**zookeeper-jute**|**3.6.3.5.3.20250911.1 ⬆️ 3.6.3.5.3.20251112.1**|
...
|TTR|0.24.4|**notebookutils**|**1.1.11.34.20250605.2 ⬆️ 1.1.12.34.20251214.2**|
